"""Create desktop shortcut for HJEMMELADING

Creates a Windows .lnk on the user's Desktop that launches the
`HjemmeladingApp/main.py` using the virtualenv `pythonw.exe` when
available, otherwise falls back to system `pythonw`/`python`.
"""
