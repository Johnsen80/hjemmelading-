...
class QDomImplementation(PyQt6.sip.simplewrapper):
    ...
    def setInvalidDataPolicy(
        policy: "QDomImplementation.InvalidDataPolicy",
    ) -> None: ...
    @staticmethod
    def invalidDataPolicy() -> "QDomImplementation.InvalidDataPolicy": ...
    def createDocument(
        self,
        nsURI: typing.Optional[str],
    ...
    def createDocumentType(
        self,
        qName: typing.Optional[str],
        publicId: typing.Optional[str],
        systemId: typing.Optional[str],
    ) -> "QDomDocumentType": ...
    def hasFeature(
        self, feature: typing.Optional[str], version: typing.Optional[str]
    ) -> bool: ...
...
class QDomNode(PyQt6.sip.simplewrapper):
    ...
    def replaceChild(
        self, newChild: "QDomNode", oldChild: "QDomNode"
    ) -> "QDomNode": ...
    def insertAfter(self, newChild: "QDomNode", refChild: "QDomNode") -> "QDomNode": ...
    def insertBefore(
        self, newChild: "QDomNode", refChild: "QDomNode"
    ) -> "QDomNode": ...
    def __ne__(self, other: object): ...
    def __eq__(self, other: object): ...
...
class QDomDocument(QDomNode):
    ...
    def setContent(
        self,
        reader: typing.Optional[QtCore.QXmlStreamReader],
        options: "QDomDocument.ParseOption" = ...,
    ...
    def setContent(
        self,
        text: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        namespaceProcessing: bool,
    ) -> typing.Tuple[
        bool, typing.Optional[str], typing.Optional[int], typing.Optional[int]
    ]: ...
    @typing.overload
    def setContent(
        self, text: typing.Optional[str], namespaceProcessing: bool
    ) -> typing.Tuple[
        bool, typing.Optional[str], typing.Optional[int], typing.Optional[int]
    ]: ...
    @typing.overload
    def setContent(
        self, dev: typing.Optional[QtCore.QIODevice], namespaceProcessing: bool
    ) -> typing.Tuple[
        bool, typing.Optional[str], typing.Optional[int], typing.Optional[int]
    ]: ...
    @typing.overload
    ...
    def elementsByTagNameNS(
        self, nsURI: typing.Optional[str], localName: typing.Optional[str]
    ) -> QDomNodeList: ...
    def createAttributeNS(
        self, nsURI: typing.Optional[str], qName: typing.Optional[str]
    ) -> "QDomAttr": ...
    def createElementNS(
        self, nsURI: typing.Optional[str], qName: typing.Optional[str]
    ) -> "QDomElement": ...
    ...
    def createProcessingInstruction(
        self, target: typing.Optional[str], data: typing.Optional[str]
...
class QDomCharacterData(QDomNode):
    ...
    def length(self) -> int: ...
    def replaceData(
        self, offset: int, count: int, arg: typing.Optional[str]
    ) -> None: ...
...
class QDomElement(QDomNode):
    ...
    @typing.overload
    def setAttributeNS(
        self, nsURI: typing.Optional[str], qName: typing.Optional[str], value: float
    ) -> None: ...
    @typing.overload
    def setAttributeNS(
        self, nsURI: typing.Optional[str], qName: typing.Optional[str], value: int
    ) -> None: ...
    def attributeNS(
        self,
        nsURI: typing.Optional[str],
        localName: typing.Optional[str],
