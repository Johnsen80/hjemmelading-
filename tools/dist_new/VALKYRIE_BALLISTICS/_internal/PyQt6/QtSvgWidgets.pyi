...
class QGraphicsSvgItem(QtWidgets.QGraphicsObject):
    @typing.overload
    def __init__(
        self, parent: typing.Optional[QtWidgets.QGraphicsItem] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        fileName: typing.Optional[str],
        parent: typing.Optional[QtWidgets.QGraphicsItem] = ...,
    ) -> None: ...
    def type(self) -> int: ...
    def paint(
        self,
        painter: typing.Optional[QtGui.QPainter],
        option: typing.Optional[QtWidgets.QStyleOptionGraphicsItem],
    ...
    def setSharedRenderer(
        self, renderer: typing.Optional[QtSvg.QSvgRenderer]
    ) -> None: ...
