...
import PyQt6.sip
from PyQt6 import QtCore, QtGui, QtMultimedia, QtNetwork
...
class QAudioEngine(QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, sampleRate: int, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
...
class QAudioRoom(QtCore.QObject):
    ...
    def setWallMaterial(
        self, wall: "QAudioRoom.Wall", material: "QAudioRoom.Material"
    ) -> None: ...
    def rotation(self) -> QtGui.QQuaternion: ...
    def setRotation(self, q: QtGui.QQuaternion) -> None: ...
