...
import PyQt6.sip
from PyQt6 import QtCore, QtGui, QtNetwork, QtQml
...
class QQuickItem(QtCore.QObject, QtQml.QQmlParserStatus):
    ...
    ) -> typing.Optional["QQuickItemGrabResult"]: ...
    ...
    def updatePaintNode(
        self,
        a0: typing.Optional["QSGNode"],
        a1: typing.Optional["QQuickItem.UpdatePaintNodeData"],
    ) -> typing.Optional["QSGNode"]: ...
    def geometryChange(
        self, newGeometry: QtCore.QRectF, oldGeometry: QtCore.QRectF
    ) -> None: ...
    def childMouseEventFilter(
        self, a0: typing.Optional["QQuickItem"], a1: typing.Optional[QtCore.QEvent]
    ) -> bool: ...
    ...
    def mapRectFromItem(
        self, item: typing.Optional["QQuickItem"], rect: QtCore.QRectF
    ) -> QtCore.QRectF: ...
    def mapFromScene(self, point: QtCore.QPointF) -> QtCore.QPointF: ...
    def mapFromItem(
        self, item: typing.Optional["QQuickItem"], point: QtCore.QPointF
    ) -> QtCore.QPointF: ...
...
class QQuickFramebufferObject(QQuickItem):
    class Renderer(PyQt6.sip.wrapper):
        ...
        def synchronize(
            self, a0: typing.Optional["QQuickFramebufferObject"]
        ) -> None: ...
        def createFramebufferObject(
            self, size: QtCore.QSize
        ) -> typing.Optional[QOpenGLFramebufferObject]: ...
...
class QQuickTextureFactory(QtCore.QObject):
    ...
    def textureFactoryForImage(
        image: QtGui.QImage,
    ) -> typing.Optional["QQuickTextureFactory"]: ...
    def image(self) -> QtGui.QImage: ...
    def textureByteCount(self) -> int: ...
    def textureSize(self) -> QtCore.QSize: ...
    def createTexture(
        self, window: typing.Optional["QQuickWindow"]
...
class QQuickImageProvider(QtQml.QQmlImageProviderBase):
    ...
    def requestTexture(
        self, id: typing.Optional[str], requestedSize: QtCore.QSize
    ) -> typing.Tuple[
        typing.Optional[QQuickTextureFactory], typing.Optional[QtCore.QSize]
    ]: ...
    def requestPixmap(
        self, id: typing.Optional[str], requestedSize: QtCore.QSize
    ) -> typing.Tuple[QtGui.QPixmap, typing.Optional[QtCore.QSize]]: ...
    def requestImage(
        self, id: typing.Optional[str], requestedSize: QtCore.QSize
    ) -> typing.Tuple[QtGui.QImage, typing.Optional[QtCore.QSize]]: ...
...
class QQuickAsyncImageProvider(QQuickImageProvider):
    ...
    def requestImageResponse(
        self, id: typing.Optional[str], requestedSize: QtCore.QSize
    ) -> typing.Optional[QQuickImageResponse]: ...
...
class QQuickPaintedItem(QQuickItem):
    ...
    def setFillColor(
        self, a0: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
...
class QQuickRenderControl(QtCore.QObject):
    ...
    def renderWindow(
        self, offset: typing.Optional[QtCore.QPoint]
    ) -> typing.Optional[QtGui.QWindow]: ...
    @staticmethod
    def renderWindowFor(
        win: typing.Optional["QQuickWindow"],
        offset: typing.Optional[QtCore.QPoint] = ...,
    ) -> typing.Optional[QtGui.QWindow]: ...
    def sync(self) -> bool: ...
    def render(self) -> None: ...
...
class QQuickRenderTarget(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromPaintDevice(
        device: typing.Optional[QtGui.QPaintDevice],
    ) -> "QQuickRenderTarget": ...
    @staticmethod
    ...
    @staticmethod
    def fromOpenGLTexture(
        textureId: int, format: int, pixelSize: QtCore.QSize, sampleCount: int = ...
    ) -> "QQuickRenderTarget": ...
    @typing.overload
    @staticmethod
    def fromOpenGLTexture(
...
class QQuickTextDocument(QtCore.QObject):
    ...
    def save(self) -> None: ...
    def setTextDocument(
        self, document: typing.Optional[QtGui.QTextDocument]
    ) -> None: ...
...
class QQuickWindow(QtGui.QWindow):
    ...
    def scheduleRenderJob(
        self,
        job: typing.Optional[QtCore.QRunnable],
        schedule: "QQuickWindow.RenderStage",
    ) -> None: ...
    ...
    def incubationController(
        self,
    ) -> typing.Optional[QtQml.QQmlIncubationController]: ...
...
class QQuickView(QQuickWindow):
    ...
    def __init__(
        self,
        engine: typing.Optional[QtQml.QQmlEngine],
...
class QSGMaterial(PyQt6.sip.wrapper):
    ...
    ) -> typing.Optional["QSGMaterialShader"]: ...
...
class QSGGeometry(PyQt6.sip.wrapper):
    ...
    def updateColoredRectGeometry(
        g: typing.Optional["QSGGeometry"], rect: QtCore.QRectF
    ) -> None: ...
...
class QSGNode(PyQt6.sip.wrapper):
    ...
    def insertChildNodeAfter(
        self, node: typing.Optional["QSGNode"], after: typing.Optional["QSGNode"]
    ) -> None: ...
    def insertChildNodeBefore(
        self, node: typing.Optional["QSGNode"], before: typing.Optional["QSGNode"]
    ) -> None: ...
...
class QSGImageNode(QSGGeometryNode):
    ...
    def rebuildGeometry(
        g: typing.Optional[QSGGeometry],
        texture: typing.Optional["QSGTexture"],
        rect: QtCore.QRectF,
        sourceRect: QtCore.QRectF,
...
class QSGMaterialShader(PyQt6.sip.simplewrapper):
    ...
    class RenderState(PyQt6.sip.simplewrapper):
        class DirtyState(enum.Flag):
            ...
            DirtyCachedMaterialData = (
                ...
            )  # type: QSGMaterialShader.RenderState.DirtyState
    ...
    class GraphicsPipelineState(PyQt6.sip.simplewrapper):
        ...
        class BlendOp(enum.Enum):
            ...
            ReverseSubtract = (
                ...
            )  # type: QSGMaterialShader.GraphicsPipelineState.BlendOp
        ...
        class BlendFactor(enum.Enum):
            ...
            OneMinusSrcColor = (
                ...
            )  # type: QSGMaterialShader.GraphicsPipelineState.BlendFactor
        ...
        colorWrite = (
            ...
        )  # type: 'QSGMaterialShader.GraphicsPipelineState.ColorMaskComponent'
    ...
    def setShaderFileName(
        self, stage: "QSGMaterialShader.Stage", filename: typing.Optional[str]
    ) -> None: ...
    @typing.overload
    def setShaderFileName(
        self,
    ...
    def updateGraphicsPipelineState(
        ...
        ps: typing.Optional["QSGMaterialShader.GraphicsPipelineState"],
        newMaterial: typing.Optional[QSGMaterial],
        oldMaterial: typing.Optional[QSGMaterial],
    ) -> bool: ...
...
class QSGRendererInterface(PyQt6.sip.simplewrapper):
    ...
    def getResource(
        self,
        window: typing.Optional[QQuickWindow],
        resource: "QSGRendererInterface.Resource",
    ) -> typing.Optional[PyQt6.sip.voidptr]: ...
    @typing.overload
    def getResource(
        self, window: typing.Optional[QQuickWindow], resource: typing.Optional[str]
    ) -> typing.Optional[PyQt6.sip.voidptr]: ...
...
class QSGRenderNode(QSGNode):
    ...
    class RenderState(PyQt6.sip.simplewrapper):
        def get(
            self, state: typing.Optional[str]
        ) -> typing.Optional[PyQt6.sip.voidptr]: ...
...
class QSGSimpleTextureNode(QSGGeometryNode):
    class TextureCoordinatesTransformFlag(enum.Flag):
        ...
        MirrorHorizontally = (
            ...
        )  # type: QSGSimpleTextureNode.TextureCoordinatesTransformFlag
        MirrorVertically = (
            ...
        )  # type: QSGSimpleTextureNode.TextureCoordinatesTransformFlag
...
class QSGTextNode(QSGTransformNode):
    ...
    def setSelectionTextColor(
        self, selectionTextColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
    def selectionColor(self) -> QtGui.QColor: ...
    def setSelectionColor(
        self, selectionColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
    def linkColor(self) -> QtGui.QColor: ...
    def setLinkColor(
        self, linkColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
    def styleColor(self) -> QtGui.QColor: ...
    def setStyleColor(
        self, styleColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
    ...
    def addTextLayout(
        ...
        layout: typing.Optional[QtGui.QTextLayout],
        selectionStart: int = ...,
        selectionCount: int = ...,
        lineStart: int = ...,
        lineCount: int = ...,
    ...
    def addTextDocument(
        self,
        position: QtCore.QPointF,
        document: typing.Optional[QtGui.QTextDocument],
        selectionStart: int = ...,
        selectionCount: int = ...,
    ) -> None: ...
