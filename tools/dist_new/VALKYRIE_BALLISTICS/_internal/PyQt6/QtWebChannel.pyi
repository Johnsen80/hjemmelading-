...
class QWebChannel(QtCore.QObject):
    ...
    def disconnectFrom(
        self, transport: typing.Optional["QWebChannelAbstractTransport"]
    ) -> None: ...
    def connectTo(
        self, transport: typing.Optional["QWebChannelAbstractTransport"]
    ) -> None: ...
    ...
    def registerObject(
        self, id: typing.Optional[str], object: typing.Optional[QtCore.QObject]
    ) -> None: ...
    def registeredObjects(self) -> dict[str, QtCore.QObject]: ...
    def registerObjects(
        self, objects: dict[typing.Optional[str], QtCore.QObject]
    ) -> None: ...
    ...
    def sendMessage(
        ...
        message: dict[
            ...
            typing.Union[
                ...
                dict[typing.Optional[str], QtCore.QJsonValue],
                bool,
                int,
                float,
                None,
