...
class QSensor(QtCore.QObject):
    ...
    def setAxesOrientationMode(
        self, axesOrientationMode: "QSensor.AxesOrientationMode"
    ) -> None: ...
    ...
    def setIdentifier(
        self, identifier: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
...
class QOrientationReading(QSensorReading):
    ...
    def setOrientation(
        self, orientation: "QOrientationReading.Orientation"
    ) -> None: ...
