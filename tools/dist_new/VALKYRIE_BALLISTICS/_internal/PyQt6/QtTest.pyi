...
class QSignalSpy(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, obj: typing.Optional[QtCore.QObject], signal: QtCore.QMetaMethod
    ) -> None: ...
...
class QTest(PyQt6.sip.simplewrapper):
    ...
    def qWaitForWindowExposed(
        self, window: typing.Optional[QtGui.QWindow], timeout: int = ...
    ) -> bool: ...
    @typing.overload
    def qWaitForWindowExposed(
        self, widget: typing.Optional[QtWidgets.QWidget], timeout: int = ...
    ) -> bool: ...
    @typing.overload
