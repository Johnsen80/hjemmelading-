...
class QBluetoothDeviceInfo(PyQt6.sip.simplewrapper):
    ...
    class CoreConfiguration(enum.Flag):
        ...
        BaseRateAndLowEnergyCoreConfiguration = (
            ...
        )  # type: QBluetoothDeviceInfo.CoreConfiguration
    ...
    class MinorWearableClass(enum.Enum):
        UncategorizedWearableDevice = (
            ...
        )  # type: QBluetoothDeviceInfo.MinorWearableClass
    ...
    class MinorPeripheralClass(enum.Enum):
        ...
        PointingDevicePeripheral = (
            ...
        )  # type: QBluetoothDeviceInfo.MinorPeripheralClass
    ...
    class MinorAudioVideoClass(enum.Enum):
        UncategorizedAudioVideoDevice = (
            ...
        )  # type: QBluetoothDeviceInfo.MinorAudioVideoClass
    ...
    class MinorPhoneClass(enum.Enum):
        ...
        WiredModemOrVoiceGatewayPhone = (
            ...
        )  # type: QBluetoothDeviceInfo.MinorPhoneClass
    ...
    class MinorMiscellaneousClass(enum.Enum):
        UncategorizedMiscellaneous = (
            ...
        )  # type: QBluetoothDeviceInfo.MinorMiscellaneousClass
    ...
    @typing.overload
    def __init__(
        self, address: QBluetoothAddress, name: typing.Optional[str], classOfDevice: int
    ) -> None: ...
    @typing.overload
    def __init__(
        self, uuid: "QBluetoothUuid", name: typing.Optional[str], classOfDevice: int
    ) -> None: ...
    @typing.overload
...
class QBluetoothServer(QtCore.QObject):
    ...
    @typing.overload
    def listen(
        self, uuid: "QBluetoothUuid", serviceName: typing.Optional[str] = ...
...
class QBluetoothServiceDiscoveryAgent(QtCore.QObject):
    ...
    class Error(enum.Enum):
        ...
        InvalidBluetoothAdapterError = (
            ...
        )  # type: QBluetoothServiceDiscoveryAgent.Error
...
class QBluetoothServiceInfo(PyQt6.sip.simplewrapper):
    ...
    class AttributeId(enum.Enum):
        ...
        AdditionalProtocolDescriptorList = (
            ...
        )  # type: QBluetoothServiceInfo.AttributeId
...
class QBluetoothUuid(QtCore.QUuid):
    ...
    class CharacteristicType(enum.Enum):
        ...
        PeripheralPreferredConnectionParameters = (
            ...
        )  # type: QBluetoothUuid.CharacteristicType
    ...
    class ServiceClassUuid(enum.Enum):
        ...
        DirectPrintingReferenceObjectsService = (
            ...
        )  # type: QBluetoothUuid.ServiceClassUuid
...
class QLowEnergyAdvertisingParameters(PyQt6.sip.simplewrapper):
    class FilterPolicy(enum.Enum):
        ...
        UseWhiteListForScanning = (
            ...
        )  # type: QLowEnergyAdvertisingParameters.FilterPolicy
...
class QLowEnergyCharacteristic(PyQt6.sip.simplewrapper):
    ...
    CCCDDisable = (
        ...
    )  # type: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
...
class QLowEnergyController(QtCore.QObject):
    ...
    def addService(
        ...
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> typing.Optional["QLowEnergyService"]: ...
    ...
    def createPeripheral(
        localDevice: QBluetoothAddress, parent: typing.Optional[QtCore.QObject] = ...
    ) -> typing.Optional["QLowEnergyController"]: ...
    @typing.overload
    @staticmethod
    def createPeripheral(
        parent: typing.Optional[QtCore.QObject] = ...,
...
class QLowEnergyService(QtCore.QObject):
    ...
    def writeDescriptor(
        ...
        newValue: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> None: ...
...
class QLowEnergyServiceData(PyQt6.sip.simplewrapper):
    ...
    def setCharacteristics(
        self, characteristics: collections.abc.Iterable[QLowEnergyCharacteristicData]
    ) -> None: ...
    def characteristics(self) -> list[QLowEnergyCharacteristicData]: ...
    def addIncludedService(
        self, service: typing.Optional[QLowEnergyService]
    ) -> None: ...
