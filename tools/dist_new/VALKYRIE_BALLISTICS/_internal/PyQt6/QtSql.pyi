...
class QSqlDatabase(PyQt6.sip.simplewrapper):
    ...
    def registerSqlDriver(
        name: typing.Optional[str], creator: typing.Optional[QSqlDriverCreatorBase]
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def database(
        connectionName: typing.Optional[str] = ..., open: bool = ...
    ) -> "QSqlDatabase": ...
    @typing.overload
    @staticmethod
    def cloneDatabase(
        other: "QSqlDatabase", connectionName: typing.Optional[str]
    ) -> "QSqlDatabase": ...
    @typing.overload
    @staticmethod
    def cloneDatabase(
        other: typing.Optional[str], connectionName: typing.Optional[str]
    ) -> "QSqlDatabase": ...
    @typing.overload
    @staticmethod
    def addDatabase(
        type: typing.Optional[str], connectionName: typing.Optional[str] = ...
    ) -> "QSqlDatabase": ...
    @typing.overload
    @staticmethod
    def addDatabase(
        driver: typing.Optional["QSqlDriver"],
        connectionName: typing.Optional[str] = ...,
    ) -> "QSqlDatabase": ...
    ...
    @typing.overload
    def open(
        self, user: typing.Optional[str], password: typing.Optional[str]
    ) -> bool: ...
...
class QSqlDriver(QtCore.QObject):
    ...
    def stripDelimiters(
        self, identifier: typing.Optional[str], type: "QSqlDriver.IdentifierType"
    ) -> str: ...
...
class QSqlError(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        driverText: typing.Optional[str] = ...,
        databaseText: typing.Optional[str] = ...,
...
class QSqlIndex(QSqlRecord):
    @typing.overload
    def __init__(
        self, cursorName: typing.Optional[str] = ..., name: typing.Optional[str] = ...
    ) -> None: ...
    @typing.overload
...
class QSqlQuery(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, query: typing.Optional[str] = ..., db: QSqlDatabase = ...
    ) -> None: ...
    @typing.overload
...
class QSqlRelationalDelegate(QtWidgets.QStyledItemDelegate):
    ...
    def setEditorData(
        self, editor: typing.Optional[QtWidgets.QWidget], index: QtCore.QModelIndex
    ) -> None: ...
    def createEditor(
        self,
...
class QSqlRelation(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        aTableName: typing.Optional[str],
        indexCol: typing.Optional[str],
        displayCol: typing.Optional[str],
    ) -> None: ...
    @typing.overload
...
class QSqlTableModel(QSqlQueryModel):
    ...
    def __init__(
        self, parent: typing.Optional[QtCore.QObject] = ..., db: QSqlDatabase = ...
    ) -> None: ...
