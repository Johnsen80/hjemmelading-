...
class QRemoteObjectSourceLocationInfo(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, typeName_: typing.Optional[str], hostUrl_: QtCore.QUrl
    ) -> None: ...
    @typing.overload
...
class QRemoteObjectAbstractPersistedStore(QtCore.QObject):
    ...
    def restoreProperties(
        self,
        repName: typing.Optional[str],
        repSig: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> list[typing.Any]: ...
    def saveProperties(
        self,
        repName: typing.Optional[str],
...
class QRemoteObjectNode(QtCore.QObject):
    ...
    def setPersistedStore(
        self, persistedStore: typing.Optional[QRemoteObjectAbstractPersistedStore]
    ) -> None: ...
    def persistedStore(
        self,
    ) -> typing.Optional[QRemoteObjectAbstractPersistedStore]: ...
...
class QRemoteObjectHostBase(QRemoteObjectNode):
    ...
    def disableRemoting(
        self, remoteObject: typing.Optional[QtCore.QObject]
    ) -> bool: ...
    @typing.overload
    def enableRemoting(
        self, object: typing.Optional[QtCore.QObject], name: typing.Optional[str] = ...
    ) -> bool: ...
    @typing.overload
    def enableRemoting(
        self,
        ...
        selectionModel: typing.Optional[QtCore.QItemSelectionModel] = ...,
    ) -> bool: ...
    def setName(self, name: typing.Optional[str]) -> None: ...
...
class QRemoteObjectHost(QRemoteObjectHostBase):
    ...
    @typing.overload
    def __init__(
        self, address: QtCore.QUrl, parent: typing.Optional[QtCore.QObject]
    ) -> None: ...
    @staticmethod
