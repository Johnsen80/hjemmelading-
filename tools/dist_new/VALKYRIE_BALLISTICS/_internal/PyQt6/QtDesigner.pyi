...
class QDesignerActionEditorInterface(QtWidgets.QWidget):
    ...
    def setFormWindow(
        self, formWindow: typing.Optional["QDesignerFormWindowInterface"]
    ) -> None: ...
...
class QAbstractFormBuilder(PyQt6.sip.simplewrapper):
    ...
    def save(
        self,
        dev: typing.Optional[QtCore.QIODevice],
...
class QDesignerFormEditorInterface(QtCore.QObject):
    ...
    def setActionEditor(
        self, actionEditor: typing.Optional[QDesignerActionEditorInterface]
    ) -> None: ...
    def setObjectInspector(
        self, objectInspector: typing.Optional["QDesignerObjectInspectorInterface"]
    ) -> None: ...
    def setPropertyEditor(
        self, propertyEditor: typing.Optional["QDesignerPropertyEditorInterface"]
    ) -> None: ...
    def setWidgetBox(
        self, widgetBox: typing.Optional["QDesignerWidgetBoxInterface"]
    ) -> None: ...
    def actionEditor(self) -> typing.Optional[QDesignerActionEditorInterface]: ...
    def formWindowManager(
        self,
    ) -> typing.Optional["QDesignerFormWindowManagerInterface"]: ...
    def objectInspector(
        self,
    ) -> typing.Optional["QDesignerObjectInspectorInterface"]: ...
...
class QDesignerFormWindowInterface(QtWidgets.QWidget):
    ...
    def selectWidget(
        self, widget: typing.Optional[QtWidgets.QWidget], select: bool = ...
    ) -> None: ...
    ...
    @staticmethod
    def findFormWindow(
        w: typing.Optional[QtWidgets.QWidget],
    ) -> typing.Optional["QDesignerFormWindowInterface"]: ...
    @typing.overload
    @staticmethod
    def findFormWindow(
    ...
    def setMainContainer(
        self, mainContainer: typing.Optional[QtWidgets.QWidget]
    ) -> None: ...
    ...
    def core(self) -> typing.Optional[QDesignerFormEditorInterface]: ...
    def setIncludeHints(
        self, includeHints: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    ...
    def setLayoutFunction(
        self, margin: typing.Optional[str], spacing: typing.Optional[str]
    ) -> None: ...
    def layoutFunction(
        self,
    ...
    def setContents(
        self,
        dev: typing.Optional[QtCore.QIODevice],
        errorMessage: typing.Optional[typing.Optional[str]] = ...,
    ) -> bool: ...
    @typing.overload
...
class QDesignerFormWindowCursorInterface(PyQt6.sip.simplewrapper):
    ...
    def resetWidgetProperty(
        self, widget: typing.Optional[QtWidgets.QWidget], name: typing.Optional[str]
    ) -> None: ...
...
class QDesignerFormWindowManagerInterface(QtCore.QObject):
    class ActionGroup(enum.Enum):
        StyledPreviewActionGroup = (
            ...
        )  # type: QDesignerFormWindowManagerInterface.ActionGroup
    ...
    class Action(enum.Enum):
        ...
        FormWindowSettingsDialogAction = (
            ...
        )  # type: QDesignerFormWindowManagerInterface.Action
    ...
    ) -> typing.Optional[QtGui.QActionGroup]: ...
    def action(
...
class QDesignerPropertyEditorInterface(QtWidgets.QWidget):
    ...
    def setPropertyValue(
        self, name: typing.Optional[str], value: typing.Any, changed: bool = ...
    ) -> None: ...
...
class QDesignerContainerExtension(PyQt6.sip.simplewrapper):
    ...
    def insertWidget(
        self, index: int, widget: typing.Optional[QtWidgets.QWidget]
    ) -> None: ...
...
class QDesignerCustomWidgetInterface(PyQt6.sip.simplewrapper):
    ...
    def domXml(self) -> str: ...
    def initialize(
        self, core: typing.Optional[QDesignerFormEditorInterface]
    ) -> None: ...
...
class QAbstractExtensionFactory(PyQt6.sip.simplewrapper):
    ...
    def extension(
        self, object: typing.Optional[QtCore.QObject], iid: typing.Optional[str]
...
class QAbstractExtensionManager(PyQt6.sip.simplewrapper):
    ...
    def unregisterExtensions(
        self,
        factory: typing.Optional[QAbstractExtensionFactory],
        iid: typing.Optional[str],
    ) -> None: ...
...
class QFormBuilder(QAbstractFormBuilder):
    ...
    def customWidgets(self) -> list[QDesignerCustomWidgetInterface]: ...
    def setPluginPath(
        self, pluginPaths: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
