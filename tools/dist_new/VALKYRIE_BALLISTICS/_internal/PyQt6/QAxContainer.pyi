...
class QAxBase(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def querySubObject(
        self, a0: typing.Optional[str], a1: collections.abc.Iterable[typing.Any]
    ) -> typing.Optional["QAxObject"]: ...
    @typing.overload
    def querySubObject(
        self,
        a0: typing.Optional[str],
        value1: typing.Any = ...,
        value2: typing.Any = ...,
        value3: typing.Any = ...,
        value4: typing.Any = ...,
...
class QAxObject(QAxBaseObject, QAxBase):
    ...
    @typing.overload
    def __init__(
        self, a0: typing.Optional[str], parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
...
class QAxWidget(QAxBaseWidget, QAxBase):
    ...
    def createHostWindow(
        self,
        a0: bool,
        a1: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> bool: ...
