...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    def nativeEvent(
        self,
        eventType: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        message: typing.Optional[PyQt6.sip.voidptr],
    ) -> typing.Tuple[bool, typing.Optional[PyQt6.sip.voidptr]]: ...
    ...
    def render(
        self,
        target: typing.Optional[QtGui.QPaintDevice],
    ...
    def restoreGeometry(
        self, geometry: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> bool: ...
    ...
    def inputMethodEvent(
        self, a0: typing.Optional[QtGui.QInputMethodEvent]
    ) -> None: ...
    ...
    def contextMenuEvent(
        self, a0: typing.Optional[QtGui.QContextMenuEvent]
    ) -> None: ...
    ...
    def insertActions(
        self,
        before: typing.Optional[QtGui.QAction],
        actions: collections.abc.Iterable[QtGui.QAction],
    ) -> None: ...
    def insertAction(
        self,
        before: typing.Optional[QtGui.QAction],
        action: typing.Optional[QtGui.QAction],
    ) -> None: ...
    def addActions(self, actions: collections.abc.Iterable[QtGui.QAction]) -> None: ...
    @typing.overload
    def addAction(
        self, icon: QtGui.QIcon, text: typing.Optional[str]
    ...
    @typing.overload
    def setParent(
        self, parent: typing.Optional["QWidget"], f: QtCore.Qt.WindowType
    ) -> None: ...
    ...
    @typing.overload
    def grabMouse(
        self, a0: typing.Union[QtGui.QCursor, QtCore.Qt.CursorShape]
    ) -> None: ...
    ...
    @staticmethod
    def setTabOrder(
        a0: typing.Optional["QWidget"], a1: typing.Optional["QWidget"]
    ) -> None: ...
    ...
    @typing.overload
    def mapFrom(
        self, a0: typing.Optional["QWidget"], a1: QtCore.QPoint
    ) -> QtCore.QPoint: ...
    @typing.overload
    def mapFrom(
        self, a0: typing.Optional["QWidget"], a1: QtCore.QPointF
    ) -> QtCore.QPointF: ...
    @typing.overload
    def mapTo(
        self, a0: typing.Optional["QWidget"], a1: QtCore.QPoint
...
class QAbstractItemDelegate(QtCore.QObject):
    ...
    def handleEditorEvent(
        self,
        object: typing.Optional[QtCore.QObject],
    ...
    def helpEvent(
        self,
        event: typing.Optional[QtGui.QHelpEvent],
        view: typing.Optional["QAbstractItemView"],
...
class QAbstractScrollArea(QFrame):
    ...
    def addScrollBarWidget(
        self, widget: typing.Optional[QWidget], alignment: QtCore.Qt.AlignmentFlag
    ) -> None: ...
    ...
    def setHorizontalScrollBar(
        self, scrollbar: typing.Optional["QScrollBar"]
    ) -> None: ...
    ...
    def eventFilter(
        self, a0: typing.Optional[QtCore.QObject], a1: typing.Optional[QtCore.QEvent]
    ) -> bool: ...
    def keyPressEvent(self, a0: typing.Optional[QtGui.QKeyEvent]) -> None: ...
    def dropEvent(self, a0: typing.Optional[QtGui.QDropEvent]) -> None: ...
    def dragLeaveEvent(self, a0: typing.Optional[QtGui.QDragLeaveEvent]) -> None: ...
...
class QAbstractItemView(QAbstractScrollArea):
    ...
    def initViewItemOption(
        self, option: typing.Optional["QStyleOptionViewItem"]
    ) -> None: ...
    ...
    def viewportSizeHint(self) -> QtCore.QSize: ...
    def inputMethodEvent(
        self, event: typing.Optional[QtGui.QInputMethodEvent]
    ) -> None: ...
    def focusNextPrevChild(self, next: bool) -> bool: ...
    ...
    ) -> typing.Optional[QAbstractItemDelegate]: ...
    def itemDelegateForColumn(
        self, column: int
    ) -> typing.Optional[QAbstractItemDelegate]: ...
    def setItemDelegateForColumn(
        self, column: int, delegate: typing.Optional[QAbstractItemDelegate]
    ) -> None: ...
    def itemDelegateForRow(
        self, row: int
    ) -> typing.Optional[QAbstractItemDelegate]: ...
    def setItemDelegateForRow(
        self, row: int, delegate: typing.Optional[QAbstractItemDelegate]
    ) -> None: ...
    ...
    def closeEditor(
        self, editor: typing.Optional[QWidget], hint: QAbstractItemDelegate.EndEditHint
    ) -> None: ...
    ...
    def setIndexWidget(
        self, index: QtCore.QModelIndex, widget: typing.Optional[QWidget]
    ) -> None: ...
    ...
    def setItemDelegate(
        self, delegate: typing.Optional[QAbstractItemDelegate]
    ) -> None: ...
    def selectionModel(self) -> typing.Optional[QtCore.QItemSelectionModel]: ...
    def setSelectionModel(
        self, selectionModel: typing.Optional[QtCore.QItemSelectionModel]
    ) -> None: ...
...
class QAbstractSpinBox(QWidget):
    ...
    def initStyleOption(
        self, option: typing.Optional["QStyleOptionSpinBox"]
    ) -> None: ...
    ...
    def validate(
        self, input: typing.Optional[str], pos: int
...
class QApplication(QtGui.QGuiApplication):
    ...
    @staticmethod
    def setPalette(
        a0: QtGui.QPalette, className: typing.Optional[str] = ...
    ) -> None: ...
    @typing.overload
    @staticmethod
...
class QLayout(QtCore.QObject, QLayoutItem):
    ...
    def setVerticalSizeConstraint(
        self, constraint: "QLayout.SizeConstraint"
    ) -> None: ...
    def horizontalSizeConstraint(self) -> "QLayout.SizeConstraint": ...
    def setHorizontalSizeConstraint(
        self, constraint: "QLayout.SizeConstraint"
    ) -> None: ...
    def setSizeConstraints(
        self, horizontal: "QLayout.SizeConstraint", vertical: "QLayout.SizeConstraint"
    ) -> None: ...
    def unsetContentsMargins(self) -> None: ...
    def replaceWidget(
        self,
        from_: typing.Optional[QWidget],
        to: typing.Optional[QWidget],
        options: QtCore.Qt.FindChildOption = ...,
    ) -> typing.Optional[QLayoutItem]: ...
    def controlTypes(self) -> "QSizePolicy.ControlType": ...
    def contentsMargins(self) -> QtCore.QMargins: ...
    def contentsRect(self) -> QtCore.QRect: ...
    ...
    def closestAcceptableSize(
        w: typing.Optional[QWidget], s: QtCore.QSize
    ) -> QtCore.QSize: ...
    def isEnabled(self) -> bool: ...
    def setEnabled(self, a0: bool) -> None: ...
    def layout(self) -> typing.Optional["QLayout"]: ...
    ...
    @typing.overload
    def setAlignment(
        self, w: typing.Optional[QWidget], alignment: QtCore.Qt.AlignmentFlag
    ) -> bool: ...
    @typing.overload
    def setAlignment(
        self, l: typing.Optional["QLayout"], alignment: QtCore.Qt.AlignmentFlag
    ) -> bool: ...
    @typing.overload
...
class QBoxLayout(QLayout):
    ...
    def __init__(
        self, direction: "QBoxLayout.Direction", parent: typing.Optional[QWidget] = ...
    ) -> None: ...
    ...
    def insertSpacerItem(
        self, index: int, spacerItem: typing.Optional["QSpacerItem"]
    ) -> None: ...
    ...
    def insertLayout(
        self, index: int, layout: typing.Optional[QLayout], stretch: int = ...
    ) -> None: ...
    def insertWidget(
        self,
        index: int,
    ...
    def addLayout(
        self, layout: typing.Optional[QLayout], stretch: int = ...
    ) -> None: ...
    def addWidget(
        self,
        a0: typing.Optional[QWidget],
        stretch: int = ...,
        alignment: QtCore.Qt.AlignmentFlag = ...,
    ) -> None: ...
...
class QButtonGroup(QtCore.QObject):
    ...
    def addButton(
        self, a0: typing.Optional[QAbstractButton], id: int = ...
    ) -> None: ...
...
class QCalendarWidget(QWidget):
    ...
    def eventFilter(
        self,
        watched: typing.Optional[QtCore.QObject],
        event: typing.Optional[QtCore.QEvent],
    ) -> bool: ...
    def event(self, event: typing.Optional[QtCore.QEvent]) -> bool: ...
...
class QCheckBox(QAbstractButton):
    ...
    @typing.overload
    def __init__(
        self, text: typing.Optional[str], parent: typing.Optional[QWidget] = ...
    ) -> None: ...
    def initStyleOption(
        self, option: typing.Optional["QStyleOptionButton"]
    ) -> None: ...
    def mouseMoveEvent(self, a0: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def paintEvent(self, a0: typing.Optional[QtGui.QPaintEvent]) -> None: ...
    def event(self, e: typing.Optional[QtCore.QEvent]) -> bool: ...
...
class QColumnView(QAbstractItemView):
    ...
    ) -> typing.Optional[QAbstractItemView]: ...
...
class QComboBox(QWidget):
    ...
    def focusInEvent(self, e: typing.Optional[QtGui.QFocusEvent]) -> None: ...
    def initStyleOption(
        self, option: typing.Optional["QStyleOptionComboBox"]
    ) -> None: ...
    ...
    def insertItems(
        self, index: int, texts: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    @typing.overload
    def insertItem(
        self, index: int, text: typing.Optional[str], userData: typing.Any = ...
    ) -> None: ...
    @typing.overload
    def insertItem(
        self,
    ...
    @typing.overload
    def addItem(
        self, text: typing.Optional[str], userData: typing.Any = ...
    ) -> None: ...
    @typing.overload
    def addItem(
        self, icon: QtGui.QIcon, text: typing.Optional[str], userData: typing.Any = ...
    ) -> None: ...
    def addItems(
        self, texts: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    ...
    def findData(
        self, data: typing.Any, role: int = ..., flags: QtCore.Qt.MatchFlag = ...
    ) -> int: ...
    def findText(
        self, text: typing.Optional[str], flags: QtCore.Qt.MatchFlag = ...
    ) -> int: ...
    def hasFrame(self) -> bool: ...
    def setFrame(self, a0: bool) -> None: ...
...
class QStyle(QtCore.QObject):
    class RequestSoftwareInputPanel(enum.Enum):
        RSIP_OnMouseClickAndAlreadyFocused = (
            ...
        )  # type: QStyle.RequestSoftwareInputPanel
    ...
    @staticmethod
    def visualAlignment(
        direction: QtCore.Qt.LayoutDirection, alignment: QtCore.Qt.AlignmentFlag
    ...
    def subControlRect(
        ...
        opt: typing.Optional["QStyleOptionComplex"],
    ...
    def drawComplexControl(
        ...
        cc: "QStyle.ComplexControl",
        opt: typing.Optional["QStyleOptionComplex"],
        p: typing.Optional[QtGui.QPainter],
        widget: typing.Optional[QWidget] = ...,
    ) -> None: ...
    def subElementRect(
        self,
...
class QCompleter(QtCore.QObject):
    ...
    def __init__(
        self,
        list: collections.abc.Iterable[typing.Optional[str]],
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    ...
    def event(self, a0: typing.Optional[QtCore.QEvent]) -> bool: ...
    def eventFilter(
        self, o: typing.Optional[QtCore.QObject], e: typing.Optional[QtCore.QEvent]
    ) -> bool: ...
...
class QDataWidgetMapper(QtCore.QObject):
    ...
    def mappedPropertyName(
        self, widget: typing.Optional[QWidget]
    ) -> QtCore.QByteArray: ...
    ...
    def addMapping(
        ...
        widget: typing.Optional[QWidget],
        section: int,
        propertyName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> None: ...
...
class QDateTimeEdit(QAbstractSpinBox):
    ...
    def setCalendarWidget(
        self, calendarWidget: typing.Optional[QCalendarWidget]
    ) -> None: ...
    ...
    def setMaximumTime(
        self, max: typing.Union[QtCore.QTime, datetime.time]
    ) -> None: ...
    def maximumTime(self) -> QtCore.QTime: ...
    def clearMinimumTime(self) -> None: ...
    def setMinimumTime(
        self, min: typing.Union[QtCore.QTime, datetime.time]
    ) -> None: ...
    ...
    def clearMaximumDate(self) -> None: ...
    def setMaximumDate(
        self, max: typing.Union[QtCore.QDate, datetime.date]
    ) -> None: ...
    def maximumDate(self) -> QtCore.QDate: ...
    def clearMinimumDate(self) -> None: ...
    def setMinimumDate(
        self, min: typing.Union[QtCore.QDate, datetime.date]
    ) -> None: ...
    def minimumDate(self) -> QtCore.QDate: ...
...
class QDial(QAbstractSlider):
    ...
    def event(self, e: typing.Optional[QtCore.QEvent]) -> bool: ...
    def initStyleOption(
        self, option: typing.Optional["QStyleOptionSlider"]
    ) -> None: ...
...
class QDialogButtonBox(QWidget):
    ...
    def standardButton(
        self, button: typing.Optional[QAbstractButton]
    ...
    def addButton(
        self,
        button: typing.Optional[QAbstractButton],
        role: "QDialogButtonBox.ButtonRole",
    ) -> None: ...
    @typing.overload
    def addButton(
        self, text: typing.Optional[str], role: "QDialogButtonBox.ButtonRole"
    ) -> typing.Optional[QPushButton]: ...
    @typing.overload
    def addButton(
...
class QDockWidget(QWidget):
    ...
    def changeEvent(self, event: typing.Optional[QtCore.QEvent]) -> None: ...
    def initStyleOption(
        self, option: typing.Optional["QStyleOptionDockWidget"]
    ) -> None: ...
...
class QErrorMessage(QDialog):
    ...
    @typing.overload
    def showMessage(
        self, message: typing.Optional[str], type: typing.Optional[str]
    ) -> None: ...
    @staticmethod
...
class QFileDialog(QDialog):
    ...
    @staticmethod
    def saveFileContent(
        fileContent: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        fileNameHint: typing.Optional[str] = ...,
    ) -> None: ...
    @typing.overload
    @staticmethod
    def saveFileContent(
    ...
    def setSupportedSchemes(
        self, schemes: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    @staticmethod
    def getSaveFileUrl(
        parent: typing.Optional[QWidget] = ...,
        ...
        filter: typing.Optional[str] = ...,
        initialFilter: typing.Optional[str] = ...,
        options: "QFileDialog.Option" = ...,
        supportedSchemes: collections.abc.Iterable[typing.Optional[str]] = ...,
    ...
    def setMimeTypeFilters(
        self, filters: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    ...
    def setProxyModel(
        self, model: typing.Optional[QtCore.QAbstractProxyModel]
    ) -> None: ...
    def restoreState(
        self, state: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> bool: ...
    ...
    def setLabelText(
        self, label: "QFileDialog.DialogLabel", text: typing.Optional[str]
    ) -> None: ...
    def iconProvider(self) -> typing.Optional[QtGui.QAbstractFileIconProvider]: ...
    def setIconProvider(
        self, provider: typing.Optional[QtGui.QAbstractFileIconProvider]
    ) -> None: ...
    def itemDelegate(self) -> typing.Optional[QAbstractItemDelegate]: ...
    def setItemDelegate(
        self, delegate: typing.Optional[QAbstractItemDelegate]
    ...
    def setHistory(
        self, paths: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QFontComboBox(QComboBox):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ...) -> None: ...
    def displayFont(
        self, fontFamily: typing.Optional[str]
    ) -> typing.Optional[QtGui.QFont]: ...
    def setDisplayFont(
        self, fontFamily: typing.Optional[str], font: QtGui.QFont
    ) -> None: ...
    def sampleTextForFont(self, fontFamily: typing.Optional[str]) -> str: ...
    def setSampleTextForFont(
        self, fontFamily: typing.Optional[str], sampleText: typing.Optional[str]
    ) -> None: ...
    ...
    def setSampleTextForSystem(
        ...
        sampleText: typing.Optional[str],
    ) -> None: ...
    def event(self, e: typing.Optional[QtCore.QEvent]) -> bool: ...
...
class QFontDialog(QDialog):
    ...
    ) -> typing.Tuple[QtGui.QFont, typing.Optional[bool]]: ...
    @typing.overload
    @staticmethod
    def getFont(
        parent: typing.Optional[QWidget] = ...,
...
class QFormLayout(QLayout):
    ...
    @typing.overload
    def takeRow(
        self, layout: typing.Optional[QLayout]
    ) -> "QFormLayout.TakeRowResult": ...
    @typing.overload
    ...
    @typing.overload
    def labelForField(
        self, field: typing.Optional[QWidget]
    ) -> typing.Optional[QWidget]: ...
    @typing.overload
    def labelForField(
        self, field: typing.Optional[QLayout]
    ) -> typing.Optional[QWidget]: ...
    def getLayoutPosition(
        self, layout: typing.Optional[QLayout]
    ) -> typing.Tuple[
        typing.Optional[int], typing.Optional["QFormLayout.ItemRole"]
    ]: ...
    ...
    def itemAt(self, index: int) -> typing.Optional[QLayoutItem]: ...
    def setLayout(
        self, row: int, role: "QFormLayout.ItemRole", layout: typing.Optional[QLayout]
    ) -> None: ...
    def setWidget(
        self, row: int, role: "QFormLayout.ItemRole", widget: typing.Optional[QWidget]
    ) -> None: ...
    def setItem(
        self, row: int, role: "QFormLayout.ItemRole", item: typing.Optional[QLayoutItem]
    ) -> None: ...
    @typing.overload
    def insertRow(
        self, row: int, label: typing.Optional[QWidget], field: typing.Optional[QWidget]
    ) -> None: ...
    @typing.overload
    def insertRow(
        self, row: int, label: typing.Optional[QWidget], field: typing.Optional[QLayout]
    ) -> None: ...
    @typing.overload
    def insertRow(
        self, row: int, labelText: typing.Optional[str], field: typing.Optional[QWidget]
    ) -> None: ...
    @typing.overload
    def insertRow(
        self, row: int, labelText: typing.Optional[str], field: typing.Optional[QLayout]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def addRow(
        self, label: typing.Optional[QWidget], field: typing.Optional[QWidget]
    ) -> None: ...
    @typing.overload
    def addRow(
        self, label: typing.Optional[QWidget], field: typing.Optional[QLayout]
    ) -> None: ...
    @typing.overload
    def addRow(
        self, labelText: typing.Optional[str], field: typing.Optional[QWidget]
    ) -> None: ...
    @typing.overload
    def addRow(
        self, labelText: typing.Optional[str], field: typing.Optional[QLayout]
    ) -> None: ...
    @typing.overload
...
class QGestureRecognizer(PyQt6.sip.wrapper):
    ...
    def registerRecognizer(
        recognizer: typing.Optional["QGestureRecognizer"],
    ) -> QtCore.Qt.GestureType: ...
    def reset(self, state: typing.Optional[QGesture]) -> None: ...
    def recognize(
        self,
        state: typing.Optional[QGesture],
        watched: typing.Optional[QtCore.QObject],
        event: typing.Optional[QtCore.QEvent],
    ) -> "QGestureRecognizer.ResultFlag": ...
    def create(
        self, target: typing.Optional[QtCore.QObject]
    ) -> typing.Optional[QGesture]: ...
...
class QGraphicsLayoutItem(PyQt6.sip.wrapper):
    ...
    def setParentLayoutItem(
        self, parent: typing.Optional["QGraphicsLayoutItem"]
    ) -> None: ...
...
class QGraphicsLayout(QGraphicsLayoutItem):
    ...
    def addChildLayoutItem(
        self, layoutItem: typing.Optional[QGraphicsLayoutItem]
    ) -> None: ...
    def updateGeometry(self) -> None: ...
...
class QGraphicsAnchorLayout(QGraphicsLayout):
    ...
    def addAnchors(
        self,
        firstItem: typing.Optional[QGraphicsLayoutItem],
        secondItem: typing.Optional[QGraphicsLayoutItem],
    ...
    ) -> typing.Optional[QGraphicsAnchor]: ...
    def addAnchor(
        self,
        firstItem: typing.Optional[QGraphicsLayoutItem],
        firstEdge: QtCore.Qt.AnchorPoint,
...
class QGraphicsColorizeEffect(QGraphicsEffect):
    ...
    def setColor(
        self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
...
class QGraphicsOpacityEffect(QGraphicsEffect):
    ...
    def setOpacityMask(
        ...
        mask: typing.Union[
            QtGui.QBrush,
            typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int],
            QtGui.QGradient,
        ],
    ) -> None: ...
...
class QGraphicsGridLayout(QGraphicsLayout):
    ...
    def rowCount(self) -> int: ...
    def alignment(
        self, item: typing.Optional[QGraphicsLayoutItem]
    ) -> QtCore.Qt.AlignmentFlag: ...
    def setAlignment(
        self,
        item: typing.Optional[QGraphicsLayoutItem],
        alignment: QtCore.Qt.AlignmentFlag,
    ) -> None: ...
...
class QGraphicsItem(PyQt6.sip.wrapper):
    ...
    class GraphicsItemFlag(enum.Flag):
        ...
        ItemDoesntPropagateOpacityToChildren = (
            ...
        )  # type: QGraphicsItem.GraphicsItemFlag
    ...
    def isBlockedByModalPanel(
        self,
    ) -> typing.Tuple[bool, typing.Optional["QGraphicsItem"]]: ...
    ...
    @typing.overload
    def mapRectFromItem(
        self, item: typing.Optional["QGraphicsItem"], rect: QtCore.QRectF
    ) -> QtCore.QRectF: ...
    @typing.overload
    def mapRectFromItem(
        self,
        item: typing.Optional["QGraphicsItem"],
        ax: float,
        ay: float,
        w: float,
        h: float,
    ...
    def itemTransform(
        self, other: typing.Optional["QGraphicsItem"]
    ) -> typing.Tuple[QtGui.QTransform, typing.Optional[bool]]: ...
    def setOpacity(self, opacity: float) -> None: ...
    ...
    def setCacheMode(
        self, mode: "QGraphicsItem.CacheMode", logicalCacheSize: QtCore.QSize = ...
    ) -> None: ...
    ...
    def wheelEvent(
        self, event: typing.Optional["QGraphicsSceneWheelEvent"]
    ) -> None: ...
    def sceneEventFilter(
        self,
        watched: typing.Optional["QGraphicsItem"],
        event: typing.Optional[QtCore.QEvent],
    ) -> bool: ...
    ...
    def hoverMoveEvent(
        self, event: typing.Optional["QGraphicsSceneHoverEvent"]
    ) -> None: ...
    def hoverLeaveEvent(
        self, event: typing.Optional["QGraphicsSceneHoverEvent"]
    ) -> None: ...
    ...
    def dropEvent(
        self, event: typing.Optional["QGraphicsSceneDragDropEvent"]
    ) -> None: ...
    def dragMoveEvent(
        self, event: typing.Optional["QGraphicsSceneDragDropEvent"]
    ) -> None: ...
    ...
    def contextMenuEvent(
        self, event: typing.Optional["QGraphicsSceneContextMenuEvent"]
    ) -> None: ...
    def removeSceneEventFilter(
        self, filterItem: typing.Optional["QGraphicsItem"]
    ) -> None: ...
    ...
    @typing.overload
    def mapFromItem(
        self, item: typing.Optional["QGraphicsItem"], point: QtCore.QPointF
    ) -> QtCore.QPointF: ...
    @typing.overload
    def mapFromItem(
        self, item: typing.Optional["QGraphicsItem"], rect: QtCore.QRectF
    ...
    @typing.overload
    def mapFromItem(
        self, item: typing.Optional["QGraphicsItem"], polygon: QtGui.QPolygonF
    ) -> QtGui.QPolygonF: ...
    @typing.overload
    def mapFromItem(
        self, item: typing.Optional["QGraphicsItem"], path: QtGui.QPainterPath
    ) -> QtGui.QPainterPath: ...
    @typing.overload
    def mapFromItem(
        self, item: typing.Optional["QGraphicsItem"], ax: float, ay: float
    ) -> QtCore.QPointF: ...
    @typing.overload
    def mapFromItem(
        self,
    ...
    def collidesWithItem(
        self,
        other: typing.Optional["QGraphicsItem"],
    ...
    def setCursor(
        self, cursor: typing.Union[QtGui.QCursor, QtCore.Qt.CursorShape]
    ) -> None: ...
    def cursor(self) -> QtGui.QCursor: ...
...
class QAbstractGraphicsShapeItem(QGraphicsItem):
    ...
    def setPen(
        self,
        pen: typing.Union[
            QtGui.QPen, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]
        ],
    ) -> None: ...
...
class QGraphicsSimpleTextItem(QAbstractGraphicsShapeItem):
    ...
    @typing.overload
    def __init__(
        self, text: typing.Optional[str], parent: typing.Optional[QGraphicsItem] = ...
    ) -> None: ...
    def type(self) -> int: ...
    def opaqueArea(self) -> QtGui.QPainterPath: ...
    def isObscuredBy(self, item: typing.Optional[QGraphicsItem]) -> bool: ...
...
class QGraphicsLinearLayout(QGraphicsLayout):
    ...
    def __init__(
        self,
        orientation: QtCore.Qt.Orientation,
        parent: typing.Optional[QGraphicsLayoutItem] = ...,
    ) -> None: ...
    def sizeHint(
        self, which: QtCore.Qt.SizeHint, constraint: QtCore.QSizeF = ...
    ) -> QtCore.QSizeF: ...
    ...
    def setStretchFactor(
        self, item: typing.Optional[QGraphicsLayoutItem], stretch: int
    ) -> None: ...
    ...
    def insertStretch(self, index: int, stretch: int = ...) -> None: ...
    def insertItem(
        self, index: int, item: typing.Optional[QGraphicsLayoutItem]
    ) -> None: ...
    def addStretch(self, stretch: int = ...) -> None: ...
...
class QGraphicsWidget(QGraphicsObject, QGraphicsLayoutItem):
    ...
    def resizeEvent(
        self, event: typing.Optional["QGraphicsSceneResizeEvent"]
    ) -> None: ...
    ...
    @staticmethod
    def setTabOrder(
        first: typing.Optional["QGraphicsWidget"],
        second: typing.Optional["QGraphicsWidget"],
    ) -> None: ...
    def setFocusPolicy(self, policy: QtCore.Qt.FocusPolicy) -> None: ...
    def focusPolicy(self) -> QtCore.Qt.FocusPolicy: ...
    def windowTitle(self) -> str: ...
...
class QGraphicsProxyWidget(QGraphicsWidget):
    ...
    def inputMethodQuery(self, query: QtCore.Qt.InputMethodQuery) -> typing.Any: ...
    def newProxyWidget(
        self, a0: typing.Optional[QWidget]
    ) -> typing.Optional["QGraphicsProxyWidget"]: ...
    def dropEvent(
        self, event: typing.Optional["QGraphicsSceneDragDropEvent"]
    ) -> None: ...
    def dragMoveEvent(
    ...
    def createProxyForChildWidget(
        self, child: typing.Optional[QWidget]
    ) -> typing.Optional["QGraphicsProxyWidget"]: ...
    def type(self) -> int: ...
    def paint(
        self,
...
class QGraphicsScene(QtCore.QObject):
    ...
    def style(self) -> typing.Optional[QStyle]: ...
    def addWidget(
        self, widget: typing.Optional[QWidget], flags: QtCore.Qt.WindowType = ...
    ) -> typing.Optional[QGraphicsProxyWidget]: ...
    def selectionArea(self) -> QtGui.QPainterPath: ...
    def setBspTreeDepth(self, depth: int) -> None: ...
    def bspTreeDepth(self) -> int: ...
    def drawForeground(
        self, painter: typing.Optional[QtGui.QPainter], rect: QtCore.QRectF
    ) -> None: ...
    def drawBackground(
        self, painter: typing.Optional[QtGui.QPainter], rect: QtCore.QRectF
    ) -> None: ...
    ...
    @typing.overload
    def invalidate(
        self, rect: QtCore.QRectF = ..., layers: "QGraphicsScene.SceneLayer" = ...
    ) -> None: ...
    @typing.overload
    def invalidate(
        self,
    ...
    def addText(
        self, text: typing.Optional[str], font: QtGui.QFont = ...
    ) -> typing.Optional[QGraphicsTextItem]: ...
    def addSimpleText(
        self, text: typing.Optional[str], font: QtGui.QFont = ...
    ) -> typing.Optional[QGraphicsSimpleTextItem]: ...
    @typing.overload
    def addRect(
        self,
        rect: QtCore.QRectF,
    ...
    ) -> typing.Optional[QGraphicsPolygonItem]: ...
    def addPixmap(
        self, pixmap: QtGui.QPixmap
    ) -> typing.Optional[QGraphicsPixmapItem]: ...
    def addPath(
        self,
    ...
    ) -> typing.Optional[QGraphicsPathItem]: ...
    @typing.overload
    def addLine(
        self,
        line: QtCore.QLineF,
    ...
    ) -> typing.Optional[QGraphicsEllipseItem]: ...
    @typing.overload
    def addEllipse(
        self,
        x: float,
    ...
    ) -> typing.Optional[QGraphicsItemGroup]: ...
    def clearSelection(self) -> None: ...
    @typing.overload
...
class QGraphicsView(QAbstractScrollArea):
    ...
    def __init__(
        self,
        scene: typing.Optional[QGraphicsScene],
        parent: typing.Optional[QWidget] = ...,
    ) -> None: ...
    ...
    def mousePressEvent(self, event: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def mouseDoubleClickEvent(
        self, event: typing.Optional[QtGui.QMouseEvent]
    ) -> None: ...
    def keyReleaseEvent(self, event: typing.Optional[QtGui.QKeyEvent]) -> None: ...
    def keyPressEvent(self, event: typing.Optional[QtGui.QKeyEvent]) -> None: ...
    def focusNextPrevChild(self, next: bool) -> bool: ...
    ...
    def contextMenuEvent(
        self, event: typing.Optional[QtGui.QContextMenuEvent]
    ) -> None: ...
    ...
    @typing.overload
    def items(
        self, x: int, y: int, w: int, h: int, mode: QtCore.Qt.ItemSelectionMode = ...
    ) -> list[QGraphicsItem]: ...
    @typing.overload
    def items(
...
class QGridLayout(QLayout):
    ...
    def addItem(
        self,
        item: typing.Optional[QLayoutItem],
        row: int,
        column: int,
        rowSpan: int = ...,
        columnSpan: int = ...,
...
class QGroupBox(QWidget):
    ...
    @typing.overload
    def __init__(
        self, title: typing.Optional[str], parent: typing.Optional[QWidget] = ...
    ) -> None: ...
    def mouseReleaseEvent(self, event: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def mouseMoveEvent(self, event: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def mousePressEvent(self, event: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    ...
    def event(self, a0: typing.Optional[QtCore.QEvent]) -> bool: ...
    def initStyleOption(
        self, option: typing.Optional["QStyleOptionGroupBox"]
    ) -> None: ...
    toggled: typing.ClassVar[QtCore.pyqtSignal]
    clicked: typing.ClassVar[QtCore.pyqtSignal]
...
class QHeaderView(QAbstractItemView):
    ...
    def initStyleOptionForIndex(
        self, option: typing.Optional["QStyleOptionHeader"], logicalIndex: int
    ) -> None: ...
    def initStyleOption(
        self, option: typing.Optional["QStyleOptionHeader"]
    ) -> None: ...
    ...
    def setSelection(
        self, rect: QtCore.QRect, flags: QtCore.QItemSelectionModel.SelectionFlag
    ) -> None: ...
    def moveCursor(
        self, a0: QAbstractItemView.CursorAction, a1: QtCore.Qt.KeyboardModifier
    ) -> QtCore.QModelIndex: ...
    def isIndexHidden(self, index: QtCore.QModelIndex) -> bool: ...
    def indexAt(self, p: QtCore.QPoint) -> QtCore.QModelIndex: ...
    def scrollTo(
    ...
    def headerDataChanged(
        self, orientation: QtCore.Qt.Orientation, logicalFirst: int, logicalLast: int
    ) -> None: ...
...
class QInputDialog(QDialog):
    ...
    def setComboBoxItems(
        self, items: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    ...
    def getItem(
        ...
        title: typing.Optional[str],
        label: typing.Optional[str],
        items: collections.abc.Iterable[typing.Optional[str]],
        current: int = ...,
        editable: bool = ...,
        flags: QtCore.Qt.WindowType = ...,
        inputMethodHints: QtCore.Qt.InputMethodHint = ...,
...
class QItemDelegate(QAbstractItemDelegate):
    ...
    def setItemEditorFactory(
        self, factory: typing.Optional["QItemEditorFactory"]
    ) -> None: ...
...
class QItemEditorCreatorBase(PyQt6.sip.wrapper):
    ...
    def createWidget(
        self, parent: typing.Optional[QWidget]
    ) -> typing.Optional[QWidget]: ...
...
class QItemEditorFactory(PyQt6.sip.wrapper):
    ...
    def registerEditor(
        self, userType: int, creator: typing.Optional[QItemEditorCreatorBase]
    ) -> None: ...
    def valuePropertyName(self, userType: int) -> QtCore.QByteArray: ...
    def createEditor(
        self, userType: int, parent: typing.Optional[QWidget]
    ) -> typing.Optional[QWidget]: ...
...
class QKeySequenceEdit(QWidget):
    ...
    def setFinishingKeyCombinations(
        self, finishingKeyCombinations: collections.abc.Iterable[QtCore.QKeyCombination]
    ) -> None: ...
...
class QLabel(QFrame):
    ...
    def contextMenuEvent(
        self, ev: typing.Optional[QtGui.QContextMenuEvent]
    ) -> None: ...
...
class QLCDNumber(QFrame):
    ...
    @typing.overload
    def __init__(
        self, numDigits: int, parent: typing.Optional[QWidget] = ...
    ) -> None: ...
    def paintEvent(self, a0: typing.Optional[QtGui.QPaintEvent]) -> None: ...
    def event(self, e: typing.Optional[QtCore.QEvent]) -> bool: ...
...
class QLineEdit(QWidget):
    ...
    @typing.overload
    def __init__(
        self, contents: typing.Optional[str], parent: typing.Optional[QWidget] = ...
    ) -> None: ...
...
class QListWidget(QListView):
    ...
    def isPersistentEditorOpen(
        self, item: typing.Optional[QListWidgetItem]
    ) -> bool: ...
    def setSelectionModel(
        self, selectionModel: typing.Optional[QtCore.QItemSelectionModel]
    ) -> None: ...
    ...
    def itemFromIndex(
        self, index: QtCore.QModelIndex
    ) -> typing.Optional[QListWidgetItem]: ...
    def indexFromItem(
        self, item: typing.Optional[QListWidgetItem]
    ) -> QtCore.QModelIndex: ...
    def items(
        self, data: typing.Optional[QtCore.QMimeData]
    ...
    def dropMimeData(
        self,
        index: int,
        data: typing.Optional[QtCore.QMimeData],
        action: QtCore.Qt.DropAction,
    ) -> bool: ...
    def mimeData(
        self, items: collections.abc.Iterable[QListWidgetItem]
    ) -> typing.Optional[QtCore.QMimeData]: ...
    ...
    def scrollToItem(
        self,
        item: typing.Optional[QListWidgetItem],
    ...
    def setItemWidget(
        self, item: typing.Optional[QListWidgetItem], widget: typing.Optional[QWidget]
    ) -> None: ...
    def itemWidget(
        self, item: typing.Optional[QListWidgetItem]
    ) -> typing.Optional[QWidget]: ...
    ...
    def addItems(
        self, labels: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    @typing.overload
    ...
    def insertItems(
        self, row: int, labels: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    @typing.overload
...
class QMainWindow(QWidget):
    ...
    def tabifiedDockWidgets(
        self, dockwidget: typing.Optional[QDockWidget]
    ) -> list[QDockWidget]: ...
    def setTabPosition(
        self, areas: QtCore.Qt.DockWidgetArea, tabPosition: "QTabWidget.TabPosition"
    ) -> None: ...
    def tabPosition(
    ...
    def tabifyDockWidget(
        self, first: typing.Optional[QDockWidget], second: typing.Optional[QDockWidget]
    ) -> None: ...
    ...
    def restoreState(
        self,
        state: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        version: int = ...,
    ) -> bool: ...
    ...
    def splitDockWidget(
        self,
        after: typing.Optional[QDockWidget],
        dockwidget: typing.Optional[QDockWidget],
        orientation: QtCore.Qt.Orientation,
    ) -> None: ...
    @typing.overload
    def addDockWidget(
        self, area: QtCore.Qt.DockWidgetArea, dockwidget: typing.Optional[QDockWidget]
    ) -> None: ...
    @typing.overload
    def addDockWidget(
        self,
    ...
    def toolBarArea(
        self, toolbar: typing.Optional["QToolBar"]
    ) -> QtCore.Qt.ToolBarArea: ...
    def removeToolBar(self, toolbar: typing.Optional["QToolBar"]) -> None: ...
    def insertToolBar(
        self, before: typing.Optional["QToolBar"], toolbar: typing.Optional["QToolBar"]
    ) -> None: ...
    @typing.overload
    def addToolBar(
        self, area: QtCore.Qt.ToolBarArea, toolbar: typing.Optional["QToolBar"]
    ) -> None: ...
    @typing.overload
    def addToolBar(self, toolbar: typing.Optional["QToolBar"]) -> None: ...
    @typing.overload
    def addToolBar(
        self, title: typing.Optional[str]
    ) -> typing.Optional["QToolBar"]: ...
...
class QMdiSubWindow(QWidget):
    ...
    def childEvent(self, childEvent: typing.Optional[QtCore.QChildEvent]) -> None: ...
    def focusOutEvent(
        self, focusOutEvent: typing.Optional[QtGui.QFocusEvent]
    ) -> None: ...
    def focusInEvent(
        self, focusInEvent: typing.Optional[QtGui.QFocusEvent]
    ) -> None: ...
    def contextMenuEvent(
        self, contextMenuEvent: typing.Optional[QtGui.QContextMenuEvent]
    ) -> None: ...
    def keyPressEvent(self, keyEvent: typing.Optional[QtGui.QKeyEvent]) -> None: ...
    def mouseMoveEvent(
        self, mouseEvent: typing.Optional[QtGui.QMouseEvent]
    ) -> None: ...
    def mouseReleaseEvent(
        self, mouseEvent: typing.Optional[QtGui.QMouseEvent]
    ) -> None: ...
...
class QMenu(QWidget):
    ...
    @typing.overload
    def insertSection(
        self, before: typing.Optional[QtGui.QAction], text: typing.Optional[str]
    ) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def insertSection(
        self,
    ...
    def initStyleOption(
        self,
        option: typing.Optional["QStyleOptionMenuItem"],
        action: typing.Optional[QtGui.QAction],
    ) -> None: ...
    def columnCount(self) -> int: ...
    ...
    @typing.overload
    def exec(
        self, p: QtCore.QPoint, action: typing.Optional[QtGui.QAction] = ...
    ) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    @staticmethod
    def exec(
        actions: collections.abc.Iterable[QtGui.QAction],
        pos: QtCore.QPoint,
        at: typing.Optional[QtGui.QAction] = ...,
        parent: typing.Optional[QWidget] = ...,
    ) -> typing.Optional[QtGui.QAction]: ...
    def popup(
        self, p: QtCore.QPoint, action: typing.Optional[QtGui.QAction] = ...
    ...
    def clear(self) -> None: ...
    def insertSeparator(
        self, before: typing.Optional[QtGui.QAction]
    ) -> typing.Optional[QtGui.QAction]: ...
    def insertMenu(
        self, before: typing.Optional[QtGui.QAction], menu: typing.Optional["QMenu"]
    ) -> typing.Optional[QtGui.QAction]: ...
    def addSeparator(self) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addMenu(
        self, menu: typing.Optional["QMenu"]
    ) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addMenu(self, title: typing.Optional[str]) -> typing.Optional["QMenu"]: ...
    @typing.overload
    def addMenu(
        self, icon: QtGui.QIcon, title: typing.Optional[str]
    ) -> typing.Optional["QMenu"]: ...
...
class QMenuBar(QWidget):
    ...
    def setCornerWidget(
        self, widget: typing.Optional[QWidget], corner: QtCore.Qt.Corner = ...
    ) -> None: ...
    def actionAt(self, a0: QtCore.QPoint) -> typing.Optional[QtGui.QAction]: ...
    def actionGeometry(self, a0: typing.Optional[QtGui.QAction]) -> QtCore.QRect: ...
    def heightForWidth(self, a0: int) -> int: ...
...
class QMessageBox(QDialog):
    ...
    ) -> typing.Optional[QAbstractButton]: ...
    def standardButton(
        self, button: typing.Optional[QAbstractButton]
    ...
    @typing.overload
    def addButton(
        self, button: typing.Optional[QAbstractButton], role: "QMessageBox.ButtonRole"
    ) -> None: ...
    @typing.overload
    def addButton(
        self, text: typing.Optional[str], role: "QMessageBox.ButtonRole"
    ) -> typing.Optional[QPushButton]: ...
    @typing.overload
    def addButton(
    ...
    @staticmethod
    def aboutQt(
        parent: typing.Optional[QWidget], title: typing.Optional[str] = ...
    ) -> None: ...
    @staticmethod
    def about(
        parent: typing.Optional[QWidget],
...
class QPlainTextEdit(QAbstractScrollArea):
    ...
    def canInsertFromMimeData(
        self, source: typing.Optional[QtCore.QMimeData]
    ) -> bool: ...
    ...
    @typing.overload
    def find(
        self, exp: typing.Optional[str], options: QtGui.QTextDocument.FindFlag = ...
    ) -> bool: ...
    @typing.overload
    def find(
        self,
...
class QPlainTextDocumentLayout(QtGui.QAbstractTextDocumentLayout):
    ...
    def frameBoundingRect(
        self, a0: typing.Optional[QtGui.QTextFrame]
    ) -> QtCore.QRectF: ...
    ...
    def draw(
        self,
        a0: typing.Optional[QtGui.QPainter],
...
class QProgressBar(QWidget):
    ...
    def event(self, e: typing.Optional[QtCore.QEvent]) -> bool: ...
    def initStyleOption(
        self, option: typing.Optional["QStyleOptionProgressBar"]
    ) -> None: ...
    valueChanged: typing.ClassVar[QtCore.pyqtSignal]
    def setOrientation(self, a0: QtCore.Qt.Orientation) -> None: ...
...
class QProgressDialog(QDialog):
    ...
    def __init__(
        self,
        labelText: typing.Optional[str],
        cancelButtonText: typing.Optional[str],
        minimum: int,
        maximum: int,
        parent: typing.Optional[QWidget] = ...,
        flags: QtCore.Qt.WindowType = ...,
...
class QProxyStyle(QCommonStyle):
    ...
    def hitTestComplexControl(
        ...
        option: typing.Optional["QStyleOptionComplex"],
        pos: QtCore.QPoint,
        widget: typing.Optional[QWidget] = ...,
    ) -> QStyle.SubControl: ...
    def itemPixmapRect(
...
class QRadioButton(QAbstractButton):
    ...
    def initStyleOption(
        self, button: typing.Optional["QStyleOptionButton"]
    ) -> None: ...
    def minimumSizeHint(self) -> QtCore.QSize: ...
    def sizeHint(self) -> QtCore.QSize: ...
...
class QRubberBand(QWidget):
    ...
    def __init__(
        self, a0: "QRubberBand.Shape", parent: typing.Optional[QWidget] = ...
    ) -> None: ...
    def moveEvent(self, a0: typing.Optional[QtGui.QMoveEvent]) -> None: ...
    def resizeEvent(self, a0: typing.Optional[QtGui.QResizeEvent]) -> None: ...
    def showEvent(self, a0: typing.Optional[QtGui.QShowEvent]) -> None: ...
    ...
    def event(self, e: typing.Optional[QtCore.QEvent]) -> bool: ...
    def initStyleOption(
        self, option: typing.Optional["QStyleOptionRubberBand"]
    ) -> None: ...
    @typing.overload
    def resize(self, w: int, h: int) -> None: ...
    @typing.overload
...
class QScrollArea(QAbstractScrollArea):
    ...
    def ensureWidgetVisible(
        self,
        childWidget: typing.Optional[QWidget],
        xMargin: int = ...,
        yMargin: int = ...,
    ) -> None: ...
    def ensureVisible(
...
class QScroller(QtCore.QObject):
    ...
    def stop(self) -> None: ...
    def handleInput(
        self, input: "QScroller.Input", position: QtCore.QPointF, timestamp: int = ...
    ) -> bool: ...
    ...
    @staticmethod
    def grabbedGesture(
        target: typing.Optional[QtCore.QObject],
    ) -> QtCore.Qt.GestureType: ...
    @staticmethod
    def grabGesture(
        target: typing.Optional[QtCore.QObject],
...
class QSplashScreen(QWidget):
    ...
    def __init__(
        self,
        screen: typing.Optional[QtGui.QScreen],
        pixmap: QtGui.QPixmap = ...,
        flags: QtCore.Qt.WindowType = ...,
    ) -> None: ...
    def mousePressEvent(self, a0: typing.Optional[QtGui.QMouseEvent]) -> None: ...
...
class QSplitter(QFrame):
    ...
    def replaceWidget(
        self, index: int, widget: typing.Optional[QWidget]
    ) -> typing.Optional[QWidget]: ...
...
class QSplitterHandle(QWidget):
    def __init__(
        self, o: QtCore.Qt.Orientation, parent: typing.Optional[QSplitter]
    ) -> None: ...
    def resizeEvent(self, a0: typing.Optional[QtGui.QResizeEvent]) -> None: ...
...
class QStatusBar(QWidget):
    ...
    def insertPermanentWidget(
        self, index: int, widget: typing.Optional[QWidget], stretch: int = ...
    ) -> int: ...
    def insertWidget(
        self, index: int, widget: typing.Optional[QWidget], stretch: int = ...
    ) -> int: ...
    ...
    def addPermanentWidget(
        self, widget: typing.Optional[QWidget], stretch: int = ...
    ) -> None: ...
    def addWidget(
        self, widget: typing.Optional[QWidget], stretch: int = ...
    ) -> None: ...
...
class QStyledItemDelegate(QAbstractItemDelegate):
    ...
    def initStyleOption(
        self, option: typing.Optional["QStyleOptionViewItem"], index: QtCore.QModelIndex
    ) -> None: ...
...
class QStyleOptionFocusRect(QStyleOption):
    ...
    backgroundColor = (
        ...
    )  # type: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]
...
class QStyleOptionViewItem(QStyleOption):
    ...
    backgroundBrush = (
        ...
    )  # type: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]
...
class QStylePainter(QtGui.QPainter):
    ...
    @typing.overload
    def __init__(
        self, pd: typing.Optional[QtGui.QPaintDevice], w: typing.Optional[QWidget]
    ) -> None: ...
    def drawItemPixmap(
        self, r: QtCore.QRect, flags: int, pixmap: QtGui.QPixmap
    ) -> None: ...
...
class QTabBar(QWidget):
    ...
    def initStyleOption(
        self, option: typing.Optional[QStyleOptionTab], tabIndex: int
    ) -> None: ...
    currentChanged: typing.ClassVar[QtCore.pyqtSignal]
    def setCurrentIndex(self, index: int) -> None: ...
    ...
    def setTabTextColor(
        self, index: int, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
    ...
    @typing.overload
    def insertTab(
        self, index: int, icon: QtGui.QIcon, text: typing.Optional[str]
    ) -> int: ...
    @typing.overload
...
class QTableWidgetItem(PyQt6.sip.wrapper):
    ...
    @typing.overload
    def __init__(
        self, icon: QtGui.QIcon, text: typing.Optional[str], type: int = ...
    ) -> None: ...
    @typing.overload
...
class QTableWidget(QTableView):
    ...
    def itemFromIndex(
        self, index: QtCore.QModelIndex
    ) -> typing.Optional[QTableWidgetItem]: ...
    def indexFromItem(
        self, item: typing.Optional[QTableWidgetItem]
    ) -> QtCore.QModelIndex: ...
    def items(
    ...
    def setCellWidget(
        self, row: int, column: int, widget: typing.Optional[QWidget]
    ) -> None: ...
    ...
    @typing.overload
    def setCurrentCell(
        self, row: int, column: int, command: QtCore.QItemSelectionModel.SelectionFlag
    ) -> None: ...
    @typing.overload
    ...
    def setHorizontalHeaderItem(
        self, column: int, item: typing.Optional[QTableWidgetItem]
    ) -> None: ...
    ...
    def setItem(
        self, row: int, column: int, item: typing.Optional[QTableWidgetItem]
    ) -> None: ...
...
class QTabWidget(QWidget):
    ...
    def tabInserted(self, index: int) -> None: ...
    def initStyleOption(
        self, option: typing.Optional[QStyleOptionTabWidgetFrame]
    ) -> None: ...
    currentChanged: typing.ClassVar[QtCore.pyqtSignal]
    ...
    @typing.overload
    def insertTab(
        self, index: int, widget: typing.Optional[QWidget], a2: typing.Optional[str]
    ) -> int: ...
    @typing.overload
    def insertTab(
        self,
    ...
    @typing.overload
    def addTab(
        self, widget: typing.Optional[QWidget], a1: typing.Optional[str]
    ) -> int: ...
    @typing.overload
    def addTab(
        self,
...
class QToolBar(QWidget):
    ...
    def setIconSize(self, iconSize: QtCore.QSize) -> None: ...
    def widgetForAction(
        self, action: typing.Optional[QtGui.QAction]
    ) -> typing.Optional[QWidget]: ...
    def toolButtonStyle(self) -> QtCore.Qt.ToolButtonStyle: ...
    def iconSize(self) -> QtCore.QSize: ...
    def toggleViewAction(self) -> typing.Optional[QtGui.QAction]: ...
    ...
    def insertWidget(
        self, before: typing.Optional[QtGui.QAction], widget: typing.Optional[QWidget]
    ) -> typing.Optional[QtGui.QAction]: ...
    def addWidget(
        self, widget: typing.Optional[QWidget]
    ) -> typing.Optional[QtGui.QAction]: ...
...
class QToolBox(QFrame):
    ...
    @typing.overload
    def insertItem(
        self, index: int, item: typing.Optional[QWidget], text: typing.Optional[str]
    ) -> int: ...
    @typing.overload
    def insertItem(
        self,
    ...
    @typing.overload
    def addItem(
        self, item: typing.Optional[QWidget], text: typing.Optional[str]
    ) -> int: ...
    @typing.overload
    def addItem(
        self,
        item: typing.Optional[QWidget],
        iconSet: QtGui.QIcon,
        text: typing.Optional[str],
    ) -> int: ...
...
class QToolButton(QAbstractButton):
    ...
    def event(self, e: typing.Optional[QtCore.QEvent]) -> bool: ...
    def initStyleOption(
        self, option: typing.Optional[QStyleOptionToolButton]
    ) -> None: ...
    triggered: typing.ClassVar[QtCore.pyqtSignal]
    def setDefaultAction(self, a0: typing.Optional[QtGui.QAction]) -> None: ...
...
class QTreeView(QAbstractItemView):
    ...
    def mousePressEvent(self, e: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def drawTree(
        self, painter: typing.Optional[QtGui.QPainter], region: QtGui.QRegion
    ) -> None: ...
    def drawBranches(
        self,
        painter: typing.Optional[QtGui.QPainter],
...
class QTreeWidgetItem(PyQt6.sip.wrapper):
    class ChildIndicatorPolicy(enum.Enum):
        ...
        DontShowIndicatorWhenChildless = (
            ...
        )  # type: QTreeWidgetItem.ChildIndicatorPolicy
    ...
    def __init__(
        self,
        parent: typing.Optional["QTreeWidgetItem"],
        after: typing.Optional["QTreeWidgetItem"],
        type: int = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        parent: typing.Optional["QTreeWidgetItem"],
        strings: collections.abc.Iterable[typing.Optional[str]],
        type: int = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self, parent: typing.Optional["QTreeWidgetItem"], type: int = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        parent: typing.Optional["QTreeWidget"],
        after: typing.Optional["QTreeWidgetItem"],
        type: int = ...,
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def __init__(
        self, parent: typing.Optional["QTreeWidget"], type: int = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, strings: collections.abc.Iterable[typing.Optional[str]], type: int = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, type: int = ...) -> None: ...
    @typing.overload
    ...
    def insertChild(
        self, index: int, child: typing.Optional["QTreeWidgetItem"]
    ) -> None: ...
...
class QTreeWidget(QTreeView):
    ...
    def supportedDragActions(self) -> QtCore.Qt.DropAction: ...
    def isPersistentEditorOpen(
        self, item: typing.Optional[QTreeWidgetItem], column: int = ...
    ) -> bool: ...
    def setSelectionModel(
        self, selectionModel: typing.Optional[QtCore.QItemSelectionModel]
    ) -> None: ...
    ...
    def itemBelow(
        self, item: typing.Optional[QTreeWidgetItem]
    ) -> typing.Optional[QTreeWidgetItem]: ...
    def itemAbove(
        self, item: typing.Optional[QTreeWidgetItem]
    ) -> typing.Optional[QTreeWidgetItem]: ...
    ...
    def scrollToItem(
        self,
        item: typing.Optional[QTreeWidgetItem],
        hint: QAbstractItemView.ScrollHint = ...,
    ) -> None: ...
    def findItems(
        self, text: typing.Optional[str], flags: QtCore.Qt.MatchFlag, column: int = ...
    ...
    def insertTopLevelItem(
        self, index: int, item: typing.Optional[QTreeWidgetItem]
    ) -> None: ...
...
class QTreeWidgetItemIterator(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        widget: typing.Optional[QTreeWidget],
        flags: "QTreeWidgetItemIterator.IteratorFlag" = ...,
    ) -> None: ...
    @typing.overload
...
class QUndoView(QListView):
    ...
    def __init__(
        self,
        stack: typing.Optional[QtGui.QUndoStack],
        parent: typing.Optional[QWidget] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        group: typing.Optional[QtGui.QUndoGroup],
        parent: typing.Optional[QWidget] = ...,
    ) -> None: ...
...
class QWizard(QDialog):
    ...
    def setButton(
        self, which: "QWizard.WizardButton", button: typing.Optional[QAbstractButton]
    ) -> None: ...
    def setButtonLayout(
    ...
    def setButtonText(
        self, which: "QWizard.WizardButton", text: typing.Optional[str]
    ) -> None: ...
...
def qDrawPlainRoundedRect(
    ...
    rx: float,
    ry: float,
    lineColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int],
    lineWidth: int = ...,
...
def qDrawPlainRoundedRect(
    ...
    rx: float,
    ry: float,
    a7: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int],
    lineWidth: int = ...,
    fill: typing.Optional[
        typing.Union[
            QtGui.QBrush,
...
def qDrawPlainRect(
    ...
    w: int,
    h: int,
    a5: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int],
    lineWidth: int = ...,
    fill: typing.Optional[
        typing.Union[
            QtGui.QBrush,
...
def qDrawPlainRect(
    p: typing.Optional[QtGui.QPainter],
    r: QtCore.QRect,
    a2: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int],
    lineWidth: int = ...,
    fill: typing.Optional[
        typing.Union[
            QtGui.QBrush,
