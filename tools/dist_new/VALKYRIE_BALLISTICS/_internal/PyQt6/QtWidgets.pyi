...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    def setAccessibleIdentifier(self, identifier: typing.Optional[str]) -> None: ...
    def accessibleIdentifier(self) -> str: ...
    def setScreen(self, a0: typing.Optional[QtGui.QScreen]) -> None: ...
    ...
    @staticmethod
    def createWindowContainer(window: typing.Optional[QtGui.QWindow], parent: typing.Optional['QWidget'] = ..., flags: QtCore.Qt.WindowType = ...) -> 'QWidget': ...
    ...
    @typing.overload
    def render(self, target: typing.Optional[QtGui.QPaintDevice], targetOffset: QtCore.QPoint = ..., sourceRegion: QtGui.QRegion = ..., flags: 'QWidget.RenderFlag' = ...) -> None: ...
    @typing.overload
    def render(self, painter: typing.Optional[QtGui.QPainter], targetOffset: QtCore.QPoint = ..., sourceRegion: QtGui.QRegion = ..., flags: 'QWidget.RenderFlag' = ...) -> None: ...
    def restoreGeometry(self, geometry: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]) -> bool: ...
    ...
    def enterEvent(self, event: typing.Optional[QtGui.QEnterEvent]) -> None: ...
    ...
    @typing.overload
    def childAt(self, p: QtCore.QPointF) -> typing.Optional['QWidget']: ...
    @typing.overload
    def childAt(self, ax: int, ay: int) -> typing.Optional['QWidget']: ...
    @staticmethod
    def find(a0: PyQt6.sip.voidptr) -> typing.Optional['QWidget']: ...
    ...
    def removeAction(self, action: typing.Optional[QtGui.QAction]) -> None: ...
    def insertActions(self, before: typing.Optional[QtGui.QAction], actions: collections.abc.Iterable[QtGui.QAction]) -> None: ...
    def insertAction(self, before: typing.Optional[QtGui.QAction], action: typing.Optional[QtGui.QAction]) -> None: ...
    def addActions(self, actions: collections.abc.Iterable[QtGui.QAction]) -> None: ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, text: typing.Optional[str]) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, text: typing.Optional[str], slot: PYQT_SLOT, type: QtCore.Qt.ConnectionType = ...) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, text: typing.Optional[str], shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, typing.Optional[str], int]) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, text: typing.Optional[str], shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, typing.Optional[str], int], slot: PYQT_SLOT, type: QtCore.Qt.ConnectionType = ...) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addAction(self, text: typing.Optional[str]) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addAction(self, text: typing.Optional[str], shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, typing.Optional[str], int]) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addAction(self, text: typing.Optional[str], slot: PYQT_SLOT, type: QtCore.Qt.ConnectionType = ...) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addAction(self, text: typing.Optional[str], shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, typing.Optional[str], int], slot: PYQT_SLOT, type: QtCore.Qt.ConnectionType = ...) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addAction(self, action: typing.Optional[QtGui.QAction]) -> None: ...
    ...
    @typing.overload
    def setParent(self, parent: typing.Optional['QWidget'], f: QtCore.Qt.WindowType) -> None: ...
    ...
    @typing.overload
    def mapFrom(self, a0: typing.Optional['QWidget'], a1: QtCore.QPointF) -> QtCore.QPointF: ...
    @typing.overload
    def mapTo(self, a0: typing.Optional['QWidget'], a1: QtCore.QPoint) -> QtCore.QPoint: ...
    @typing.overload
    def mapTo(self, a0: typing.Optional['QWidget'], a1: QtCore.QPointF) -> QtCore.QPointF: ...
    @typing.overload
...
class QAbstractItemDelegate(QtCore.QObject):
    ...
    def handleEditorEvent(self, object: typing.Optional[QtCore.QObject], event: typing.Optional[QtCore.QEvent]) -> bool: ...
...
class QAbstractScrollArea(QFrame):
    ...
    def addScrollBarWidget(self, widget: typing.Optional[QWidget], alignment: QtCore.Qt.AlignmentFlag) -> None: ...
...
class QAbstractItemView(QAbstractScrollArea):
    ...
    def initViewItemOption(self, option: typing.Optional['QStyleOptionViewItem']) -> None: ...
    ...
    def itemDelegateForIndex(self, index: QtCore.QModelIndex) -> typing.Optional[QAbstractItemDelegate]: ...
    ...
    def selectionCommand(self, index: QtCore.QModelIndex, event: typing.Optional[QtCore.QEvent] = ...) -> QtCore.QItemSelectionModel.SelectionFlag: ...
...
class QLayout(QtCore.QObject, QLayoutItem):
    ...
    def replaceWidget(self, from_: typing.Optional[QWidget], to: typing.Optional[QWidget], options: QtCore.Qt.FindChildOption = ...) -> typing.Optional[QLayoutItem]: ...
    def controlTypes(self) -> 'QSizePolicy.ControlType': ...
    def contentsMargins(self) -> QtCore.QMargins: ...
    def contentsRect(self) -> QtCore.QRect: ...
...
class QBoxLayout(QLayout):
    ...
    def insertWidget(self, index: int, widget: typing.Optional[QWidget], stretch: int = ..., alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    ...
    def addWidget(self, a0: typing.Optional[QWidget], stretch: int = ..., alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
...
class QCalendarWidget(QWidget):
    ...
    def setDateTextFormat(self, date: typing.Union[QtCore.QDate, datetime.date], format: QtGui.QTextCharFormat) -> None: ...
    @typing.overload
...
class QColorDialog(QDialog):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, initial: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], parent: typing.Optional[QWidget] = ...) -> None: ...
    ...
    def setCurrentColor(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    @staticmethod
    def setStandardColor(index: int, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    @staticmethod
    def standardColor(index: int) -> QtGui.QColor: ...
    @staticmethod
    def setCustomColor(index: int, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    @staticmethod
    def customColor(index: int) -> QtGui.QColor: ...
    @staticmethod
    def customCount() -> int: ...
    @staticmethod
    def getColor(initial: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int] = ..., parent: typing.Optional[QWidget] = ..., title: typing.Optional[str] = ..., options: 'QColorDialog.ColorDialogOption' = ...) -> QtGui.QColor: ...
...
class QComboBox(QWidget):
    ...
    def insertItems(self, index: int, texts: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
    @typing.overload
    ...
    def addItems(self, texts: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
    ...
    def findText(self, text: typing.Optional[str], flags: QtCore.Qt.MatchFlag = ...) -> int: ...
    def hasFrame(self) -> bool: ...
    def setFrame(self, a0: bool) -> None: ...
...
class QStyle(QtCore.QObject):
    ...
    def combinedLayoutSpacing(self, controls1: 'QSizePolicy.ControlType', controls2: 'QSizePolicy.ControlType', orientation: QtCore.Qt.Orientation, option: typing.Optional['QStyleOption'] = ..., widget: typing.Optional[QWidget] = ...) -> int: ...
...
class QCompleter(QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, list: collections.abc.Iterable[typing.Optional[str]], parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    ...
    def splitPath(self, path: typing.Optional[str]) -> list[str]: ...
...
class QDataWidgetMapper(QtCore.QObject):
    ...
    @typing.overload
    def addMapping(self, widget: typing.Optional[QWidget], section: int, propertyName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
...
class QDateTimeEdit(QAbstractSpinBox):
    ...
    @typing.overload
    def __init__(self, d: typing.Union[QtCore.QDate, datetime.date], parent: typing.Optional[QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, t: typing.Union[QtCore.QTime, datetime.time], parent: typing.Optional[QWidget] = ...) -> None: ...
...
class QDialogButtonBox(QWidget):
    ...
    @typing.overload
    def __init__(self, buttons: 'QDialogButtonBox.StandardButton', parent: typing.Optional[QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, buttons: 'QDialogButtonBox.StandardButton', orientation: QtCore.Qt.Orientation, parent: typing.Optional[QWidget] = ...) -> None: ...
...
class QDockWidget(QWidget):
    ...
    @typing.overload
    def __init__(self, title: typing.Optional[str], parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
...
class QFileDialog(QDialog):
    ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QWidget], f: QtCore.Qt.WindowType) -> None: ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def saveFileContent(fileContent: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview], fileNameHint: typing.Optional[str] = ...) -> None: ...
    @typing.overload
    @staticmethod
    def saveFileContent(fileContent: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview], fileNameHint: typing.Optional[str], parent: typing.Optional[QWidget] = ...) -> None: ...
    def selectedMimeTypeFilter(self) -> str: ...
    def supportedSchemes(self) -> list[str]: ...
    def setSupportedSchemes(self, schemes: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
    @staticmethod
    def getSaveFileUrl(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: QtCore.QUrl = ..., filter: typing.Optional[str] = ..., initialFilter: typing.Optional[str] = ..., options: 'QFileDialog.Option' = ..., supportedSchemes: collections.abc.Iterable[typing.Optional[str]] = ...) -> tuple[QtCore.QUrl, str]: ...
    @staticmethod
    def getOpenFileUrls(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: QtCore.QUrl = ..., filter: typing.Optional[str] = ..., initialFilter: typing.Optional[str] = ..., options: 'QFileDialog.Option' = ..., supportedSchemes: collections.abc.Iterable[typing.Optional[str]] = ...) -> tuple[list[QtCore.QUrl], str]: ...
    @staticmethod
    def getOpenFileUrl(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: QtCore.QUrl = ..., filter: typing.Optional[str] = ..., initialFilter: typing.Optional[str] = ..., options: 'QFileDialog.Option' = ..., supportedSchemes: collections.abc.Iterable[typing.Optional[str]] = ...) -> tuple[QtCore.QUrl, str]: ...
    ...
    def setMimeTypeFilters(self, filters: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
    ...
    def restoreState(self, state: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]) -> bool: ...
    ...
    def done(self, result: int) -> None: ...
    @staticmethod
    def getSaveFileName(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: typing.Optional[str] = ..., filter: typing.Optional[str] = ..., initialFilter: typing.Optional[str] = ..., options: 'QFileDialog.Option' = ...) -> tuple[str, str]: ...
    @staticmethod
    def getOpenFileNames(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: typing.Optional[str] = ..., filter: typing.Optional[str] = ..., initialFilter: typing.Optional[str] = ..., options: 'QFileDialog.Option' = ...) -> tuple[list[str], str]: ...
    @staticmethod
    def getOpenFileName(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: typing.Optional[str] = ..., filter: typing.Optional[str] = ..., initialFilter: typing.Optional[str] = ..., options: 'QFileDialog.Option' = ...) -> tuple[str, str]: ...
    @staticmethod
    def getExistingDirectoryUrl(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: QtCore.QUrl = ..., options: 'QFileDialog.Option' = ..., supportedSchemes: collections.abc.Iterable[typing.Optional[str]] = ...) -> QtCore.QUrl: ...
    @staticmethod
    def getExistingDirectory(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: typing.Optional[str] = ..., options: 'QFileDialog.Option' = ...) -> str: ...
    ...
    def iconProvider(self) -> typing.Optional[QtGui.QAbstractFileIconProvider]: ...
    def setIconProvider(self, provider: typing.Optional[QtGui.QAbstractFileIconProvider]) -> None: ...
    def itemDelegate(self) -> typing.Optional[QAbstractItemDelegate]: ...
    def setItemDelegate(self, delegate: typing.Optional[QAbstractItemDelegate]) -> None: ...
    def history(self) -> list[str]: ...
    def setHistory(self, paths: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
...
class QFontComboBox(QComboBox):
    ...
    def displayFont(self, fontFamily: typing.Optional[str]) -> typing.Optional[QtGui.QFont]: ...
    def setDisplayFont(self, fontFamily: typing.Optional[str], font: QtGui.QFont) -> None: ...
    def sampleTextForFont(self, fontFamily: typing.Optional[str]) -> str: ...
    def setSampleTextForFont(self, fontFamily: typing.Optional[str], sampleText: typing.Optional[str]) -> None: ...
    def sampleTextForSystem(self, writingSystem: QtGui.QFontDatabase.WritingSystem) -> str: ...
    def setSampleTextForSystem(self, writingSystem: QtGui.QFontDatabase.WritingSystem, sampleText: typing.Optional[str]) -> None: ...
    def event(self, e: typing.Optional[QtCore.QEvent]) -> bool: ...
...
class QFontDialog(QDialog):
    ...
    @typing.overload
    @staticmethod
    def getFont(initial: QtGui.QFont, parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., options: 'QFontDialog.FontDialogOption' = ...) -> typing.Tuple[QtGui.QFont, typing.Optional[bool]]: ...
    @typing.overload
    @staticmethod
...
class QFormLayout(QLayout):
    ...
    @typing.overload
    def isRowVisible(self, layout: typing.Optional[QLayout]) -> bool: ...
    @typing.overload
    def isRowVisible(self, widget: typing.Optional[QWidget]) -> bool: ...
    @typing.overload
    def isRowVisible(self, row: int) -> bool: ...
    @typing.overload
    def setRowVisible(self, layout: typing.Optional[QLayout], on: bool) -> None: ...
    @typing.overload
    def setRowVisible(self, widget: typing.Optional[QWidget], on: bool) -> None: ...
    @typing.overload
...
class QGestureRecognizer(PyQt6.sip.wrapper):
    ...
    def recognize(self, state: typing.Optional[QGesture], watched: typing.Optional[QtCore.QObject], event: typing.Optional[QtCore.QEvent]) -> 'QGestureRecognizer.ResultFlag': ...
...
class QGraphicsAnchorLayout(QGraphicsLayout):
    ...
    def addAnchors(self, firstItem: typing.Optional[QGraphicsLayoutItem], secondItem: typing.Optional[QGraphicsLayoutItem], orientations: QtCore.Qt.Orientation = ...) -> None: ...
...
class QGraphicsColorizeEffect(QGraphicsEffect):
    ...
    def setColor(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QGraphicsOpacityEffect(QGraphicsEffect):
    ...
    def setOpacityMask(self, mask: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]) -> None: ...
...
class QGraphicsGridLayout(QGraphicsLayout):
    ...
    def rowCount(self) -> int: ...
    def alignment(self, item: typing.Optional[QGraphicsLayoutItem]) -> QtCore.Qt.AlignmentFlag: ...
    def setAlignment(self, item: typing.Optional[QGraphicsLayoutItem], alignment: QtCore.Qt.AlignmentFlag) -> None: ...
    ...
    def setHorizontalSpacing(self, spacing: float) -> None: ...
    @typing.overload
    def addItem(self, item: typing.Optional[QGraphicsLayoutItem], row: int, column: int, rowSpan: int, columnSpan: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    @typing.overload
    def addItem(self, item: typing.Optional[QGraphicsLayoutItem], row: int, column: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
...
class QGraphicsItem(PyQt6.sip.wrapper):
    ...
    @typing.overload
    def mapFromItem(self, item: typing.Optional['QGraphicsItem'], point: QtCore.QPointF) -> QtCore.QPointF: ...
    @typing.overload
    ...
    @typing.overload
    def mapToItem(self, item: typing.Optional['QGraphicsItem'], point: QtCore.QPointF) -> QtCore.QPointF: ...
    @typing.overload
...
class QGraphicsTextItem(QGraphicsObject):
    ...
    def setDefaultTextColor(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setFont(self, font: QtGui.QFont) -> None: ...
    def font(self) -> QtGui.QFont: ...
...
class QGraphicsScene(QtCore.QObject):
    ...
    def isActive(self) -> bool: ...
    @typing.overload
    def itemAt(self, pos: QtCore.QPointF, deviceTransform: QtGui.QTransform) -> typing.Optional[QGraphicsItem]: ...
    @typing.overload
    ...
    def inputMethodQuery(self, query: QtCore.Qt.InputMethodQuery) -> typing.Any: ...
    def setForegroundBrush(self, brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]) -> None: ...
    ...
    @typing.overload
    def addRect(self, rect: QtCore.QRectF, pen: typing.Union[QtGui.QPen, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]] = ..., brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient] = ...) -> typing.Optional[QGraphicsRectItem]: ...
    @typing.overload
    def addRect(self, x: float, y: float, w: float, h: float, pen: typing.Union[QtGui.QPen, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]] = ..., brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient] = ...) -> typing.Optional[QGraphicsRectItem]: ...
    def addPolygon(self, polygon: QtGui.QPolygonF, pen: typing.Union[QtGui.QPen, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]] = ..., brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient] = ...) -> typing.Optional[QGraphicsPolygonItem]: ...
    def addPixmap(self, pixmap: QtGui.QPixmap) -> typing.Optional[QGraphicsPixmapItem]: ...
    def addPath(self, path: QtGui.QPainterPath, pen: typing.Union[QtGui.QPen, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]] = ..., brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient] = ...) -> typing.Optional[QGraphicsPathItem]: ...
    @typing.overload
    def addLine(self, line: QtCore.QLineF, pen: typing.Union[QtGui.QPen, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]] = ...) -> typing.Optional[QGraphicsLineItem]: ...
    @typing.overload
    def addLine(self, x1: float, y1: float, x2: float, y2: float, pen: typing.Union[QtGui.QPen, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]] = ...) -> typing.Optional[QGraphicsLineItem]: ...
    @typing.overload
    def addEllipse(self, rect: QtCore.QRectF, pen: typing.Union[QtGui.QPen, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]] = ..., brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient] = ...) -> typing.Optional[QGraphicsEllipseItem]: ...
    @typing.overload
    def addEllipse(self, x: float, y: float, w: float, h: float, pen: typing.Union[QtGui.QPen, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]] = ..., brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient] = ...) -> typing.Optional[QGraphicsEllipseItem]: ...
    ...
    def createItemGroup(self, items: collections.abc.Iterable[QGraphicsItem]) -> typing.Optional[QGraphicsItemGroup]: ...
    def clearSelection(self) -> None: ...
    @typing.overload
    ...
    def collidingItems(self, item: typing.Optional[QGraphicsItem], mode: QtCore.Qt.ItemSelectionMode = ...) -> list[QGraphicsItem]: ...
    @typing.overload
...
class QGridLayout(QLayout):
    ...
    @typing.overload
    def addItem(self, item: typing.Optional[QLayoutItem], row: int, column: int, rowSpan: int = ..., columnSpan: int = ..., alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    @typing.overload
    def addItem(self, a0: typing.Optional[QLayoutItem]) -> None: ...
    def setGeometry(self, a0: QtCore.QRect) -> None: ...
    def count(self) -> int: ...
    ...
    @typing.overload
    def addLayout(self, a0: typing.Optional[QLayout], row: int, column: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    @typing.overload
    def addLayout(self, a0: typing.Optional[QLayout], row: int, column: int, rowSpan: int, columnSpan: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    @typing.overload
    def addWidget(self, w: typing.Optional[QWidget]) -> None: ...
    @typing.overload
    def addWidget(self, a0: typing.Optional[QWidget], row: int, column: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    @typing.overload
    def addWidget(self, a0: typing.Optional[QWidget], row: int, column: int, rowSpan: int, columnSpan: int, alignment: QtCore.Qt.AlignmentFlag = ...) -> None: ...
    def invalidate(self) -> None: ...
    def expandingDirections(self) -> QtCore.Qt.Orientation: ...
    def minimumHeightForWidth(self, a0: int) -> int: ...
    def heightForWidth(self, a0: int) -> int: ...
...
class QHeaderView(QAbstractItemView):
    ...
    def initStyleOptionForIndex(self, option: typing.Optional['QStyleOptionHeader'], logicalIndex: int) -> None: ...
...
class QInputDialog(QDialog):
    ...
    def setComboBoxItems(self, items: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
    ...
    @staticmethod
    def getMultiLineText(parent: typing.Optional[QWidget], title: typing.Optional[str], label: typing.Optional[str], text: typing.Optional[str] = ..., flags: QtCore.Qt.WindowType = ..., inputMethodHints: QtCore.Qt.InputMethodHint = ...) -> typing.Tuple[str, typing.Optional[bool]]: ...
    @staticmethod
    def getItem(parent: typing.Optional[QWidget], title: typing.Optional[str], label: typing.Optional[str], items: collections.abc.Iterable[typing.Optional[str]], current: int = ..., editable: bool = ..., flags: QtCore.Qt.WindowType = ..., inputMethodHints: QtCore.Qt.InputMethodHint = ...) -> typing.Tuple[str, typing.Optional[bool]]: ...
    @staticmethod
    def getDouble(parent: typing.Optional[QWidget], title: typing.Optional[str], label: typing.Optional[str], value: float = ..., min: float = ..., max: float = ..., decimals: int = ..., flags: QtCore.Qt.WindowType = ..., step: float = ...) -> typing.Tuple[float, typing.Optional[bool]]: ...
    @staticmethod
    def getInt(parent: typing.Optional[QWidget], title: typing.Optional[str], label: typing.Optional[str], value: int = ..., min: int = ..., max: int = ..., step: int = ..., flags: QtCore.Qt.WindowType = ...) -> typing.Tuple[int, typing.Optional[bool]]: ...
    @staticmethod
    def getText(parent: typing.Optional[QWidget], title: typing.Optional[str], label: typing.Optional[str], echo: 'QLineEdit.EchoMode' = ..., text: typing.Optional[str] = ..., flags: QtCore.Qt.WindowType = ..., inputMethodHints: QtCore.Qt.InputMethodHint = ...) -> typing.Tuple[str, typing.Optional[bool]]: ...
...
class QLabel(QFrame):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
    @typing.overload
    def __init__(self, text: typing.Optional[str], parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
...
class QLineEdit(QWidget):
    ...
    @typing.overload
    def addAction(self, a0: typing.Optional[QtGui.QAction]) -> None: ...
    @typing.overload
    def addAction(self, action: typing.Optional[QtGui.QAction], position: 'QLineEdit.ActionPosition') -> None: ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, position: 'QLineEdit.ActionPosition') -> typing.Optional[QtGui.QAction]: ...
    def isClearButtonEnabled(self) -> bool: ...
    def setClearButtonEnabled(self, enable: bool) -> None: ...
...
class QListWidgetItem(PyQt6.sip.wrapper):
    ...
    def setForeground(self, brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]) -> None: ...
    def foreground(self) -> QtGui.QBrush: ...
    def setBackground(self, brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]) -> None: ...
...
class QListWidget(QListView):
    ...
    def items(self, data: typing.Optional[QtCore.QMimeData]) -> list[QListWidgetItem]: ...
    def dropEvent(self, event: typing.Optional[QtGui.QDropEvent]) -> None: ...
    def event(self, e: typing.Optional[QtCore.QEvent]) -> bool: ...
    def supportedDropActions(self) -> QtCore.Qt.DropAction: ...
    def dropMimeData(self, index: int, data: typing.Optional[QtCore.QMimeData], action: QtCore.Qt.DropAction) -> bool: ...
    def mimeData(self, items: collections.abc.Iterable[QListWidgetItem]) -> typing.Optional[QtCore.QMimeData]: ...
    ...
    def clear(self) -> None: ...
    def findItems(self, text: typing.Optional[str], flags: QtCore.Qt.MatchFlag) -> list[QListWidgetItem]: ...
    ...
    @typing.overload
    def setCurrentItem(self, item: typing.Optional[QListWidgetItem], command: QtCore.QItemSelectionModel.SelectionFlag) -> None: ...
    def currentItem(self) -> typing.Optional[QListWidgetItem]: ...
    def __len__(self) -> int: ...
    def count(self) -> int: ...
    def takeItem(self, row: int) -> typing.Optional[QListWidgetItem]: ...
    def addItems(self, labels: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
    @typing.overload
    def addItem(self, aitem: typing.Optional[QListWidgetItem]) -> None: ...
    @typing.overload
    def addItem(self, label: typing.Optional[str]) -> None: ...
    def insertItems(self, row: int, labels: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
    @typing.overload
...
class QMainWindow(QWidget):
    ...
    def tabifiedDockWidgets(self, dockwidget: typing.Optional[QDockWidget]) -> list[QDockWidget]: ...
...
class QMdiArea(QAbstractScrollArea):
    ...
    def setBackground(self, background: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]) -> None: ...
    def background(self) -> QtGui.QBrush: ...
    ...
    def addSubWindow(self, widget: typing.Optional[QWidget], flags: QtCore.Qt.WindowType = ...) -> typing.Optional['QMdiSubWindow']: ...
...
class QMenu(QWidget):
    ...
    @staticmethod
    def menuInAction(action: typing.Optional[QtGui.QAction]) -> typing.Optional['QMenu']: ...
    @typing.overload
    ...
    @typing.overload
    def insertSection(self, before: typing.Optional[QtGui.QAction], text: typing.Optional[str]) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def insertSection(self, before: typing.Optional[QtGui.QAction], icon: QtGui.QIcon, text: typing.Optional[str]) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addSection(self, text: typing.Optional[str]) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addSection(self, icon: QtGui.QIcon, text: typing.Optional[str]) -> typing.Optional[QtGui.QAction]: ...
    ...
    def hideEvent(self, a0: typing.Optional[QtGui.QHideEvent]) -> None: ...
    def leaveEvent(self, a0: typing.Optional[QtCore.QEvent]) -> None: ...
    def enterEvent(self, a0: typing.Optional[QtGui.QEnterEvent]) -> None: ...
    def wheelEvent(self, a0: typing.Optional[QtGui.QWheelEvent]) -> None: ...
    def mouseMoveEvent(self, a0: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def mousePressEvent(self, a0: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def mouseReleaseEvent(self, a0: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def keyPressEvent(self, a0: typing.Optional[QtGui.QKeyEvent]) -> None: ...
    def changeEvent(self, a0: typing.Optional[QtCore.QEvent]) -> None: ...
    def initStyleOption(self, option: typing.Optional['QStyleOptionMenuItem'], action: typing.Optional[QtGui.QAction]) -> None: ...
    def columnCount(self) -> int: ...
    ...
    def title(self) -> str: ...
    def menuAction(self) -> typing.Optional[QtGui.QAction]: ...
    def actionAt(self, a0: QtCore.QPoint) -> typing.Optional[QtGui.QAction]: ...
    def actionGeometry(self, a0: typing.Optional[QtGui.QAction]) -> QtCore.QRect: ...
    def sizeHint(self) -> QtCore.QSize: ...
    @typing.overload
    def exec(self) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def exec(self, p: QtCore.QPoint, action: typing.Optional[QtGui.QAction] = ...) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    @staticmethod
    def exec(actions: collections.abc.Iterable[QtGui.QAction], pos: QtCore.QPoint, at: typing.Optional[QtGui.QAction] = ..., parent: typing.Optional[QWidget] = ...) -> typing.Optional[QtGui.QAction]: ...
    def popup(self, p: QtCore.QPoint, action: typing.Optional[QtGui.QAction] = ...) -> None: ...
    def activeAction(self) -> typing.Optional[QtGui.QAction]: ...
    def setActiveAction(self, act: typing.Optional[QtGui.QAction]) -> None: ...
    def defaultAction(self) -> typing.Optional[QtGui.QAction]: ...
    def setDefaultAction(self, a0: typing.Optional[QtGui.QAction]) -> None: ...
    ...
    def clear(self) -> None: ...
    def insertSeparator(self, before: typing.Optional[QtGui.QAction]) -> typing.Optional[QtGui.QAction]: ...
    def insertMenu(self, before: typing.Optional[QtGui.QAction], menu: typing.Optional['QMenu']) -> typing.Optional[QtGui.QAction]: ...
    def addSeparator(self) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def addMenu(self, menu: typing.Optional['QMenu']) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
...
class QMenuBar(QWidget):
    ...
    def setActiveAction(self, action: typing.Optional[QtGui.QAction]) -> None: ...
    def activeAction(self) -> typing.Optional[QtGui.QAction]: ...
    def clear(self) -> None: ...
    def insertSeparator(self, before: typing.Optional[QtGui.QAction]) -> typing.Optional[QtGui.QAction]: ...
    def insertMenu(self, before: typing.Optional[QtGui.QAction], menu: typing.Optional[QMenu]) -> typing.Optional[QtGui.QAction]: ...
...
class QMessageBox(QDialog):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, icon: 'QMessageBox.Icon', title: typing.Optional[str], text: typing.Optional[str], buttons: 'QMessageBox.StandardButton' = ..., parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
    ...
    @staticmethod
    def critical(parent: typing.Optional[QWidget], title: typing.Optional[str], text: typing.Optional[str], buttons: 'QMessageBox.StandardButton' = ..., defaultButton: 'QMessageBox.StandardButton' = ...) -> 'QMessageBox.StandardButton': ...
    @staticmethod
    def warning(parent: typing.Optional[QWidget], title: typing.Optional[str], text: typing.Optional[str], buttons: 'QMessageBox.StandardButton' = ..., defaultButton: 'QMessageBox.StandardButton' = ...) -> 'QMessageBox.StandardButton': ...
    @staticmethod
    def question(parent: typing.Optional[QWidget], title: typing.Optional[str], text: typing.Optional[str], buttons: 'QMessageBox.StandardButton' = ..., defaultButton: 'QMessageBox.StandardButton' = ...) -> 'QMessageBox.StandardButton': ...
    @staticmethod
    def information(parent: typing.Optional[QWidget], title: typing.Optional[str], text: typing.Optional[str], buttons: 'QMessageBox.StandardButton' = ..., defaultButton: 'QMessageBox.StandardButton' = ...) -> 'QMessageBox.StandardButton': ...
    def setTextFormat(self, a0: QtCore.Qt.TextFormat) -> None: ...
    def textFormat(self) -> QtCore.Qt.TextFormat: ...
...
class QPlainTextEdit(QAbstractScrollArea):
    ...
    def toPlainText(self) -> str: ...
    @typing.overload
    def find(self, exp: typing.Optional[str], options: QtGui.QTextDocument.FindFlag = ...) -> bool: ...
    @typing.overload
...
class QProgressDialog(QDialog):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
    @typing.overload
    def __init__(self, labelText: typing.Optional[str], cancelButtonText: typing.Optional[str], minimum: int, maximum: int, parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
...
class QSplashScreen(QWidget):
    ...
    @typing.overload
    def __init__(self, screen: typing.Optional[QtGui.QScreen], pixmap: QtGui.QPixmap = ..., flags: QtCore.Qt.WindowType = ...) -> None: ...
    ...
    def showMessage(self, message: typing.Optional[str], alignment: int = ..., color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int] = ...) -> None: ...
...
class QStyleOptionViewItem(QStyleOption):
    ...
    backgroundBrush = ... # type: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]
...
class QStyleOptionGroupBox(QStyleOptionComplex):
    ...
    text = ... # type: typing.Optional[str]
    textAlignment = ... # type: QtCore.Qt.AlignmentFlag
    textColor = ... # type: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]
...
class QTabBar(QWidget):
    ...
    def setTabTextColor(self, index: int, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QTableWidget(QTableView):
    ...
    def items(self, data: typing.Optional[QtCore.QMimeData]) -> list[QTableWidgetItem]: ...
    def supportedDropActions(self) -> QtCore.Qt.DropAction: ...
    def dropMimeData(self, row: int, column: int, data: typing.Optional[QtCore.QMimeData], action: QtCore.Qt.DropAction) -> bool: ...
    def mimeData(self, items: collections.abc.Iterable[QTableWidgetItem]) -> typing.Optional[QtCore.QMimeData]: ...
    def mimeTypes(self) -> list[str]: ...
    ...
    def findItems(self, text: typing.Optional[str], flags: QtCore.Qt.MatchFlag) -> list[QTableWidgetItem]: ...
    ...
    @typing.overload
    def setCurrentItem(self, item: typing.Optional[QTableWidgetItem], command: QtCore.QItemSelectionModel.SelectionFlag) -> None: ...
...
class QTextEdit(QAbstractScrollArea):
    ...
    def placeholderText(self) -> str: ...
    def setPlaceholderText(self, placeholderText: typing.Optional[str]) -> None: ...
    def setTextBackgroundColor(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setAlignment(self, a: QtCore.Qt.AlignmentFlag) -> None: ...
    def setCurrentFont(self, f: QtGui.QFont) -> None: ...
    def setTextColor(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setText(self, text: typing.Optional[str]) -> None: ...
...
class QTextBrowser(QTextEdit):
    ...
    def loadResource(self, type: int, name: QtCore.QUrl) -> typing.Any: ...
    def setSearchPaths(self, paths: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
...
class QToolBar(QWidget):
    ...
    def setToolButtonStyle(self, toolButtonStyle: QtCore.Qt.ToolButtonStyle) -> None: ...
    def setIconSize(self, iconSize: QtCore.QSize) -> None: ...
    def widgetForAction(self, action: typing.Optional[QtGui.QAction]) -> typing.Optional[QWidget]: ...
    def toolButtonStyle(self) -> QtCore.Qt.ToolButtonStyle: ...
    def iconSize(self) -> QtCore.QSize: ...
    def toggleViewAction(self) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def actionAt(self, p: QtCore.QPoint) -> typing.Optional[QtGui.QAction]: ...
    @typing.overload
    def actionAt(self, ax: int, ay: int) -> typing.Optional[QtGui.QAction]: ...
    def actionGeometry(self, action: typing.Optional[QtGui.QAction]) -> QtCore.QRect: ...
    def insertWidget(self, before: typing.Optional[QtGui.QAction], widget: typing.Optional[QWidget]) -> typing.Optional[QtGui.QAction]: ...
    def addWidget(self, widget: typing.Optional[QWidget]) -> typing.Optional[QtGui.QAction]: ...
    def insertSeparator(self, before: typing.Optional[QtGui.QAction]) -> typing.Optional[QtGui.QAction]: ...
    def addSeparator(self) -> typing.Optional[QtGui.QAction]: ...
    def clear(self) -> None: ...
    def orientation(self) -> QtCore.Qt.Orientation: ...
...
class QToolTip(PyQt6.sip.simplewrapper):
    ...
    def palette() -> QtGui.QPalette: ...
    @staticmethod
    def showText(pos: QtCore.QPoint, text: typing.Optional[str], widget: typing.Optional[QWidget] = ..., rect: QtCore.QRect = ..., msecShowTime: int = ...) -> None: ...
...
class QTreeWidgetItem(PyQt6.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, parent: typing.Optional['QTreeWidgetItem'], after: typing.Optional['QTreeWidgetItem'], type: int = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional['QTreeWidgetItem'], strings: collections.abc.Iterable[typing.Optional[str]], type: int = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional['QTreeWidgetItem'], type: int = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional['QTreeWidget'], after: typing.Optional['QTreeWidgetItem'], type: int = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional['QTreeWidget'], strings: collections.abc.Iterable[typing.Optional[str]], type: int = ...) -> None: ...
    @typing.overload
    ...
    def setForeground(self, column: int, brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]) -> None: ...
    def foreground(self, column: int) -> QtGui.QBrush: ...
    def setBackground(self, column: int, brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]) -> None: ...
...
class QTreeWidget(QTreeView):
    ...
    def mimeData(self, items: collections.abc.Iterable[QTreeWidgetItem]) -> typing.Optional[QtCore.QMimeData]: ...
    def mimeTypes(self) -> list[str]: ...
    itemSelectionChanged: typing.ClassVar[QtCore.pyqtSignal]
    currentItemChanged: typing.ClassVar[QtCore.pyqtSignal]
    ...
    def findItems(self, text: typing.Optional[str], flags: QtCore.Qt.MatchFlag, column: int = ...) -> list[QTreeWidgetItem]: ...
    ...
    @typing.overload
    def setCurrentItem(self, item: typing.Optional[QTreeWidgetItem], column: int, command: QtCore.QItemSelectionModel.SelectionFlag) -> None: ...
    def currentColumn(self) -> int: ...
    def currentItem(self) -> typing.Optional[QTreeWidgetItem]: ...
    def setHeaderLabels(self, labels: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
...
class QTreeWidgetItemIterator(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, item: typing.Optional[QTreeWidgetItem], flags: 'QTreeWidgetItemIterator.IteratorFlag' = ...) -> None: ...
    @typing.overload
    def __init__(self, widget: typing.Optional[QTreeWidget], flags: 'QTreeWidgetItemIterator.IteratorFlag' = ...) -> None: ...
    @typing.overload
...
class QUndoView(QListView):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, stack: typing.Optional[QtGui.QUndoStack], parent: typing.Optional[QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, group: typing.Optional[QtGui.QUndoGroup], parent: typing.Optional[QWidget] = ...) -> None: ...

    def setGroup(self, group: typing.Optional[QtGui.QUndoGroup]) -> None: ...
    def setStack(self, stack: typing.Optional[QtGui.QUndoStack]) -> None: ...
    ...
    def group(self) -> typing.Optional[QtGui.QUndoGroup]: ...
    def stack(self) -> typing.Optional[QtGui.QUndoStack]: ...
...
class QWhatsThis(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def createAction(parent: typing.Optional[QtCore.QObject] = ...) -> typing.Optional[QtGui.QAction]: ...
    @staticmethod
    def hideText() -> None: ...
    @staticmethod
...
@typing.overload
def qDrawPlainRoundedRect(painter: typing.Optional[QtGui.QPainter], rect: QtCore.QRect, rx: float, ry: float, lineColor: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], lineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawPlainRoundedRect(p: typing.Optional[QtGui.QPainter], x: int, y: int, w: int, h: int, rx: float, ry: float, a7: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], lineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
...
@typing.overload
def qDrawPlainRect(p: typing.Optional[QtGui.QPainter], x: int, y: int, w: int, h: int, a5: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], lineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawPlainRect(p: typing.Optional[QtGui.QPainter], r: QtCore.QRect, a2: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], lineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawWinPanel(p: typing.Optional[QtGui.QPainter], x: int, y: int, w: int, h: int, pal: QtGui.QPalette, sunken: bool = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawWinPanel(p: typing.Optional[QtGui.QPainter], r: QtCore.QRect, pal: QtGui.QPalette, sunken: bool = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawWinButton(p: typing.Optional[QtGui.QPainter], x: int, y: int, w: int, h: int, pal: QtGui.QPalette, sunken: bool = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawWinButton(p: typing.Optional[QtGui.QPainter], r: QtCore.QRect, pal: QtGui.QPalette, sunken: bool = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawShadePanel(p: typing.Optional[QtGui.QPainter], x: int, y: int, w: int, h: int, pal: QtGui.QPalette, sunken: bool = ..., lineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawShadePanel(p: typing.Optional[QtGui.QPainter], r: QtCore.QRect, pal: QtGui.QPalette, sunken: bool = ..., lineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawShadeRect(p: typing.Optional[QtGui.QPainter], x: int, y: int, w: int, h: int, pal: QtGui.QPalette, sunken: bool = ..., lineWidth: int = ..., midLineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
def qDrawShadeRect(p: typing.Optional[QtGui.QPainter], r: QtCore.QRect, pal: QtGui.QPalette, sunken: bool = ..., lineWidth: int = ..., midLineWidth: int = ..., fill: typing.Optional[typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]] = ...) -> None: ...
@typing.overload
