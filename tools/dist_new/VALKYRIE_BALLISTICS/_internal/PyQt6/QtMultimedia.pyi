...
class QAudioFormat(PyQt6.sip.simplewrapper):
    ...
    def normalizedSampleValue(
        self, sample: typing.Optional[PyQt6.sip.voidptr]
    ) -> float: ...
...
class QAudioInput(QtCore.QObject):
    @typing.overload
    def __init__(
        self, deviceInfo: QAudioDevice, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QMediaCaptureSession(QtCore.QObject):
    ...
    def setVideoFrameInput(
        self, input: typing.Optional["QVideoFrameInput"]
    ) -> None: ...
    def videoFrameInput(self) -> typing.Optional["QVideoFrameInput"]: ...
    def setAudioBufferInput(
        self, input: typing.Optional[QAudioBufferInput]
    ) -> None: ...
    ...
    def setWindowCapture(
        self, windowCapture: typing.Optional["QWindowCapture"]
    ) -> None: ...
    ...
    def setScreenCapture(
        self, screenCapture: typing.Optional["QScreenCapture"]
    ) -> None: ...
...
class QMediaPlayer(QtCore.QObject):
    ...
    def pitchCompensationAvailability(
        self,
    ...
    def setAudioBufferOutput(
        self, output: typing.Optional[QAudioBufferOutput]
    ) -> None: ...
    ...
    sourceChanged: typing.ClassVar[QtCore.pyqtSignal]
    def setSourceDevice(
        self, device: typing.Optional[QtCore.QIODevice], sourceUrl: QtCore.QUrl = ...
    ) -> None: ...
...
class QSoundEffect(QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, audioDevice: QAudioDevice, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QVideoFrameInput(QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, format: QVideoFrameFormat, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
