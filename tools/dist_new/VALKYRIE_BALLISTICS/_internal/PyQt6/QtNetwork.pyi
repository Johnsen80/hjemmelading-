...
class QAbstractNetworkCache(QtCore.QObject):
    ...
    ) -> typing.Optional[QtCore.QIODevice]: ...
...
class QDnsTlsAssociationRecord(PyQt6.sip.simplewrapper):
    ...
    class CertificateUsage(enum.Enum):
        CertificateAuthorityConstrait = (
            ...
        )  # type: QDnsTlsAssociationRecord.CertificateUsage
...
class QFormDataPartBuilder(PyQt6.sip.simplewrapper):
    ...
    def setBodyDevice(
        self,
        body: typing.Optional[QtCore.QIODevice],
...
class QHostAddress(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, copy: typing.Union["QHostAddress", "QHostAddress.SpecialAddress"]
    ) -> None: ...
    ...
    def isInSubnet(
        self,
        subnet: typing.Union["QHostAddress", "QHostAddress.SpecialAddress"],
        netmask: int,
    ) -> bool: ...
    @typing.overload
    def isInSubnet(
        self,
        subnet: tuple[typing.Union["QHostAddress", "QHostAddress.SpecialAddress"], int],
    ) -> bool: ...
...
class QHstsPolicy(PyQt6.sip.simplewrapper):
    ...
    def setHost(
        self, host: typing.Optional[str], mode: QtCore.QUrl.ParsingMode = ...
    ) -> None: ...
...
class QHttpHeaders(PyQt6.sip.simplewrapper):
    ...
    ) -> typing.Optional[list[QtCore.QDateTime]]: ...
    @typing.overload
    def dateTimeValues(
        self,
        name: typing.Union[
    ...
    def dateTimeValue(
        self, name: "QHttpHeaders.WellKnownHeader"
    ) -> typing.Optional[QtCore.QDateTime]: ...
    @typing.overload
    def dateTimeValue(
        self,
        name: typing.Union[
...
class QHttpPart(PyQt6.sip.simplewrapper):
    ...
    def setBody(
        self, body: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    def setRawHeader(
        self,
        headerName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        headerValue: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> None: ...
    def setHeader(
...
class QHttpMultiPart(QtCore.QObject):
    ...
    def setBoundary(
        self, boundary: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
...
class QLocalSocket(QtCore.QIODevice):
    ...
    @typing.overload
    def connectToServer(
        self, name: typing.Optional[str], mode: QtCore.QIODeviceBase.OpenModeFlag = ...
    ) -> None: ...
    @typing.overload
    def connectToServer(
...
class QNetworkAccessManager(QtCore.QObject):
    ...
    def enableStrictTransportSecurityStore(
        self, enabled: bool, storeDir: typing.Optional[str] = ...
    ) -> None: ...
    ...
    def connectToHost(
        self, hostName: typing.Optional[str], port: int = ...
    ) -> None: ...
    @typing.overload
    ...
    def sendCustomRequest(
        ...
        verb: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ...
    def sendCustomRequest(
        ...
        request: "QNetworkRequest",
        verb: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        multiPart: typing.Optional[QHttpMultiPart],
    ) -> typing.Optional["QNetworkReply"]: ...
    def deleteResource(
    ...
    def setProxyFactory(
        self, factory: typing.Optional["QNetworkProxyFactory"]
    ) -> None: ...
    ...
    @typing.overload
    def put(
        self, request: "QNetworkRequest", data: typing.Optional[QtCore.QIODevice]
    ) -> typing.Optional["QNetworkReply"]: ...
    @typing.overload
    def put(
        self,
    ...
    @typing.overload
    def put(
        self, request: "QNetworkRequest", multiPart: typing.Optional[QHttpMultiPart]
    ) -> typing.Optional["QNetworkReply"]: ...
    @typing.overload
    def post(
        self, request: "QNetworkRequest", data: typing.Optional[QtCore.QIODevice]
...
class QNetworkCookie(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        name: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview] = ...,
        value: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview] = ...,
    ) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def parseCookies(
        cookieString: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> list["QNetworkCookie"]: ...
    def toRawForm(self, form: "QNetworkCookie.RawForm" = ...) -> QtCore.QByteArray: ...
    def setValue(
        self, value: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    def value(self) -> QtCore.QByteArray: ...
    def setName(
        self, cookieName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    ...
    def domain(self) -> str: ...
    def setExpirationDate(
        self, date: typing.Union[QtCore.QDateTime, datetime.datetime]
    ) -> None: ...
    def expirationDate(self) -> QtCore.QDateTime: ...
...
class QNetworkCookieJar(QtCore.QObject):
    ...
    def setCookiesFromUrl(
        self, cookieList: collections.abc.Iterable[QNetworkCookie], url: QtCore.QUrl
    ) -> bool: ...
...
class QNetworkDatagram(PyQt6.sip.simplewrapper):
    ...
    def makeReply(
        self, payload: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> "QNetworkDatagram": ...
    def setData(
        self, data: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
...
class QNetworkProxy(PyQt6.sip.simplewrapper):
    ...
    def rawHeader(
        self, headerName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> QtCore.QByteArray: ...
...
class QNetworkProxyQuery(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        ...
        hostname: typing.Optional[str],
        port: int,
        protocolTag: typing.Optional[str] = ...,
...
class QNetworkProxyFactory(PyQt6.sip.wrapper):
    ...
    def setApplicationProxyFactory(
        factory: typing.Optional["QNetworkProxyFactory"],
    ) -> None: ...
...
class QNetworkReply(QtCore.QIODevice):
    ...
    def setUrl(self, url: QtCore.QUrl) -> None: ...
    def setError(
        self, errorCode: "QNetworkReply.NetworkError", errorString: typing.Optional[str]
    ) -> None: ...
...
class QNetworkRequest(PyQt6.sip.simplewrapper):
    class TransferTimeoutConstant(enum.Enum):
        DefaultTransferTimeoutConstant = (
            ...
        )  # type: QNetworkRequest.TransferTimeoutConstant
    ...
    class Attribute(enum.Enum):
        ...
        ConnectionCacheExpiryTimeoutSecondsAttribute = (
            ...
        )  # type: QNetworkRequest.Attribute
...
class QNetworkRequestFactory(PyQt6.sip.simplewrapper):
    ...
    def setBearerToken(
        self, token: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    ...
    @typing.overload
    def createRequest(
        self, path: typing.Optional[str], query: QtCore.QUrlQuery
    ) -> QNetworkRequest: ...
    def setSslConfiguration(self, configuration: "QSslConfiguration") -> None: ...
    def sslConfiguration(self) -> "QSslConfiguration": ...
...
class QPasswordDigestor(PyQt6.sip.simplewrapper):
    def deriveKeyPbkdf2(
        ...
        password: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        salt: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        iterations: int,
        dkLen: int,
    ) -> QtCore.QByteArray: ...
    def deriveKeyPbkdf1(
...
class QRestAccessManager(QtCore.QObject):
    def __init__(
        self,
        manager: typing.Optional[QNetworkAccessManager],
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> None: ...
    @typing.overload
    def sendCustomRequest(
        self,
        request: QNetworkRequest,
        method: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        data: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> typing.Optional[QNetworkReply]: ...
    @typing.overload
    def sendCustomRequest(
    ...
    def sendCustomRequest(
        ...
        request: QNetworkRequest,
        method: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        data: typing.Optional[QHttpMultiPart],
    ) -> typing.Optional[QNetworkReply]: ...
    @typing.overload
    def patch(
    ...
    @typing.overload
    def patch(
        self, request: QNetworkRequest, data: dict[typing.Optional[str], typing.Any]
    ) -> typing.Optional[QNetworkReply]: ...
    @typing.overload
    def patch(
        self,
    ...
    @typing.overload
    def put(
        self, request: QNetworkRequest, data: typing.Optional[QHttpMultiPart]
    ) -> typing.Optional[QNetworkReply]: ...
    @typing.overload
    def put(
        self, request: QNetworkRequest, data: typing.Optional[QtCore.QIODevice]
...
class QRestReply(PyQt6.sip.simplewrapper):
    ...
    def readJson(
        self, error: typing.Optional[QtCore.QJsonParseError] = ...
    ) -> typing.Optional[QtCore.QJsonDocument]: ...
...
class QSslCertificate(PyQt6.sip.simplewrapper):
    ...
    def importPkcs12(
        device: typing.Optional[QtCore.QIODevice],
        key: typing.Optional["QSslKey"],
        certificate: typing.Optional["QSslCertificate"],
        caCertificates: typing.Optional[
            collections.abc.Iterable["QSslCertificate"]
        ] = ...,
        passPhrase: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview] = ...,
    ) -> bool: ...
    def __hash__(self) -> int: ...
    ...
    @staticmethod
    def fromFile(
        filePath: typing.Optional[str], format: QSsl.EncodingFormat = ...
    ...
    @staticmethod
    def fromDevice(
        device: typing.Optional[QtCore.QIODevice], format: QSsl.EncodingFormat = ...
    ) -> list["QSslCertificate"]: ...
    @staticmethod
    def fromPath(
    ...
    @typing.overload
    def subjectInfo(
        self, attribute: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> list[str]: ...
    @typing.overload
...
class QSslCipher(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, name: typing.Optional[str], protocol: QSsl.SslProtocol
    ) -> None: ...
    @typing.overload
...
class QSslConfiguration(PyQt6.sip.simplewrapper):
    class NextProtocolNegotiationStatus(enum.Enum):
        NextProtocolNegotiationNone = (
            ...
        )  # type: QSslConfiguration.NextProtocolNegotiationStatus
    ...
    def setBackendConfiguration(
        ...
        backendConfiguration: dict[
            typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview], typing.Any
        ] = ...,
    ) -> None: ...
    ...
    def setPreSharedKeyIdentityHint(
        self, hint: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    ...
    def setSessionTicket(
        self,
        sessionTicket: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> None: ...
...
class QSslDiffieHellmanParameters(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromEncoded(
        encoded: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        encoding: QSsl.EncodingFormat = ...,
    ) -> "QSslDiffieHellmanParameters": ...
    @typing.overload
    @staticmethod
    def fromEncoded(
        device: typing.Optional[QtCore.QIODevice], encoding: QSsl.EncodingFormat = ...
    ) -> "QSslDiffieHellmanParameters": ...
    @staticmethod
...
class QSslKey(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, handle: typing.Optional[PyQt6.sip.voidptr], type: QSsl.KeyType = ...
    ) -> None: ...
    @typing.overload
...
class QSslPreSharedKeyAuthenticator(PyQt6.sip.simplewrapper):
    ...
    def setPreSharedKey(
        self,
        preSharedKey: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> None: ...
    def maximumIdentityLength(self) -> int: ...
    def identity(self) -> QtCore.QByteArray: ...
    def setIdentity(
        self, identity: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
...
class QSslSocket(QTcpSocket):
    ...
    def isFeatureSupported(
        feat: QSsl.SupportedFeature, backendName: typing.Optional[str] = ...
    ) -> bool: ...
    @staticmethod
    def supportedFeatures(
        backendName: typing.Optional[str] = ...,
    ) -> list[QSsl.SupportedFeature]: ...
    @staticmethod
    def isClassImplemented(
        cl: QSsl.ImplementedClass, backendName: typing.Optional[str] = ...
    ) -> bool: ...
    @staticmethod
    ...
    def isProtocolSupported(
        protocol: QSsl.SslProtocol, backendName: typing.Optional[str] = ...
    ) -> bool: ...
    @staticmethod
    ...
    def setLocalCertificate(
        self, path: typing.Optional[str], format: QSsl.EncodingFormat = ...
    ) -> None: ...
    def atEnd(self) -> bool: ...
    def close(self) -> None: ...
    def canReadLine(self) -> bool: ...
    ...
    def connectToHostEncrypted(
        ...
        hostName: typing.Optional[str],
        port: int,
        sslPeerName: typing.Optional[str],
        mode: QtCore.QIODeviceBase.OpenModeFlag = ...,
        protocol: QAbstractSocket.NetworkLayerProtocol = ...,
    ) -> None: ...
...
class QUdpSocket(QAbstractSocket):
    ...
    def writeDatagram(
        self,
        a0: PyQt6.sip.Buffer,
        a1: typing.Union[QHostAddress, QHostAddress.SpecialAddress],
        a2: int,
    ) -> int: ...
    @typing.overload
    ...
    def readDatagram(
        self, maxlen: int
    ) -> typing.Tuple[bytes, typing.Optional[QHostAddress], typing.Optional[int]]: ...
