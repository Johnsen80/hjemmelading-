...
class QDBusAbstractInterface(QtCore.QObject):
    ...
    def asyncCallWithArgumentList(
        self, method: typing.Optional[str], args: collections.abc.Iterable[typing.Any]
    ) -> "QDBusPendingCall": ...
    def asyncCall(
        self, method: typing.Optional[str], *args: typing.Any
    ) -> "QDBusPendingCall": ...
    @typing.overload
    ...
    @typing.overload
    def call(
        self, mode: "QDBus.CallMode", method: typing.Optional[str], *args: typing.Any
    ) -> "QDBusMessage": ...
...
class QDBusConnection(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def connectToPeer(
        address: typing.Optional[str], name: typing.Optional[str]
    ) -> "QDBusConnection": ...
    @typing.overload
    @staticmethod
    def connectToBus(
        type: "QDBusConnection.BusType", name: typing.Optional[str]
    ) -> "QDBusConnection": ...
    @typing.overload
    @staticmethod
    def connectToBus(
    ...
    def objectRegisteredAt(
        self, path: typing.Optional[str]
    ) -> typing.Optional[QtCore.QObject]: ...
    def unregisterObject(
        self, path: typing.Optional[str], mode: "QDBusConnection.UnregisterMode" = ...
    ) -> None: ...
    @typing.overload
    def registerObject(
        self,
    ...
    def disconnect(
        ...
        interface: typing.Optional[str],
        name: typing.Optional[str],
        argumentMatch: collections.abc.Iterable[typing.Optional[str]],
        signature: typing.Optional[str],
        slot: PYQT_SLOT,
    ) -> bool: ...
    @typing.overload
...
class QDBusConnectionInterface(QDBusAbstractInterface):
    class RegisterServiceReply(enum.Enum):
        ServiceNotRegistered = (
            ...
        )  # type: QDBusConnectionInterface.RegisterServiceReply
    ...
    class ServiceReplacementOptions(enum.Enum):
        DontAllowReplacement = (
            ...
        )  # type: QDBusConnectionInterface.ServiceReplacementOptions
        AllowReplacement = (
            ...
        )  # type: QDBusConnectionInterface.ServiceReplacementOptions
    ...
    class ServiceQueueOptions(enum.Enum):
        ...
        ReplaceExistingService = (
            ...
        )  # type: QDBusConnectionInterface.ServiceQueueOptions
...
class QDBusMessage(PyQt6.sip.simplewrapper):
    ...
    def createErrorReply(
        self, name: typing.Optional[str], msg: typing.Optional[str]
    ) -> "QDBusMessage": ...
    @typing.overload
    def createErrorReply(self, error: QDBusError) -> "QDBusMessage": ...
    @typing.overload
    def createErrorReply(
        self, type: QDBusError.ErrorType, msg: typing.Optional[str]
    ) -> "QDBusMessage": ...
    @typing.overload
    def createReply(
    ...
    @staticmethod
    def createError(
        name: typing.Optional[str], msg: typing.Optional[str]
    ) -> "QDBusMessage": ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def createError(
        type: QDBusError.ErrorType, msg: typing.Optional[str]
    ) -> "QDBusMessage": ...
    @staticmethod
...
class QDBusServiceWatcher(QtCore.QObject):
    ...
    def setWatchedServices(
        self, services: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
