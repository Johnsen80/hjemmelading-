...
class QWebSocket(QtCore.QObject):
    ...
    def ping(
        self,
        payload: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview] = ...,
    ) -> None: ...
    @typing.overload
    def open(
        self, request: QtNetwork.QNetworkRequest, options: "QWebSocketHandshakeOptions"
    ) -> None: ...
    @typing.overload
    ...
    def setMaskGenerator(
        self, maskGenerator: typing.Optional[QMaskGenerator]
    ) -> None: ...
...
class QWebSocketHandshakeOptions(PyQt6.sip.simplewrapper):
    ...
    def setSubprotocols(
        self, protocols: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QWebSocketServer(QtCore.QObject):
    ...
    def __init__(
        self,
        serverName: typing.Optional[str],
    ...
    def handleConnection(
        self, socket: typing.Optional[QtNetwork.QTcpSocket]
    ) -> None: ...
