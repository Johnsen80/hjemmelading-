...
class QAbstractTextDocumentLayout(QtCore.QObject):
    ...
    class PaintContext(PyQt6.sip.simplewrapper):
        ...
        selections = (
            ...
        )  # type: collections.abc.Iterable['QAbstractTextDocumentLayout.Selection']
    ...
    def handlerForObject(
        self, objectType: int
    ) -> typing.Optional["QTextObjectInterface"]: ...
    ...
    def frameBoundingRect(
        self, frame: typing.Optional["QTextFrame"]
    ) -> QtCore.QRectF: ...
...
class QTextObjectInterface(PyQt6.sip.simplewrapper):
    ...
    def drawObject(
        ...
        painter: typing.Optional["QPainter"],
        rect: QtCore.QRectF,
        doc: typing.Optional["QTextDocument"],
        posInDocument: int,
        format: "QTextFormat",
    ) -> None: ...
    def intrinsicSize(
...
class QAccessibilityHints(QtCore.QObject):
    ...
    def contrastPreferenceChanged(
        self, contrastPreference: QtCore.Qt.ContrastPreference
    ) -> None: ...
...
class QAction(QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, text: typing.Optional[str], parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def setShortcuts(
        ...
        shortcuts: collections.abc.Iterable[
            typing.Union[
                "QKeySequence", "QKeySequence.StandardKey", typing.Optional[str], int
            ]
        ],
    ) -> None: ...
    @typing.overload
...
class QActionGroup(QtCore.QObject):
    ...
    @typing.overload
    def addAction(
        self, icon: "QIcon", text: typing.Optional[str]
...
class QPixmap(QPaintDevice):
    ...
    def loadFromData(
        self,
        buf: typing.Optional[PyQt6.sip.array[bytes]],
        format: typing.Optional[str] = ...,
        flags: QtCore.Qt.ImageConversionFlag = ...,
    ) -> bool: ...
    @typing.overload
    def loadFromData(
        self,
        buf: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        format: typing.Optional[str] = ...,
        flags: QtCore.Qt.ImageConversionFlag = ...,
    ) -> bool: ...
    def load(
    ...
    @staticmethod
    def fromImageReader(
        imageReader: typing.Optional["QImageReader"],
        flags: QtCore.Qt.ImageConversionFlag = ...,
    ) -> "QPixmap": ...
    @staticmethod
    def fromImage(
    ...
    def createMaskFromColor(
        self,
        maskColor: typing.Union["QColor", QtCore.Qt.GlobalColor, int],
    ...
    def fill(
        self, color: typing.Union["QColor", QtCore.Qt.GlobalColor, int] = ...
    ) -> None: ...
    @staticmethod
...
class QBitmap(QPixmap):
    ...
    @typing.overload
    def __init__(
        self, fileName: typing.Optional[str], format: typing.Optional[str] = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, variant: typing.Any) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def fromData(
        size: QtCore.QSize, bits: typing.Optional[bytes], format: "QImage.Format" = ...
    ) -> "QBitmap": ...
    @staticmethod
...
class QColor(PyQt6.sip.simplewrapper):
    ...
    def isValidColorName(
        a0: typing.Union[
            typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
            typing.Optional[str],
        ],
    ) -> bool: ...
    @staticmethod
...
class QColorConstants(PyQt6.sip.simplewrapper):
    class Svg(PyQt6.sip.simplewrapper):
        ...
        lightgoldenrodyellow = (
            ...
        )  # type: typing.Union[QColor, QtCore.Qt.GlobalColor, int]
...
class QBrush(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        color: typing.Union[QColor, QtCore.Qt.GlobalColor, int],
        style: QtCore.Qt.BrushStyle = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self, color: typing.Union[QColor, QtCore.Qt.GlobalColor, int], pixmap: QPixmap
    ) -> None: ...
    @typing.overload
    ...
    def __init__(
        self,
        brush: typing.Union[
            "QBrush", typing.Union[QColor, QtCore.Qt.GlobalColor, int], "QGradient"
        ],
    ) -> None: ...
    @typing.overload
    def __init__(self, variant: typing.Any) -> None: ...
...
class QGradient(PyQt6.sip.simplewrapper):
    ...
    def setStops(
        ...
        stops: collections.abc.Iterable[
            tuple[float, typing.Union[QColor, QtCore.Qt.GlobalColor, int]]
        ],
    ) -> None: ...
    def setColorAt(
        self, pos: float, color: typing.Union[QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
...
class QClipboard(QtCore.QObject):
    ...
    def setMimeData(
        self, data: typing.Optional[QtCore.QMimeData], mode: "QClipboard.Mode" = ...
    ) -> None: ...
    def mimeData(
        self, mode: "QClipboard.Mode" = ...
    ) -> typing.Optional[QtCore.QMimeData]: ...
    def setText(
        self, a0: typing.Optional[str], mode: "QClipboard.Mode" = ...
    ) -> None: ...
    @typing.overload
    def text(self, mode: "QClipboard.Mode" = ...) -> str: ...
    @typing.overload
    def text(
        self, subtype: typing.Optional[str], mode: "QClipboard.Mode" = ...
    ) -> tuple[str, str]: ...
...
class QColorSpace(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromIccProfile(
        iccProfile: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> "QColorSpace": ...
    def isValid(self) -> bool: ...
    @typing.overload
...
class QCursor(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, cursor: typing.Union["QCursor", QtCore.Qt.CursorShape]
    ) -> None: ...
    @typing.overload
    def __init__(self, variant: typing.Any) -> None: ...
    def __ne__(self, other: object): ...
...
class QDesktopServices(PyQt6.sip.simplewrapper):
    ...
    def setUrlHandler(
        ...
        receiver: typing.Optional[QtCore.QObject],
...
class QKeyEvent(QInputEvent):
    ...
    def __init__(
        ...
        autorep: bool = ...,
        count: int = ...,
        device: typing.Optional["QInputDevice"] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QInputMethodEvent(QtCore.QEvent):
    ...
    class Attribute(PyQt6.sip.simplewrapper):
        ...
        @typing.overload
        def __init__(
            self, t: "QInputMethodEvent.AttributeType", s: int, l: int, val: typing.Any
        ) -> None: ...
        @typing.overload
        def __init__(
    ...
    def __init__(
        self,
        preeditText: typing.Optional[str],
    ...
    def setCommitString(
        self, commitString: typing.Optional[str], from_: int = ..., length: int = ...
    ) -> None: ...
...
class QActionEvent(QtCore.QEvent):
    def __init__(
        self,
        type: int,
        action: typing.Optional[QAction],
        before: typing.Optional[QAction] = ...,
    ) -> None: ...
...
class QShortcutEvent(QtCore.QEvent):
    ...
    def __init__(
        ...
        shortcut: typing.Optional["QShortcut"] = ...,
        ambiguous: bool = ...,
    ) -> None: ...
...
class QSinglePointEvent(QPointerEvent):
    ...
    def setExclusivePointGrabber(
        self, exclusiveGrabber: typing.Optional[QtCore.QObject]
    ) -> None: ...
...
class QNativeGestureEvent(QSinglePointEvent):
    ...
    def __init__(
        ...
        dev: typing.Optional["QPointingDevice"],
        fingerCount: int,
        localPos: QtCore.QPointF,
        scenePos: QtCore.QPointF,
        globalPos: QtCore.QPointF,
...
class QChildWindowEvent(QtCore.QEvent):
    def __init__(
        self, type: QtCore.QEvent.Type, childWindow: typing.Optional["QWindow"]
    ) -> None: ...
...
class QFileSystemModel(QtCore.QAbstractItemModel):
    ...
    def mkdir(
        self, parent: QtCore.QModelIndex, name: typing.Optional[str]
    ) -> QtCore.QModelIndex: ...
    @typing.overload
    ...
    def setIconProvider(
        self, provider: typing.Optional[QAbstractFileIconProvider]
    ) -> None: ...
    ...
    @typing.overload
    def index(
        self, path: typing.Optional[str], column: int = ...
    ) -> QtCore.QModelIndex: ...
...
class QFont(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        families: collections.abc.Iterable[typing.Optional[str]],
        pointSize: int = ...,
        weight: int = ...,
        italic: bool = ...,
    ) -> None: ...
    ...
    def setFamilies(
        self, a0: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    ...
    def insertSubstitutions(
        a0: typing.Optional[str], a1: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    @staticmethod
    def insertSubstitution(
        a0: typing.Optional[str], a1: typing.Optional[str]
    ) -> None: ...
    @staticmethod
...
class QFontDatabase(PyQt6.sip.simplewrapper):
    ...
    def setApplicationEmojiFontFamilies(
        familyNames: collections.abc.Iterable[typing.Optional[str]],
    ) -> None: ...
    @staticmethod
    ...
    def removeApplicationFallbackFontFamily(
        script: QtCore.QChar.Script, familyName: typing.Optional[str]
    ) -> bool: ...
    @staticmethod
    ...
    def addApplicationFontFromData(
        fontData: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def isFixedPitch(
        family: typing.Optional[str], style: typing.Optional[str] = ...
    ) -> bool: ...
    @staticmethod
    def isScalable(
        family: typing.Optional[str], style: typing.Optional[str] = ...
    ...
    @staticmethod
    def font(
        family: typing.Optional[str], style: typing.Optional[str], pointSize: int
    ) -> QFont: ...
    @typing.overload
    @staticmethod
...
class QFontMetrics(PyQt6.sip.simplewrapper):
    ...
    def horizontalAdvance(
        self, a0: typing.Optional[str], textOption: "QTextOption"
    ) -> int: ...
    @typing.overload
    ...
    def tightBoundingRect(
        self, text: typing.Optional[str], textOption: "QTextOption"
    ) -> QtCore.QRect: ...
    @typing.overload
    ...
    def size(
        ...
        text: typing.Optional[str],
        tabStops: int = ...,
        tabArray: typing.Optional[list[int]] = ...,
    ) -> QtCore.QSize: ...
...
class QFontMetricsF(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def horizontalAdvance(
        self, string: typing.Optional[str], textOption: "QTextOption"
    ) -> float: ...
    @typing.overload
    def horizontalAdvance(
        self, string: typing.Optional[str], length: int = ...
    ) -> float: ...
...
class QGuiApplication(QtCore.QCoreApplication):
    ...
    def changeOverrideCursor(
        a0: typing.Union[QCursor, QtCore.Qt.CursorShape],
    ) -> None: ...
    @staticmethod
...
class QIcon(PyQt6.sip.wrapper):
    ...
    def setThemeSearchPaths(
        searchpath: collections.abc.Iterable[typing.Optional[str]],
    ) -> None: ...
    @staticmethod
...
class QImage(QPaintDevice):
    ...
    def __init__(
        ...
        cleanupInfo: typing.Optional[typing.Any] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    @typing.overload
    def setPixelColor(
        self, x: int, y: int, c: typing.Union[QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
    @typing.overload
    def setPixelColor(
        self, pt: QtCore.QPoint, c: typing.Union[QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def fromData(
        data: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        format: typing.Optional[str] = ...,
    ) -> "QImage": ...
    @typing.overload
    def save(
    ...
    @typing.overload
    def load(
        self, device: typing.Optional[QtCore.QIODevice], format: typing.Optional[str]
    ) -> bool: ...
    @typing.overload
    def load(
        self, fileName: typing.Optional[str], format: typing.Optional[str] = ...
    ...
    def width(self) -> int: ...
    @staticmethod
    def fromHICON(hicon: typing.Optional[PyQt6.sip.voidptr]) -> "QImage": ...
    def toHICON(self, mask: "QImage" = ...) -> typing.Optional[PyQt6.sip.voidptr]: ...
    @staticmethod
    def fromHBITMAP(hbitmap: typing.Optional[PyQt6.sip.voidptr]) -> "QImage": ...
    def toHBITMAP(self) -> typing.Optional[PyQt6.sip.voidptr]: ...
    @typing.overload
    def convertToFormat(
        self, f: "QImage.Format", flags: QtCore.Qt.ImageConversionFlag = ...
    ) -> "QImage": ...
...
class QImageIOHandler(PyQt6.sip.simplewrapper):
    ...
    def setFormat(
        self, format: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
...
class QImageReader(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        device: typing.Optional[QtCore.QIODevice],
        format: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def imageFormatsForMimeType(
        mimeType: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
...
class QImageWriter(PyQt6.sip.simplewrapper):
    ...
    def subType(self) -> QtCore.QByteArray: ...
    def setSubType(
        self, type: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    @staticmethod
    def supportedMimeTypes() -> list[QtCore.QByteArray]: ...
    ...
    def supportsOption(self, option: QImageIOHandler.ImageOption) -> bool: ...
    def setText(
        self, key: typing.Optional[str], text: typing.Optional[str]
    ) -> None: ...
    @staticmethod
    def supportedImageFormats() -> list[QtCore.QByteArray]: ...
    def errorString(self) -> str: ...
...
class QKeySequence(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, key: typing.Optional[str], format: "QKeySequence.SequenceFormat" = ...
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    @staticmethod
    def listFromString(
        str: typing.Optional[str], format: "QKeySequence.SequenceFormat" = ...
    ) -> list["QKeySequence"]: ...
    @staticmethod
...
class QOffscreenSurface(QtCore.QObject, QSurface):
    def __init__(
        self,
        screen: typing.Optional["QScreen"] = ...,
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> None: ...
...
class QOpenGLContext(QtCore.QObject):
    ...
    def hasExtension(
        self, extension: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> bool: ...
    def extensions(self) -> set[QtCore.QByteArray]: ...
    @staticmethod
    def areSharing(
        first: typing.Optional["QOpenGLContext"],
        second: typing.Optional["QOpenGLContext"],
    ) -> bool: ...
    @staticmethod
    def currentContext() -> typing.Optional["QOpenGLContext"]: ...
    def surface(self) -> typing.Optional[QSurface]: ...
    def getProcAddress(
        self, procName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ...
    def setScreen(self, screen: typing.Optional["QScreen"]) -> None: ...
    def setShareContext(
        self, shareContext: typing.Optional["QOpenGLContext"]
    ) -> None: ...
    def setFormat(self, format: "QSurfaceFormat") -> None: ...
...
class QPageLayout(PyQt6.sip.simplewrapper):
    ...
    def setTopMargin(
        self, topMargin: float, outOfBoundsPolicy: "QPageLayout.OutOfBoundsPolicy" = ...
    ) -> bool: ...
    def setRightMargin(
        self,
        rightMargin: float,
...
class QWindow(QtCore.QObject, QSurface):
    ...
    def isAncestorOf(
        self, child: typing.Optional["QWindow"], mode: "QWindow.AncestorMode" = ...
    ) -> bool: ...
    ...
    def parent(
        self, mode: "QWindow.AncestorMode" = ...
    ) -> typing.Optional["QWindow"]: ...
...
class QPaintEngine(PyQt6.sip.simplewrapper):
    ...
    def drawPolygon(
        self,
        points: typing.Optional[PyQt6.sip.array[QtCore.QPointF]],
        mode: "QPaintEngine.PolygonDrawMode",
    ) -> None: ...
    @typing.overload
    def drawPolygon(
        self,
        points: typing.Optional[PyQt6.sip.array[QtCore.QPoint]],
        mode: "QPaintEngine.PolygonDrawMode",
    ) -> None: ...
    @typing.overload
    def drawPoints(
        self, points: typing.Optional[PyQt6.sip.array[QtCore.QPointF]]
    ) -> None: ...
    @typing.overload
    def drawPoints(
        self, points: typing.Optional[PyQt6.sip.array[QtCore.QPoint]]
    ) -> None: ...
    ...
    @typing.overload
    def drawLines(
        self, lines: typing.Optional[PyQt6.sip.array[QtCore.QLine]]
    ) -> None: ...
    @typing.overload
    def drawLines(
        self, lines: typing.Optional[PyQt6.sip.array[QtCore.QLineF]]
    ) -> None: ...
    @typing.overload
    def drawRects(
        self, rects: typing.Optional[PyQt6.sip.array[QtCore.QRect]]
    ) -> None: ...
    @typing.overload
    def drawRects(
        self, rects: typing.Optional[PyQt6.sip.array[QtCore.QRectF]]
    ) -> None: ...
...
class QPainter(PyQt6.sip.simplewrapper):
    ...
    def drawPixmapFragments(
        self,
        fragments: typing.Optional[PyQt6.sip.array["QPainter.PixmapFragment"]],
        pixmap: QPixmap,
    ...
    @typing.overload
    def fillRect(
        self, a0: QtCore.QRectF, color: typing.Union[QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
    @typing.overload
    def fillRect(
        self, a0: QtCore.QRect, color: typing.Union[QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
    @typing.overload
    def fillRect(
        self,
        ...
        w: int,
        h: int,
        b: typing.Union[QColor, QtCore.Qt.GlobalColor, int],
    ) -> None: ...
    @typing.overload
    def fillRect(
    ...
    @typing.overload
    def boundingRect(
        self, rect: QtCore.QRectF, flags: int, text: typing.Optional[str]
    ) -> QtCore.QRectF: ...
    @typing.overload
    def boundingRect(
        self, rect: QtCore.QRect, flags: int, text: typing.Optional[str]
    ) -> QtCore.QRect: ...
    @typing.overload
    def boundingRect(
        self,
    ...
    @typing.overload
    def boundingRect(
        self, x: int, y: int, w: int, h: int, flags: int, text: typing.Optional[str]
    ) -> QtCore.QRect: ...
    @typing.overload
    def drawText(self, p: QtCore.QPointF, s: typing.Optional[str]) -> None: ...
    @typing.overload
    def drawText(
        self, rectangle: QtCore.QRectF, flags: int, text: typing.Optional[str]
    ) -> typing.Optional[QtCore.QRectF]: ...
    @typing.overload
    def drawText(
        self, rectangle: QtCore.QRect, flags: int, text: typing.Optional[str]
    ) -> typing.Optional[QtCore.QRect]: ...
    @typing.overload
    def drawText(
        self,
        rectangle: QtCore.QRectF,
    ...
    @typing.overload
    def drawConvexPolygon(
        self, point: typing.Optional[QtCore.QPointF], *args: QtCore.QPointF
    ) -> None: ...
    @typing.overload
    def drawConvexPolygon(
        self, points: typing.Optional[PyQt6.sip.array[QtCore.QPoint]]
    ...
    @typing.overload
    def drawConvexPolygon(
        self, point: typing.Optional[QtCore.QPoint], *args: QtCore.QPoint
    ) -> None: ...
    @typing.overload
    def drawPolygon(
    ...
    @typing.overload
    def drawRects(
        self, rect: typing.Optional[QtCore.QRectF], *args: QtCore.QRectF
    ) -> None: ...
    @typing.overload
    def drawRects(
        self, rects: typing.Optional[PyQt6.sip.array[QtCore.QRect]]
    ...
    @typing.overload
    def drawRects(
        self, rect: typing.Optional[QtCore.QRect], *args: QtCore.QRect
    ) -> None: ...
    @typing.overload
    def drawLines(
        self, lines: typing.Optional[PyQt6.sip.array[QtCore.QLineF]]
    ...
    @typing.overload
    def drawLines(
        self, line: typing.Optional[QtCore.QLineF], *args: QtCore.QLineF
    ) -> None: ...
    @typing.overload
    def drawLines(
        self, pointPairs: typing.Optional[PyQt6.sip.array[QtCore.QPointF]]
    ) -> None: ...
    @typing.overload
    def drawLines(
        self, pointPair: typing.Optional[QtCore.QPointF], *args: QtCore.QPointF
    ) -> None: ...
    @typing.overload
    def drawLines(
        self, lines: typing.Optional[PyQt6.sip.array[QtCore.QLine]]
    ...
    @typing.overload
    def drawLines(
        self, line: typing.Optional[QtCore.QLine], *args: QtCore.QLine
    ) -> None: ...
    @typing.overload
    def drawLines(
        self, pointPairs: typing.Optional[PyQt6.sip.array[QtCore.QPoint]]
    ) -> None: ...
    @typing.overload
    def drawLines(
        self, pointPair: typing.Optional[QtCore.QPoint], *args: QtCore.QPoint
    ) -> None: ...
    @typing.overload
    ...
    def strokePath(
        self,
        path: "QPainterPath",
        pen: typing.Union["QPen", typing.Union[QColor, QtCore.Qt.GlobalColor, int]],
    ) -> None: ...
...
class QPainterPath(PyQt6.sip.simplewrapper):
    ...
    def trimmed(
        self, fromFraction: float, toFraction: float, offset: float = ...
    ) -> "QPainterPath": ...
    ...
    @typing.overload
    def addText(
        self, point: QtCore.QPointF, f: QFont, text: typing.Optional[str]
    ) -> None: ...
    @typing.overload
    def addText(
        self, x: float, y: float, f: QFont, text: typing.Optional[str]
    ) -> None: ...
    ...
    @typing.overload
    def cubicTo(
        self, ctrlPt1: QtCore.QPointF, ctrlPt2: QtCore.QPointF, endPt: QtCore.QPointF
    ) -> None: ...
    @typing.overload
    def cubicTo(
        self,
...
class QPalette(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, button: typing.Union[QColor, QtCore.Qt.GlobalColor, int]
    ) -> None: ...
    @typing.overload
    ...
    def __init__(
        self,
        button: typing.Union[QColor, QtCore.Qt.GlobalColor, int],
        background: typing.Union[QColor, QtCore.Qt.GlobalColor, int],
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        foreground: typing.Union[
            QBrush, typing.Union[QColor, QtCore.Qt.GlobalColor, int], QGradient
        ],
        button: typing.Union[
            QBrush, typing.Union[QColor, QtCore.Qt.GlobalColor, int], QGradient
    ...
    def setColor(
        ...
        acolor: typing.Union[QColor, QtCore.Qt.GlobalColor, int],
    ) -> None: ...
    @typing.overload
    def setColor(
        self,
...
class QPdfOutputIntent(PyQt6.sip.simplewrapper):
    ...
    def setOutputConditionIdentifier(
...
class QPdfWriter(QtCore.QObject, QPagedPaintDevice):
    ...
    def setDocumentXmpMetadata(
        self, xmpMetadata: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
...
class QPointingDevice(QInputDevice):
    ...
    def primaryPointingDevice(
        seatName: typing.Optional[str] = ...,
    ) -> typing.Optional["QPointingDevice"]: ...
    def uniqueId(self) -> QPointingDeviceUniqueId: ...
...
class QQuaternion(PyQt6.sip.simplewrapper):
    ...
    def getAxisAndAngle(
        self,
    ) -> typing.Tuple[typing.Optional["QVector3D"], typing.Optional[float]]: ...
...
class QSessionManager(QtCore.QObject):
    ...
    def setManagerProperty(
        self,
        name: typing.Optional[str],
        value: collections.abc.Iterable[typing.Optional[str]],
    ) -> None: ...
...
class QStandardItemModel(QtCore.QAbstractItemModel):
    ...
    def setItemRoleNames(
        self,
        roleNames: dict[
            int, typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
        ],
    ) -> None: ...
    def dropMimeData(
        self,
    ...
    def setVerticalHeaderItem(
        self, row: int, item: typing.Optional["QStandardItem"]
    ) -> None: ...
    def verticalHeaderItem(self, row: int) -> typing.Optional["QStandardItem"]: ...
    def setHorizontalHeaderItem(
        self, column: int, item: typing.Optional["QStandardItem"]
    ) -> None: ...
    ...
    @typing.overload
    def setItem(
        self, row: int, column: int, item: typing.Optional["QStandardItem"]
    ) -> None: ...
    @typing.overload
    ...
    def indexFromItem(
        self, item: typing.Optional["QStandardItem"]
    ) -> QtCore.QModelIndex: ...
    def itemFromIndex(
        self, index: QtCore.QModelIndex
    ) -> typing.Optional["QStandardItem"]: ...
...
class QStandardItem(PyQt6.sip.wrapper):
    ...
    def setAccessibleDescription(
        self, aaccessibleDescription: typing.Optional[str]
    ) -> None: ...
...
class QSyntaxHighlighter(QtCore.QObject):
    ...
    def setCurrentBlockUserData(
        self, data: typing.Optional["QTextBlockUserData"]
    ) -> None: ...
...
class QTextCursor(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def createList(
        self, style: "QTextListFormat.Style"
    ) -> typing.Optional["QTextList"]: ...
    @typing.overload
    ...
    @typing.overload
    def insertText(
        self, text: typing.Optional[str], format: "QTextCharFormat"
    ) -> None: ...
    def anchor(self) -> int: ...
...
class QTextDocument(QtCore.QObject):
    ...
    def drawContents(
        self, p: typing.Optional[QPainter], rect: QtCore.QRectF = ...
    ) -> None: ...
    ...
    def setMetaInformation(
        self, info: "QTextDocument.MetaInformation", a1: typing.Optional[str]
    ) -> None: ...
    def documentLayout(self) -> typing.Optional[QAbstractTextDocumentLayout]: ...
    def setDocumentLayout(
        self, layout: typing.Optional[QAbstractTextDocumentLayout]
    ) -> None: ...
    ...
    def isEmpty(self) -> bool: ...
    def clone(
        self, parent: typing.Optional[QtCore.QObject] = ...
    ) -> typing.Optional["QTextDocument"]: ...
...
class QTextDocumentFragment(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromMarkdown(
        markdown: typing.Optional[str], features: QTextDocument.MarkdownFeature = ...
    ...
    def fromHtml(
        ...
        resourceProvider: typing.Optional[QTextDocument] = ...,
    ) -> "QTextDocumentFragment": ...
    @staticmethod
...
class QTextCharFormat(QTextFormat):
    class FontPropertiesInheritanceBehavior(enum.Enum):
        FontPropertiesSpecifiedOnly = (
            ...
        )  # type: QTextCharFormat.FontPropertiesInheritanceBehavior
        FontPropertiesAll = (
            ...
        )  # type: QTextCharFormat.FontPropertiesInheritanceBehavior
    ...
    def setFontFamilies(
        self, families: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    ...
    def setTextOutline(
        self, pen: typing.Union[QPen, typing.Union[QColor, QtCore.Qt.GlobalColor, int]]
    ) -> None: ...
...
class QTextLayout(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        ...
        text: typing.Optional[str],
        font: QFont,
        paintdevice: typing.Optional[QPaintDevice] = ...,
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawCursor(
        self, p: typing.Optional[QPainter], pos: QtCore.QPointF, cursorPosition: int
    ) -> None: ...
    @typing.overload
    def drawCursor(
        self,
        p: typing.Optional[QPainter],
        pos: QtCore.QPointF,
        cursorPosition: int,
        width: int,
    ) -> None: ...
...
class QTextLine(PyQt6.sip.simplewrapper):
    ...
    def position(self) -> QtCore.QPointF: ...
    def draw(
        self, painter: typing.Optional[QPainter], position: QtCore.QPointF
    ) -> None: ...
    ...
    def cursorToX(
        self, cursorPos: typing.Optional[int], edge: "QTextLine.Edge" = ...
    ) -> typing.Tuple[float, typing.Optional[int]]: ...
...
class QTransform(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, h11: float, h12: float, h13: float, h21: float, h22: float, h23: float
    ) -> None: ...
    @typing.overload
...
class QUndoCommand(PyQt6.sip.wrapper):
    ...
    @typing.overload
    def __init__(
        self, text: typing.Optional[str], parent: typing.Optional["QUndoCommand"] = ...
    ) -> None: ...
...
class QIntValidator(QValidator):
    ...
    @typing.overload
    def __init__(
        self, bottom: int, top: int, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    def top(self) -> int: ...
    def bottom(self) -> int: ...
