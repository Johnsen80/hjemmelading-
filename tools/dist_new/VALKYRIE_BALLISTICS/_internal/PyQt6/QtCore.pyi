...
class QObject(PyQt6.sip.wrapper):
    ...
    def setObjectName(
        self,
        name: typing.Union[
            typing.Union["QByteArray", bytes, bytearray, memoryview],
            typing.Optional[str],
        ],
    ) -> None: ...
    ...
    def eventFilter(
        self, a0: typing.Optional["QObject"], a1: typing.Optional["QEvent"]
    ) -> bool: ...
...
class QAbstractEventDispatcher(QObject):
    ...
    def registeredTimers(
        self, object: typing.Optional[QObject]
    ...
    @typing.overload
    def registerTimer(
        self, interval: int, timerType: Qt.TimerType, object: typing.Optional[QObject]
    ) -> int: ...
    @typing.overload
    def registerTimer(
        self,
...
class QAbstractItemModel(QObject):
    ...
    def checkIndex(
        self, index: QModelIndex, options: "QAbstractItemModel.CheckIndexOption" = ...
    ) -> bool: ...
    def moveColumn(
        self,
    ...
    def canDropMimeData(
        self,
        data: typing.Optional["QMimeData"],
    ...
    def encodeData(
        self, indexes: collections.abc.Iterable[QModelIndex], stream: "QDataStream"
    ) -> None: ...
...
class QAbstractProxyModel(QAbstractItemModel):
    ...
    def setSourceModel(
        self, sourceModel: typing.Optional[QAbstractItemModel]
    ) -> None: ...
...
class QAnimationGroup(QAbstractAnimation):
    ...
    def removeAnimation(
        self, animation: typing.Optional[QAbstractAnimation]
    ) -> None: ...
    def insertAnimation(
        self, index: int, animation: typing.Optional[QAbstractAnimation]
    ) -> None: ...
...
class QBasicTimer(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def start(
        self, msec: int, timerType: Qt.TimerType, obj: typing.Optional[QObject]
    ) -> None: ...
    @typing.overload
...
class QBuffer(QIODevice):
    ...
    def __init__(
        self,
        byteArray: typing.Optional["QByteArray"],
    ...
    @typing.overload
    def setData(
        self, data: typing.Union["QByteArray", bytes, bytearray, memoryview]
    ) -> None: ...
    @typing.overload
...
class QByteArray(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, a: typing.Union["QByteArray", bytes, bytearray, memoryview]
    ) -> None: ...
    def __add__(
        self, a2: typing.Union["QByteArray", bytes, bytearray, memoryview]
    ) -> "QByteArray": ...
    ...
    def assign(
        self, v: typing.Union["QByteArray", bytes, bytearray, memoryview]
    ) -> "QByteArray": ...
    ...
    def fromBase64Encoding(
        base64: typing.Union["QByteArray", bytes, bytearray, memoryview],
    ...
    def compare(
        self,
        a: typing.Union["QByteArray", bytes, bytearray, memoryview],
    ...
    def fromPercentEncoding(
        input: typing.Union["QByteArray", bytes, bytearray, memoryview],
        percent: str = ...,
    ) -> "QByteArray": ...
    def toPercentEncoding(
        self,
        exclude: typing.Union["QByteArray", bytes, bytearray, memoryview] = ...,
        include: typing.Union["QByteArray", bytes, bytearray, memoryview] = ...,
        percent: str = ...,
    ) -> "QByteArray": ...
    def toHex(self, separator: bytes = ...) -> "QByteArray": ...
    def contains(
        self, bv: typing.Union["QByteArray", bytes, bytearray, memoryview]
    ) -> bool: ...
    def push_front(
        self, a: typing.Union["QByteArray", bytes, bytearray, memoryview]
    ) -> None: ...
    ...
    @staticmethod
    def fromHex(
        hexEncoded: typing.Union["QByteArray", bytes, bytearray, memoryview],
    ) -> "QByteArray": ...
    @staticmethod
    def fromBase64(
        base64: typing.Union["QByteArray", bytes, bytearray, memoryview],
    ...
    def replace(
        self,
        before: typing.Union["QByteArray", bytes, bytearray, memoryview],
        after: typing.Union["QByteArray", bytes, bytearray, memoryview],
    ) -> "QByteArray": ...
    @typing.overload
    def replace(
        self,
        index: int,
        len: int,
        s: typing.Union["QByteArray", bytes, bytearray, memoryview],
    ) -> "QByteArray": ...
    def remove(self, index: int, len: int) -> "QByteArray": ...
    @typing.overload
    def insert(
        self, i: int, data: typing.Union["QByteArray", bytes, bytearray, memoryview]
    ) -> "QByteArray": ...
    @typing.overload
    ...
    def lastIndexOf(
        self,
        bv: typing.Union["QByteArray", bytes, bytearray, memoryview],
        from_: int = ...,
    ) -> int: ...
    def indexOf(
        self,
...
class QByteArrayMatcher(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, pattern: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def indexIn(
        self, str: typing.Optional[bytes], len: int, from_: int = ...
    ) -> int: ...
    def setPattern(
        self, pattern: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
...
class QCalendar(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        name: typing.Union[
            typing.Union[QByteArray, bytes, bytearray, memoryview], typing.Optional[str]
        ],
    ) -> None: ...
    @typing.overload
    ...
    def dateTimeToString(
        ...
        dateOnly: typing.Union["QDate", datetime.date],
        timeOnly: typing.Union["QTime", datetime.time],
        locale: "QLocale",
    ) -> str: ...
    ...
    def partsFromDate(
        self, date: typing.Union["QDate", datetime.date]
...
class QCborStreamReader(PyQt6.sip.simplewrapper):
    ...
    def readAndAppendToByteArray(
        self, dst: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> bool: ...
...
class QCommandLineOption(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, names: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        valueName: typing.Optional[str] = ...,
        defaultValue: typing.Optional[str] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        names: collections.abc.Iterable[typing.Optional[str]],
        description: typing.Optional[str],
        valueName: typing.Optional[str] = ...,
        defaultValue: typing.Optional[str] = ...,
    ) -> None: ...
    ...
    def setDefaultValues(
        self, defaultValues: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QCommandLineParser(PyQt6.sip.simplewrapper):
    ...
    class OptionsAfterPositionalArgumentsMode(enum.Enum):
        ParseAsOptions = (
            ...
        )  # type: QCommandLineParser.OptionsAfterPositionalArgumentsMode
    ...
    class SingleDashWordOptionMode(enum.Enum):
        ParseAsCompactedShortOptions = (
            ...
        )  # type: QCommandLineParser.SingleDashWordOptionMode
    ...
    def parse(
        self, arguments: collections.abc.Iterable[typing.Optional[str]]
    ) -> bool: ...
    @typing.overload
    def process(
        self, arguments: collections.abc.Iterable[typing.Optional[str]]
...
class QCoreApplication(QObject):
    ...
    def setEventDispatcher(
        eventDispatcher: typing.Optional[QAbstractEventDispatcher],
    ) -> None: ...
    @staticmethod
    ...
    def removePostedEvents(
        receiver: typing.Optional[QObject], eventType: int = ...
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def postEvent(
        receiver: typing.Optional[QObject],
        event: typing.Optional["QEvent"],
        priority: int = ...,
    ) -> None: ...
    @staticmethod
    def sendEvent(
        receiver: typing.Optional[QObject], event: typing.Optional["QEvent"]
    ) -> bool: ...
    @typing.overload
    @staticmethod
...
class QDynamicPropertyChangeEvent(QEvent):
    def __init__(
        self, name: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
...
class QDataStream(QIODeviceBase):
    ...
    @typing.overload
    def __init__(
        self, a0: typing.Optional[QByteArray], flags: QIODeviceBase.OpenModeFlag
    ) -> None: ...
    @typing.overload
    def __init__(
        self, a0: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def __lshift__(
        self, a0: typing.Union["QDateTime", datetime.datetime]
    ) -> "QDataStream": ...
    @typing.overload
    ...
    def writeQVariantHash(
        self, qvarhash: dict[typing.Optional[str], typing.Any]
    ) -> None: ...
    def readQVariantHash(self) -> dict[str, typing.Any]: ...
    def writeQVariantMap(
        self, qvarmap: dict[typing.Optional[str], typing.Any]
    ) -> None: ...
    ...
    def writeQStringList(
        self, qstrlst: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QDate(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromString(
        string: typing.Optional[str], format: Qt.DateFormat = ...
    ) -> "QDate": ...
    @typing.overload
    @staticmethod
    def fromString(
        string: typing.Optional[str], format: typing.Optional[str], cal: QCalendar = ...
    ) -> "QDate": ...
    @typing.overload
    @staticmethod
    def fromString(
...
class QTime(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromString(
        s: typing.Optional[str], format: typing.Optional[str]
    ) -> "QTime": ...
    @staticmethod
...
class QDir(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        ...
        nameFilter: typing.Optional[str],
        sort: "QDir.SortFlag" = ...,
        filters: "QDir.Filter" = ...,
    ) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def addSearchPath(
        prefix: typing.Optional[str], path: typing.Optional[str]
    ) -> None: ...
    @staticmethod
    def setSearchPaths(
        prefix: typing.Optional[str],
        searchPaths: collections.abc.Iterable[typing.Optional[str]],
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def match(
        filters: collections.abc.Iterable[typing.Optional[str]],
    ...
    def rename(
        self, oldName: typing.Optional[str], newName: typing.Optional[str]
    ) -> bool: ...
    ...
    @typing.overload
    def mkpath(
        self, dirPath: typing.Optional[str], permissions: "QFileDevice.Permission"
    ) -> bool: ...
    @typing.overload
    ...
    @typing.overload
    def mkdir(
        self, dirName: typing.Optional[str], permissions: "QFileDevice.Permission"
    ) -> bool: ...
    @typing.overload
    ...
    def entryInfoList(
        self,
        nameFilters: collections.abc.Iterable[typing.Optional[str]],
        filters: "QDir.Filter" = ...,
        sort: "QDir.SortFlag" = ...,
    ) -> list["QFileInfo"]: ...
    @typing.overload
    ...
    def setNameFilters(
        self, nameFilters: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QDirIterator(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, path: typing.Optional[str], flags: "QDirIterator.IteratorFlag" = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QFileDevice(QIODevice):
    ...
    ) -> typing.Optional[PyQt6.sip.voidptr]: ...
...
class QFile(QFileDevice):
    ...
    @typing.overload
    def __init__(
        self, name: typing.Optional[str], parent: typing.Optional[QObject]
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def setPermissions(
        filename: typing.Optional[str], permissionSpec: QFileDevice.Permission
    ) -> bool: ...
    @typing.overload
    def permissions(self) -> QFileDevice.Permission: ...
    @typing.overload
    ...
    @typing.overload
    def open(
        self, flags: QIODeviceBase.OpenModeFlag, permissions: QFileDevice.Permission
    ) -> bool: ...
    @typing.overload
    ...
    @staticmethod
    def rename(
        oldName: typing.Optional[str], newName: typing.Optional[str]
    ) -> bool: ...
    @typing.overload
    ...
    @staticmethod
    def decodeName(
        localFileName: typing.Union[QByteArray, bytes, bytearray, memoryview],
    ) -> str: ...
    @typing.overload
    @staticmethod
...
class QFileSelector(QObject):
    ...
    def setExtraSelectors(
        self, list: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QFileSystemWatcher(QObject):
    ...
    def __init__(
        self,
        paths: collections.abc.Iterable[typing.Optional[str]],
        parent: typing.Optional[QObject] = ...,
    ) -> None: ...
    ...
    def removePaths(
        self, files: collections.abc.Iterable[typing.Optional[str]]
    ) -> list[str]: ...
...
class QItemSelection(PyQt6.sip.simplewrapper):
    ...
    def split(
        ...
        result: typing.Optional["QItemSelection"],
    ) -> None: ...
    def merge(
...
class QJsonDocument(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        ...
        object: dict[
            ...
            typing.Union[
                ...
                dict[typing.Optional[str], "QJsonValue"],
                bool,
                int,
                float,
                None,
    ...
    @staticmethod
    def fromJson(
        json: typing.Union[QByteArray, bytes, bytearray, memoryview],
...
class QJsonValue(PyQt6.sip.simplewrapper):
    ...
    def fromJson(
        ...
        typing.Optional["QJsonValue"], typing.Optional[QJsonParseError]
    ]: ...
    def __hash__(self) -> int: ...
    @typing.overload
    def __getitem__(self, i: int) -> typing.Optional["QJsonValue"]: ...
...
class QLibrary(QObject):
    ...
    @typing.overload
    def __init__(
        self, fileName: typing.Optional[str], parent: typing.Optional[QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def setFileNameAndVersion(
        self, fileName: typing.Optional[str], verNum: int
    ) -> None: ...
    @typing.overload
    def setFileNameAndVersion(
        self, fileName: typing.Optional[str], version: typing.Optional[str]
    ) -> None: ...
    ...
    @typing.overload
    def resolve(
        self, symbol: typing.Optional[str]
    ) -> typing.Optional[PyQt6.sip.voidptr]: ...
    @typing.overload
    @staticmethod
    def resolve(
        fileName: typing.Optional[str], symbol: typing.Optional[str]
    ) -> typing.Optional[PyQt6.sip.voidptr]: ...
    @typing.overload
    @staticmethod
    def resolve(
        fileName: typing.Optional[str], verNum: int, symbol: typing.Optional[str]
    ) -> typing.Optional[PyQt6.sip.voidptr]: ...
    @typing.overload
    @staticmethod
    def resolve(
...
class QLineF(PyQt6.sip.simplewrapper):
    ...
    def intersects(
        self, l: "QLineF"
    ) -> typing.Tuple["QLineF.IntersectionType", typing.Optional["QPointF"]]: ...
...
class QLocale(PyQt6.sip.simplewrapper):
    ...
    def toCurrencyString(
        self, a0: float, symbol: typing.Optional[str] = ..., precision: int = ...
    ) -> str: ...
    @typing.overload
    def toCurrencyString(
        self, value: int, symbol: typing.Optional[str] = ...
    ) -> str: ...
    ...
    @typing.overload
    def toTime(
        self, string: typing.Optional[str], format: "QLocale.FormatType" = ...
    ) -> QTime: ...
    @typing.overload
    def toTime(
        self, string: typing.Optional[str], format: typing.Optional[str]
    ) -> QTime: ...
    @typing.overload
    def toDate(
        self,
    ...
    @typing.overload
    def toString(
        self, date: typing.Union[QDate, datetime.date], formatStr: str
    ) -> str: ...
    @typing.overload
    def toString(
        self,
    ...
    @typing.overload
    def toString(
        self, time: typing.Union[QTime, datetime.time], formatStr: str
    ) -> str: ...
    @typing.overload
...
class QLockFile(PyQt6.sip.simplewrapper):
    ...
    def getLockInfo(
        ...
        bool, typing.Optional[int], typing.Optional[str], typing.Optional[str]
    ]: ...
...
class QMessageLogger(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, file: typing.Optional[str], line: int, function: typing.Optional[str]
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QLoggingCategory(PyQt6.sip.simplewrapper):
    def __init__(
        self, category: typing.Optional[str], severityLevel: QtMsgType = ...
    ) -> None: ...
    @staticmethod
...
class QMessageAuthenticationCode(PyQt6.sip.simplewrapper):
    def __init__(
        self,
        method: QCryptographicHash.Algorithm,
        key: typing.Union[QByteArray, bytes, bytearray, memoryview] = ...,
    ) -> None: ...
    def swap(self, other: "QMessageAuthenticationCode") -> None: ...
    @staticmethod
    def hash(
        message: typing.Union[QByteArray, bytes, bytearray, memoryview],
        key: typing.Union[QByteArray, bytes, bytearray, memoryview],
        method: QCryptographicHash.Algorithm,
    ) -> QByteArray: ...
    def result(self) -> QByteArray: ...
    ...
    def addData(self, device: typing.Optional[QIODevice]) -> bool: ...
    def setKey(
        self, key: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    def reset(self) -> None: ...
...
class QMimeData(QObject):
    def __init__(self) -> None: ...
    def retrieveData(
        self, mimetype: typing.Optional[str], preferredType: QMetaType
    ) -> typing.Any: ...
...
class QMimeDatabase(PyQt6.sip.simplewrapper):
    ...
    def mimeTypeForFileNameAndData(
        self, fileName: typing.Optional[str], device: typing.Optional[QIODevice]
    ) -> "QMimeType": ...
    @typing.overload
    def mimeTypeForFileNameAndData(
        self,
    ...
    @typing.overload
    def mimeTypeForFile(
        self, fileName: typing.Optional[str], mode: "QMimeDatabase.MatchMode" = ...
    ) -> "QMimeType": ...
    @typing.overload
    def mimeTypeForFile(
...
class QMetaObject(PyQt6.sip.simplewrapper):
    ...
    def newInstance(
        ...
        value8: "QGenericArgument" = ...,
        value9: "QGenericArgument" = ...,
    ) -> typing.Optional[QObject]: ...
    @typing.overload
    @staticmethod
    def invokeMethod(
        obj: typing.Optional[QObject],
    ...
    def checkConnectArgs(
        signal: typing.Optional[str], method: typing.Optional[str]
    ) -> bool: ...
    @typing.overload
    @staticmethod
...
class QVariantAnimation(QAbstractAnimation):
    ...
    def setEasingCurve(
        self, easing: typing.Union[QEasingCurve, QEasingCurve.Type]
    ) -> None: ...
...
class QPropertyAnimation(QVariantAnimation):
    ...
    def __init__(
        self,
        target: typing.Optional[QObject],
        propertyName: typing.Union[QByteArray, bytes, bytearray, memoryview],
        parent: typing.Optional[QObject] = ...,
    ) -> None: ...
    def updateState(
        self, newState: QAbstractAnimation.State, oldState: QAbstractAnimation.State
    ...
    def event(self, event: typing.Optional[QEvent]) -> bool: ...
    def setPropertyName(
        self, propertyName: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    def propertyName(self) -> QByteArray: ...
...
class QProcess(QIODevice):
    ...
    def setNativeArguments(self, arguments: typing.Optional[str]) -> None: ...
    def setArguments(
        self, arguments: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    ...
    def setStandardOutputProcess(
        self, destination: typing.Optional["QProcess"]
    ) -> None: ...
    def setStandardErrorFile(
        self, fileName: typing.Optional[str], mode: QIODeviceBase.OpenModeFlag = ...
    ) -> None: ...
    ...
    def startDetached(
        ...
        arguments: collections.abc.Iterable[typing.Optional[str]] = ...,
    ...
    def startCommand(
        self, command: typing.Optional[str], mode: QIODeviceBase.OpenModeFlag = ...
    ) -> None: ...
    @typing.overload
    def start(
        self,
...
class QProcessEnvironment(PyQt6.sip.simplewrapper):
    ...
    def value(
        self, name: typing.Optional[str], defaultValue: typing.Optional[str] = ...
    ) -> str: ...
...
class QRangeModel(QAbstractItemModel):
    def __init__(
        self,
        range: typing.Optional["QPyAbstractRange"],
        parent: typing.Optional[QObject] = ...,
    ) -> None: ...
    def eventFilter(
        self, a0: typing.Optional[QObject], a1: typing.Optional[QEvent]
    ...
    def setRoleNames(
        self, names: dict[int, typing.Union[QByteArray, bytes, bytearray, memoryview]]
    ) -> None: ...
    def roleNames(self) -> dict[int, QByteArray]: ...
    def moveRows(
        self,
    ...
    def itemData(self, index: QModelIndex) -> dict[int, typing.Any]: ...
    def setData(
        self, index: QModelIndex, data: typing.Any, role: int = ...
    ) -> bool: ...
    def data(self, index: QModelIndex, role: int = ...) -> typing.Any: ...
    def setHeaderData(
        self,
...
class QRegularExpression(PyQt6.sip.simplewrapper):
    class WildcardConversionOption(enum.Flag):
        DefaultWildcardConversion = (
            ...
        )  # type: QRegularExpression.WildcardConversionOption
...
class QResource(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self, fileName: typing.Optional[str] = ..., locale: QLocale = ...
    ) -> None: ...
    ...
    def unregisterResourceData(
        rccData: typing.Optional[bytes], mapRoot: typing.Optional[str] = ...
    ) -> bool: ...
    @staticmethod
    def unregisterResource(
        rccFileName: typing.Optional[str], mapRoot: typing.Optional[str] = ...
    ) -> bool: ...
    @staticmethod
...
class QSequentialAnimationGroup(QAnimationGroup):
    ...
    ) -> typing.Optional[QPauseAnimation]: ...
...
class QSettings(QObject):
    ...
    @typing.overload
    def __init__(
        self, scope: "QSettings.Scope", parent: typing.Optional[QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QObject] = ...) -> None: ...
    def event(self, event: typing.Optional[QEvent]) -> bool: ...
    ...
    @staticmethod
    def setPath(
        format: "QSettings.Format", scope: "QSettings.Scope", path: typing.Optional[str]
    ) -> None: ...
    def fileName(self) -> str: ...
...
class QSharedMemory(QObject):
    ...
    @typing.overload
    def __init__(
        self, key: "QNativeIpcKey", parent: typing.Optional[QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, key: typing.Optional[str], parent: typing.Optional[QObject] = ...
    ) -> None: ...
    @staticmethod
    def legacyNativeKey(
        key: typing.Optional[str], type: "QNativeIpcKey.Type" = ...
    ) -> "QNativeIpcKey": ...
    @staticmethod
    def platformSafeKey(
        key: typing.Optional[str], type: "QNativeIpcKey.Type" = ...
    ...
    @typing.overload
    def setNativeKey(
        self, key: typing.Optional[str], type: "QNativeIpcKey.Type" = ...
    ) -> None: ...
    def errorString(self) -> str: ...
...
class QSignalMapper(QObject):
    ...
    @typing.overload
    def setMapping(
        self, sender: typing.Optional[QObject], text: typing.Optional[str]
    ) -> None: ...
    @typing.overload
    def setMapping(
        self, sender: typing.Optional[QObject], object: typing.Optional[QObject]
    ) -> None: ...
...
class QSocketNotifier(QObject):
    ...
    @typing.overload
    def __init__(
        self, a0: "QSocketNotifier.Type", parent: typing.Optional[QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QSortFilterProxyModel(QAbstractProxyModel):
    ...
    def __init__(self, parent: typing.Optional[QObject] = ...) -> None: ...
    def endFilterChange(
        self, directions: "QSortFilterProxyModel.Direction" = ...
    ) -> None: ...
...
class QStandardPaths(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def findExecutable(
        executableName: typing.Optional[str],
        paths: collections.abc.Iterable[typing.Optional[str]] = ...,
    ) -> str: ...
    @staticmethod
...
class QStringListModel(QAbstractListModel):
    ...
    def sort(self, column: int, order: Qt.SortOrder = ...) -> None: ...
    def setStringList(
        self, strings: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QTemporaryFile(QFile):
    ...
    @typing.overload
    def __init__(
        self, templateName: typing.Optional[str], parent: typing.Optional[QObject]
    ) -> None: ...
    def rename(self, newName: typing.Optional[str]) -> bool: ...
    @typing.overload
    @staticmethod
    def createNativeFile(
        fileName: typing.Optional[str],
    ) -> typing.Optional["QTemporaryFile"]: ...
    @typing.overload
    @staticmethod
...
class QTextBoundaryFinder(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, type: "QTextBoundaryFinder.BoundaryType", string: typing.Optional[str]
    ) -> None: ...
...
class QTextStream(QIODeviceBase):
    ...
    @typing.overload
    def __init__(
        self, array: typing.Optional[QByteArray], mode: QIODeviceBase.OpenModeFlag = ...
    ) -> None: ...
    def __int__(self) -> bool: ...
    @typing.overload
    ...
    @typing.overload
    def __lshift__(
        self, array: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> "QTextStream": ...
    @typing.overload
...
class QThread(QObject):
    ...
    def setEventDispatcher(
        self, eventDispatcher: typing.Optional[QAbstractEventDispatcher]
    ) -> None: ...
...
class QThreadPool(QObject):
    ...
    @typing.overload
    def start(
        self, runnable: typing.Optional[QRunnable], priority: int = ...
    ) -> None: ...
    @typing.overload
    def start(
        self, functionToRun: collections.abc.Callable[[], None], priority: int = ...
    ) -> None: ...
    @staticmethod
...
class QTimeZone(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        zoneId: typing.Union[QByteArray, bytes, bytearray, memoryview],
        offsetSeconds: int,
        name: typing.Optional[str],
    ...
    @typing.overload
    def __init__(
        self, ianaId: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
    @typing.overload
    ...
    def hasAlternativeName(
        self, alias: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> bool: ...
    ...
    def windowsIdToIanaIds(
        windowsId: typing.Union[QByteArray, bytes, bytearray, memoryview],
    ) -> list[QByteArray]: ...
    @typing.overload
    @staticmethod
    def windowsIdToIanaIds(
    ...
    def ianaIdToWindowsId(
        ianaId: typing.Union[QByteArray, bytes, bytearray, memoryview],
    ) -> QByteArray: ...
    @typing.overload
    @staticmethod
...
class QNativeIpcKey(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, k: typing.Optional[str], type: "QNativeIpcKey.Type" = ...
    ) -> None: ...
    @typing.overload
...
class QTranslator(QObject):
    ...
    def loadFromData(
        self,
        data: typing.Optional[PyQt6.sip.array[bytes]],
    ...
    def load(
        ...
        fileName: typing.Optional[str],
        directory: typing.Optional[str] = ...,
        searchDelimiters: typing.Optional[str] = ...,
...
class QTransposeProxyModel(QAbstractProxyModel):
    ...
    def rowCount(self, parent: QModelIndex = ...) -> int: ...
    def setSourceModel(
        self, newSourceModel: typing.Optional[QAbstractItemModel]
    ) -> None: ...
...
class QUrl(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, url: typing.Optional[str], mode: "QUrl.ParsingMode" = ...
    ) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def fromStringList(
        uris: collections.abc.Iterable[typing.Optional[str]],
    ...
    @typing.overload
    def setQuery(
        self, query: typing.Optional[str], mode: "QUrl.ParsingMode" = ...
    ) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def toAce(
        domain: typing.Optional[str], options: "QUrl.AceProcessingOption" = ...
    ) -> QByteArray: ...
    @staticmethod
    def fromAce(
        domain: typing.Union[QByteArray, bytes, bytearray, memoryview],
    ...
    @staticmethod
    def fromPercentEncoding(
        a0: typing.Union[QByteArray, bytes, bytearray, memoryview],
    ) -> str: ...
    def isDetached(self) -> bool: ...
    def detach(self) -> None: ...
    @staticmethod
...
class QUrlQuery(PyQt6.sip.simplewrapper):
    ...
    def allQueryItemValues(
        self, key: typing.Optional[str], options: QUrl.ComponentFormattingOption = ...
    ) -> list[str]: ...
    def queryItemValue(
        self, key: typing.Optional[str], options: QUrl.ComponentFormattingOption = ...
    ) -> str: ...
    ...
    def addQueryItem(
        self, key: typing.Optional[str], value: typing.Optional[str]
    ) -> None: ...
    ...
    def setQueryItems(
        self,
        query: collections.abc.Iterable[
...
class QUuid(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def createUuidV5(
        ns: "QUuid", baseData: typing.Union[QByteArray, bytes, bytearray, memoryview]
    ) -> "QUuid": ...
    @typing.overload
    @staticmethod
...
class QVersionNumber(PyQt6.sip.simplewrapper):
    ...
    ) -> typing.Tuple["QVersionNumber", typing.Optional[int]]: ...
    def toString(self) -> str: ...
    @staticmethod
    def commonPrefix(
...
class QWaitCondition(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def wait(
        self, lockedMutex: typing.Optional[QMutex], deadline: QDeadlineTimer = ...
    ) -> bool: ...
    @typing.overload
    ...
    def wait(
        self,
        lockedReadWriteLock: typing.Optional[QReadWriteLock],
        deadline: QDeadlineTimer = ...,
    ) -> bool: ...
    @typing.overload
    def wait(
        self, lockedReadWriteLock: typing.Optional[QReadWriteLock], time: int
    ) -> bool: ...
...
class QXmlStreamAttribute(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, qualifiedName: typing.Optional[str], value: typing.Optional[str]
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QXmlStreamNamespaceDeclaration(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, prefix: typing.Optional[str], namespaceUri: typing.Optional[str]
    ) -> None: ...
    @typing.overload
...
class QXmlStreamReader(PyQt6.sip.simplewrapper):
    ...
    class ReadElementTextBehaviour(enum.Enum):
        ErrorOnUnexpectedElement = (
            ...
        )  # type: QXmlStreamReader.ReadElementTextBehaviour
    ...
    def setEntityResolver(
        self, resolver: typing.Optional[QXmlStreamEntityResolver]
    ) -> None: ...
    def hasError(self) -> bool: ...
...
class QXmlStreamWriter(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        array: typing.Optional[typing.Union[QByteArray, bytes, bytearray, memoryview]],
    ) -> None: ...
...
class QWinEventNotifier(QObject):
    ...
    def __init__(
        self,
        hEvent: typing.Optional[PyQt6.sip.voidptr],
        parent: typing.Optional[QObject] = ...,
    ) -> None: ...
    def event(self, e: typing.Optional[QEvent]) -> bool: ...
    activated: typing.ClassVar[pyqtSignal]
    def setEnabled(self, enable: bool) -> None: ...
    def setHandle(self, hEvent: typing.Optional[PyQt6.sip.voidptr]) -> None: ...
    def isEnabled(self) -> bool: ...
...
def qFormatLogMessage(
    type: QtMsgType, context: QMessageLogContext, buf: typing.Optional[str]
) -> str: ...
def qSetMessagePattern(messagePattern: typing.Optional[str]) -> None: ...
def qInstallMessageHandler(
    a0: typing.Optional[
        collections.abc.Callable[
            [QtMsgType, QMessageLogContext, typing.Optional[str]], None
        ]
    ],
) -> typing.Optional[
    collections.abc.Callable[
...
@typing.overload
def qCompress(
    data: typing.Optional[PyQt6.sip.array[bytes]], compressionLevel: int = ...
) -> QByteArray: ...
@typing.overload
def qCompress(
    data: typing.Union[QByteArray, bytes, bytearray, memoryview],
...
def qEnvironmentVariableIntegerValue(
    varName: typing.Optional[str],
) -> typing.Optional[int]: ...
...
def qEnvironmentVariable(
    varName: typing.Optional[str], defaultValue: typing.Optional[str]
) -> str: ...
@typing.overload
...
def qUnregisterResourceData(
    a0: int,
    a1: typing.Optional[bytes],
    a2: typing.Optional[bytes],
    a3: typing.Optional[bytes],
) -> bool: ...
