...
class QOpenGLBuffer(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def allocate(
        self, data: typing.Optional[PyQt6.sip.voidptr], count: int
    ) -> None: ...
    @typing.overload
    def allocate(self, count: int) -> None: ...
    def write(
        self, offset: int, data: typing.Optional[PyQt6.sip.voidptr], count: int
    ) -> None: ...
    def read(
        self, offset: int, data: typing.Optional[PyQt6.sip.voidptr], count: int
    ) -> bool: ...
...
class QOpenGLFramebufferObject(PyQt6.sip.simplewrapper):
    class FramebufferRestorePolicy(enum.Enum):
        DontRestoreFramebufferBinding = (
            ...
        )  # type: QOpenGLFramebufferObject.FramebufferRestorePolicy
    ...
    @staticmethod
    def blitFramebuffer(
        target: typing.Optional["QOpenGLFramebufferObject"],
        targetRect: QtCore.QRect,
        source: typing.Optional["QOpenGLFramebufferObject"],
...
class QOpenGLShader(QtCore.QObject):
    ...
    def compileSourceCode(
        self, source: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> bool: ...
    @typing.overload
...
class QOpenGLShaderProgram(QtCore.QObject):
    ...
    def addCacheableShaderFromSourceFile(
        self, type: QOpenGLShader.ShaderTypeBit, fileName: typing.Optional[str]
    ) -> bool: ...
    @typing.overload
    def addCacheableShaderFromSourceCode(
        self,
        type: QOpenGLShader.ShaderTypeBit,
        source: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> bool: ...
    @typing.overload
    def addCacheableShaderFromSourceCode(
        self, type: QOpenGLShader.ShaderTypeBit, source: typing.Optional[str]
    ) -> bool: ...
    def create(self) -> bool: ...
    ...
    @typing.overload
    def setUniformValueArray(
        self, name: typing.Optional[str], values: PYQT_SHADER_UNIFORM_VALUE_ARRAY
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], x: float, y: float
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], x: float, y: float, z: float
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], x: float, y: float, z: float, w: float
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QVector2D
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QVector3D
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QVector4D
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self,
    ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], point: QtCore.QPoint
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], point: QtCore.QPointF
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], size: QtCore.QSize
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], size: QtCore.QSizeF
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QMatrix2x2
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QMatrix2x3
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QMatrix2x4
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QMatrix3x2
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QMatrix3x3
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QMatrix3x4
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QMatrix4x2
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QMatrix4x3
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QMatrix4x4
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: typing.Optional[str], value: QtGui.QTransform
    ) -> None: ...
    @typing.overload
    def uniformLocation(
        self, name: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def setAttributeArray(
        self, name: typing.Optional[str], values: PYQT_SHADER_ATTRIBUTE_ARRAY
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def bindAttributeLocation(
        self, name: typing.Optional[str], location: int
    ) -> None: ...
...
class QOpenGLTexture(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, image: QtGui.QImage, genMipMaps: "QOpenGLTexture.MipMapGeneration" = ...
    ) -> None: ...
    ...
    def setCompressedData(
        ...
        dataSize: int,
        data: typing.Optional[PyQt6.sip.voidptr],
    ...
    def createTextureView(
        ...
        minimumLayer: int,
        maximumLayer: int,
    ) -> typing.Optional["QOpenGLTexture"]: ...
...
class QOpenGLWindow(QtGui.QPaintDeviceWindow):
    ...
    def __init__(
        self,
        shareContext: typing.Optional[QtGui.QOpenGLContext],
        updateBehavior: "QOpenGLWindow.UpdateBehavior" = ...,
        parent: typing.Optional[QtGui.QWindow] = ...,
    ) -> None: ...
    def metric(self, metric: QtGui.QPaintDevice.PaintDeviceMetric) -> int: ...
...
class QOpenGLFunctions_2_0(QAbstractOpenGLFunctions):
    ...
    ) -> typing.Optional[typing.Union[float, tuple[float, float, float, float]]]: ...
    def glGetColorTableParameteriv(
        self, target: int, pname: int
    ) -> typing.Optional[typing.Union[int, tuple[int, int, int, int]]]: ...
    def glColorSubTable(
        self,
        target: int,
        start: int,
    ...
    def glColorPointer(
        self, size: int, type: int, stride: int, pointer: PYQT_OPENGL_BOUND_ARRAY
    ) -> None: ...
    ...
    def glDrawPixels(
        self, width: int, height: int, format: int, type: int, pixels: PYQT_OPENGL_ARRAY
    ) -> None: ...
    def glGetClipPlane(
        self, plane: int
    ...
    def glGetLightiv(
        ...
        typing.Union[int, tuple[int, int, int], tuple[int, int, int, int]]
    ]: ...
    def glGetMaterialfv(
    ...
    def glBindAttribLocation(
        self, program: int, index: int, name: typing.Optional[str]
    ) -> None: ...
    ...
    ) -> typing.Optional[typing.Union[int, tuple[int, int, int]]]: ...
    ...
    def glUniformMatrix2fv(
        self, location: int, count: int, transpose: int, value: PYQT_OPENGL_ARRAY
    ) -> None: ...
    ...
    def glGenQueries(
        self, n: int
    ) -> typing.Optional[typing.Union[int, tuple[int, ...]]]: ...
    ...
    ) -> typing.Union[tuple[float, ...], tuple[int, ...]]: ...
    def glGetBooleanv(
        self, pname: int
    ) -> typing.Optional[typing.Union[bool, tuple[bool, ...]]]: ...
    def glGetDoublev(
        self, pname: int
    ) -> typing.Optional[typing.Union[float, tuple[float, ...]]]: ...
