...
class QCompressedHelpInfo(PyQt6.sip.simplewrapper):
    ...
    def fromCompressedHelpFile(
        documentationFileName: typing.Optional[str],
    ) -> "QCompressedHelpInfo": ...
...
class QHelpContentModel(QtCore.QAbstractItemModel):
    ...
    ) -> typing.Optional[QHelpContentItem]: ...
...
class QHelpEngineCore(QtCore.QObject):
    def __init__(
        self,
        collectionFile: typing.Optional[str],
    ...
    def documentsForKeyword(
        self, keyword: typing.Optional[str]
    ) -> list["QHelpLink"]: ...
    @typing.overload
    def documentsForKeyword(
        self, keyword: typing.Optional[str], filterName: typing.Optional[str]
    ) -> list["QHelpLink"]: ...
    @typing.overload
    def documentsForIdentifier(self, id: typing.Optional[str]) -> list["QHelpLink"]: ...
    @typing.overload
    def documentsForIdentifier(
        self, id: typing.Optional[str], filterName: typing.Optional[str]
    ) -> list["QHelpLink"]: ...
    def usesFilterEngine(self) -> bool: ...
    def setUsesFilterEngine(self, uses: bool) -> None: ...
    def files(
        self,
        namespaceName: typing.Optional[str],
        filterName: typing.Optional[str],
        extensionFilter: typing.Optional[str] = ...,
    ) -> list[QtCore.QUrl]: ...
    ...
    @staticmethod
    def metaData(
        documentationFileName: typing.Optional[str], name: typing.Optional[str]
    ) -> typing.Any: ...
    def setCustomValue(self, key: typing.Optional[str], value: typing.Any) -> bool: ...
    def customValue(
        self, key: typing.Optional[str], defaultValue: typing.Any = ...
    ) -> typing.Any: ...
    ...
    def registerDocumentation(
        self, documentationFileName: typing.Optional[str]
    ) -> bool: ...
    @staticmethod
...
class QHelpFilterData(PyQt6.sip.simplewrapper):
    ...
    def setComponents(
        self, components: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
...
class QHelpFilterEngine(QtCore.QObject):
    ...
    def setFilterData(
        self, filterName: typing.Optional[str], filterData: QHelpFilterData
    ) -> bool: ...
...
class QHelpFilterSettingsWidget(QtWidgets.QWidget):
    ...
    def applySettings(
        self, filterEngine: typing.Optional[QHelpFilterEngine]
    ) -> bool: ...
    def readSettings(
        self, filterEngine: typing.Optional[QHelpFilterEngine]
    ) -> None: ...
...
class QHelpIndexModel(QtCore.QStringListModel):
    ...
    def filter(
        self, filter: typing.Optional[str], wildcard: typing.Optional[str] = ...
    ) -> QtCore.QModelIndex: ...
...
class QHelpSearchQuery(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        ...
        wordList: collections.abc.Iterable[typing.Optional[str]],
    ) -> None: ...
    @typing.overload
...
class QHelpSearchEngine(QtCore.QObject):
    def __init__(
        self,
        helpEngine: typing.Optional[QHelpEngineCore],
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> None: ...
