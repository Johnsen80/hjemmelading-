...
class QSvgGenerator(QtGui.QPaintDevice):
    ...
    def setOutputDevice(
        self, outputDevice: typing.Optional[QtCore.QIODevice]
    ) -> None: ...
...
class QSvgRenderer(QtCore.QObject):
    ...
    def __init__(
        self,
        contents: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        contents: typing.Optional[QtCore.QXmlStreamReader],
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> None: ...
    @staticmethod
    ...
    @typing.overload
    def render(
        self, p: typing.Optional[QtGui.QPainter], bounds: QtCore.QRectF
    ) -> None: ...
    @typing.overload
    def render(
        self,
        painter: typing.Optional[QtGui.QPainter],
        elementId: typing.Optional[str],
    ...
    @typing.overload
    def load(
        self, contents: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> bool: ...
    @typing.overload
