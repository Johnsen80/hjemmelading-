...
class QNdefMessage(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromByteArray(
        message: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
    ) -> "QNdefMessage": ...
...
class QNdefRecord(PyQt6.sip.simplewrapper):
    ...
    def setId(
        self, id: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
    ) -> None: ...
...
class QNearFieldTarget(QtCore.QObject):
    ...
    def sendCommand(
        self, command: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]
