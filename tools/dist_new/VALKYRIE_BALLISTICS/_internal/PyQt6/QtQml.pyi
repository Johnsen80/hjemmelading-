...
class QJSEngine(QtCore.QObject):
    ...
    def registerModule(
        self,
        moduleName: typing.Optional[str],
        value: typing.Union[
            "QJSValue", "QJSValue.SpecialValue", bool, int, float, typing.Optional[str]
        ],
    ) -> bool: ...
    ...
    @staticmethod
    def objectOwnership(
        a0: typing.Optional[QtCore.QObject],
    ) -> "QJSEngine.ObjectOwnership": ...
    @staticmethod
    def setObjectOwnership(
        a0: typing.Optional[QtCore.QObject], a1: "QJSEngine.ObjectOwnership"
    ) -> None: ...
    ...
    @typing.overload
    def throwError(
        self, errorType: "QJSValue.ErrorType", message: typing.Optional[str] = ...
    ) -> None: ...
    def newErrorObject(
        self, errorType: "QJSValue.ErrorType", message: typing.Optional[str] = ...
    ) -> "QJSValue": ...
    ...
    def newQMetaObject(
        self, metaObject: typing.Optional[QtCore.QMetaObject]
    ) -> "QJSValue": ...
...
class QJSManagedValue(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        ...
        engine: typing.Optional[QJSEngine],
    ) -> None: ...
    @typing.overload
    def __init__(
        self, value: "QJSPrimitiveValue", engine: typing.Optional[QJSEngine]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, string: typing.Optional[str], engine: typing.Optional[QJSEngine]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, variant: typing.Any, engine: typing.Optional[QJSEngine]
    ) -> None: ...
...
class QQmlEngine(QJSEngine):
    ...
    def removeUrlInterceptor(
        self, urlInterceptor: typing.Optional[QQmlAbstractUrlInterceptor]
    ) -> None: ...
    ...
    def singletonInstance(
        ...
        typeName: typing.Union[
            typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
            typing.Optional[str],
        ],
    ) -> QtCore.QObject: ...
    def offlineStorageDatabaseFilePath(
        self, databaseName: typing.Optional[str]
    ) -> str: ...
    ...
    def setContextForObject(
        a0: typing.Optional[QtCore.QObject], a1: typing.Optional["QQmlContext"]
    ) -> None: ...
    @staticmethod
    def contextForObject(
        a0: typing.Optional[QtCore.QObject],
    ) -> typing.Optional["QQmlContext"]: ...
    ...
    def setIncubationController(
        self, a0: typing.Optional["QQmlIncubationController"]
    ) -> None: ...
    def removeImageProvider(self, id: typing.Optional[str]) -> None: ...
    def imageProvider(
        self, id: typing.Optional[str]
    ) -> typing.Optional["QQmlImageProviderBase"]: ...
    def addImageProvider(
        self, id: typing.Optional[str], a1: typing.Optional["QQmlImageProviderBase"]
    ) -> None: ...
    def networkAccessManager(
        self,
    ) -> typing.Optional[QtNetwork.QNetworkAccessManager]: ...
    def networkAccessManagerFactory(
        self,
    ) -> typing.Optional["QQmlNetworkAccessManagerFactory"]: ...
    def setNetworkAccessManagerFactory(
        self, a0: typing.Optional["QQmlNetworkAccessManagerFactory"]
    ) -> None: ...
    def importPlugin(
        self,
        filePath: typing.Optional[str],
        uri: typing.Optional[str],
        errors: typing.Optional[collections.abc.Iterable["QQmlError"]],
    ) -> bool: ...
...
class QQmlApplicationEngine(QQmlEngine):
    ...
    @typing.overload
    def __init__(
        self, url: QtCore.QUrl, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def setInitialProperties(
        self, initialProperties: dict[typing.Optional[str], typing.Any]
    ) -> None: ...
    def setExtraFileSelectors(
        self, extraFileSelectors: collections.abc.Iterable[typing.Optional[str]]
    ) -> None: ...
    def loadData(
        self,
...
class QQmlComponent(QtCore.QObject):
    ...
    def setInitialProperties(
        self,
        component: typing.Optional[QtCore.QObject],
        properties: dict[typing.Optional[str], typing.Any],
    ) -> None: ...
    ...
    def setData(
        self,
        a0: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview],
        baseUrl: QtCore.QUrl,
    ) -> None: ...
    @typing.overload
    ...
    def beginCreate(
        self, a0: typing.Optional["QQmlContext"]
    ) -> typing.Optional[QtCore.QObject]: ...
    def createWithInitialProperties(
        self,
        initialProperties: dict[typing.Optional[str], typing.Any],
        context: typing.Optional["QQmlContext"] = ...,
    ) -> typing.Optional[QtCore.QObject]: ...
    @typing.overload
    def create(
        self, context: typing.Optional["QQmlContext"] = ...
    ) -> typing.Optional[QtCore.QObject]: ...
    @typing.overload
    def create(
        self,
...
class QQmlContext(QtCore.QObject):
    ...
    def __init__(
        self,
        parentContext: typing.Optional["QQmlContext"],
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> None: ...
    def objectForName(
        self, a0: typing.Optional[str]
    ) -> typing.Optional[QtCore.QObject]: ...
    ...
    def setContextProperty(
        self, a0: typing.Optional[str], a1: typing.Optional[QtCore.QObject]
    ) -> None: ...
    @typing.overload
...
class QQmlExpression(QtCore.QObject):
    ...
    def __init__(
        self,
        a0: typing.Optional[QQmlContext],
        a1: typing.Optional[QtCore.QObject],
        a2: typing.Optional[str],
        parent: typing.Optional[QtCore.QObject] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    def setSourceLocation(
        self, fileName: typing.Optional[str], line: int, column: int = ...
    ) -> None: ...
...
class QQmlEngineExtensionPlugin(QtCore.QObject):
    ...
    def initializeEngine(
        self, engine: typing.Optional[QQmlEngine], uri: typing.Optional[str]
    ) -> None: ...
...
class QQmlProperty(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, a0: typing.Optional[QtCore.QObject], a1: typing.Optional[QQmlContext]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, a0: typing.Optional[QtCore.QObject], a1: typing.Optional[QQmlEngine]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, a0: typing.Optional[QtCore.QObject], a1: typing.Optional[str]
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        a0: typing.Optional[QtCore.QObject],
        a1: typing.Optional[str],
        a2: typing.Optional[QQmlContext],
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def connectNotifySignal(
        self, dest: typing.Optional[QtCore.QObject], method: int
    ) -> bool: ...
    ...
    @staticmethod
    def write(
        a0: typing.Optional[QtCore.QObject], a1: typing.Optional[str], a2: typing.Any
    ) -> bool: ...
    @typing.overload
    @staticmethod
    def write(
        ...
        a1: typing.Optional[str],
        a2: typing.Any,
        a3: typing.Optional[QQmlContext],
    ) -> bool: ...
    @typing.overload
    @staticmethod
    def write(
    ...
    @staticmethod
    def read(
        a0: typing.Optional[QtCore.QObject], a1: typing.Optional[str]
    ) -> typing.Any: ...
    @typing.overload
    @staticmethod
    def read(
...
class QQmlPropertyMap(QtCore.QObject):
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    def updateValue(
        self, key: typing.Optional[str], input: typing.Any
    ) -> typing.Any: ...
    valueChanged: typing.ClassVar[QtCore.pyqtSignal]
...
def qmlRegisterAnonymousType(
    a0: type, uri: typing.Optional[str], major: int
) -> int: ...
def qmlRegisterSingletonInstance(
    ...
    cppObject: typing.Optional[QtCore.QObject],
) -> int: ...
...
def qmlAttachedPropertiesObject(
    a0: type, object: typing.Optional[QtCore.QObject], create: bool = ...
) -> typing.Optional[QtCore.QObject]: ...
...
def qmlRegisterModule(
    uri: typing.Optional[str], versionMajor: int, versionMinor: int
) -> None: ...
