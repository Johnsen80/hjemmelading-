...
class QGeoAreaMonitorInfo(PyQt6.sip.wrapper):
    ...
    def setNotificationParameters(
        self, parameters: dict[typing.Optional[str], typing.Any]
    ) -> None: ...
...
class QGeoAreaMonitorSource(QtCore.QObject):
    class AreaMonitorFeature(enum.Flag):
        PersistentAreaMonitorFeature = (
            ...
        )  # type: QGeoAreaMonitorSource.AreaMonitorFeature
    ...
    def setBackendProperty(
        self, name: typing.Optional[str], value: typing.Any
    ) -> bool: ...
    ...
    def requestUpdate(
        self, monitor: QGeoAreaMonitorInfo, signal: typing.Optional[str]
    ) -> bool: ...
    ...
    def setPositionInfoSource(
        self, source: typing.Optional["QGeoPositionInfoSource"]
    ) -> None: ...
    @staticmethod
    def availableSources() -> list[str]: ...
    @staticmethod
    def createSource(
        sourceName: typing.Optional[str], parent: typing.Optional[QtCore.QObject]
    ) -> typing.Optional["QGeoAreaMonitorSource"]: ...
    @staticmethod
...
class QGeoCoordinate(PyQt6.sip.wrapper):
    class CoordinateFormat(enum.Enum):
        ...
        DegreesMinutesSecondsWithHemisphere = (
            ...
        )  # type: QGeoCoordinate.CoordinateFormat
...
class QGeoLocation(PyQt6.sip.wrapper):
    ...
    def setExtendedAttributes(
        self, data: dict[typing.Optional[str], typing.Any]
    ) -> None: ...
...
class QGeoPath(QGeoShape):
    ...
    @typing.overload
    def __init__(
        self, path: collections.abc.Iterable[QGeoCoordinate], width: float = ...
    ) -> None: ...
    @typing.overload
...
class QGeoPositionInfoSource(QtCore.QObject):
    class PositioningMethod(enum.Flag):
        ...
        SatellitePositioningMethods = (
            ...
        )  # type: QGeoPositionInfoSource.PositioningMethod
    ...
    def createSource(
        sourceName: typing.Optional[str], parent: typing.Optional[QtCore.QObject]
    ) -> typing.Optional["QGeoPositionInfoSource"]: ...
    @typing.overload
    @staticmethod
    def createSource(
        sourceName: typing.Optional[str],
        parameters: dict[typing.Optional[str], typing.Any],
        parent: typing.Optional[QtCore.QObject],
    ) -> typing.Optional["QGeoPositionInfoSource"]: ...
    @typing.overload
    @staticmethod
...
class QGeoSatelliteInfoSource(QtCore.QObject):
    ...
    def createSource(
        sourceName: typing.Optional[str], parent: typing.Optional[QtCore.QObject]
    ) -> typing.Optional["QGeoSatelliteInfoSource"]: ...
    @typing.overload
    @staticmethod
    def createSource(
        sourceName: typing.Optional[str],
...
class QNmeaPositionInfoSource(QGeoPositionInfoSource):
    ...
    def parsePosInfoFromNmeaData(
        ...
        size: int,
        posInfo: typing.Optional[QGeoPositionInfo],
