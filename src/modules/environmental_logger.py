...
class EnvironmentalLogger(QWidget):
    ...
    def init_ui(self):
        ...
        tabs.addTab(self.create_comparison_tab(), tr('comparison_tab', self.current_language))
        
        # Tab 4: Quick DA Calculator
        tabs.addTab(self.create_da_calculator_tab(), tr('da_calculator_tab', self.current_language))
    ...
    def create_input_tab(self):
        ...
        da_info = QLabel("Kan beregnes automatisk eller legges inn manuelt hvis du har Kestrel.")
        ...
        save_btn.setStyleSheet("font-size: 14pt; font-weight: bold; background-color: #4CAF50; color: white;")
    ...
    def create_history_tab(self):
        ...
        self.history_table.setHorizontalHeaderLabels([
            "ID", "Dato/Tid", "Lokasjon", "Temp (°C)", "Trykk (hPa)", 
            "Fuktighet (%)", "Vind (m/s)", "Retning (°)", "DA (ft)", 
            "Instrumenter", "Notater"
        ])
    ...
    def calculate_density_altitude(self, temp_c, pressure_hpa, elevation_m):
        ...
        # Pressure altitude
        pressure_alt_ft = (1 - (pressure_hpa / standard_pressure) ** 0.190284) * 145366.45
...
""".format(da_ft, (da_ft / 1000) * 10)  # Rough estimate: 10cm per 1000ft DA at 600m
    ...
    def save_measurement(self):
        ...
        instruments_str = " | ".join(instruments) if instruments else "Ingen spesifisert"
    ...
    def load_measurements_for_comparison(self):
        ...
        try:
            ...
            logger.debug("Failed to load measurements for comparison: %s", e, exc_info=True)
            try:
    ...
    def run_comparison(self):
        ...
        try:
            ...
            manual = manual[0]
            dt, location, lat, lon, temp, press, humid, wind_speed, wind_dir, da = manual
