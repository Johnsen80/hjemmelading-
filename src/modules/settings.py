...
class SettingsWidget(QWidget):
    ...
    def save_settings(self):
        ...
        self.settings.setValue("defaults/test_distance", self.default_test_distance.value())
        self.settings.setValue("defaults/ladder_step", self.default_ladder_step.value())
        
        # Sikkerhet
        self.settings.setValue("safety/warn_high_charge", self.warn_high_charge.isChecked())
        ...
        # Lageradvarsler
        self.settings.setValue("inventory/low_powder", self.low_powder_threshold.value())
        self.settings.setValue("inventory/low_bullet", self.low_bullet_threshold.value())
        self.settings.setValue("inventory/low_primer", self.low_primer_threshold.value())
    ...
    def restore_backup(self):
        ...
        if file_path:
            try:
                ...
                QMessageBox.critical(
                    self, "Feil",
                    f"Kunne ikke gjenopprette backup:\n{str(e)}"
                )
