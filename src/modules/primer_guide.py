...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel,
                            ...
                            QDialog, QComboBox, QTextEdit, QGroupBox,
...
class PrimerSelectionGuide(QWidget):
    ...
    def init_ui(self):
        ...
        self.recommendation.setHtml("<i>Select options above to get primer recommendation...</i>")
    ...
    def load_primers(self):
        ...
        try:
            ...
            for primer in primers:
                ...
                self.primers_table.setItem(row, 0, QTableWidgetItem(primer['manufacturer']))
