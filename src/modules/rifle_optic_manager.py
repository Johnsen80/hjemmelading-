...
class RifleOpticManager(QWidget):
    ...
    def create_rifles_section(self):
        ...
        self.rifles_table.setSelectionBehavior(QTableWidget.SelectionBehavior.SelectRows)
    ...
    def create_optics_section(self):
        ...
        self.optics_table.setSelectionBehavior(QTableWidget.SelectionBehavior.SelectRows)
...
class RifleDialog(QDialog):
    ...
    def init_ui(self):
        ...
        ai_info = QLabel("🤖 AI kan hente spesifikasjoner (du kan redigere alt etterpå):")
        ...
        self.action_type.addItems(["Bolt Action", "Semi-Auto", "Lever Action", "Single Shot", "Annet"])
    ...
    def run_ai_lookup(self):
        ...
        if not rifle_name:
            QMessageBox.warning(self, "Mangler navn", 
        ...
        try:
            ...
            QMessageBox.information(self, "AI Lookup ferdig",
            ...
            QMessageBox.warning(self, "AI Lookup feilet",
