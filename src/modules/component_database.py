...
class ComponentDatabaseManager(QWidget):
    ...
    def create_bullets_tab(self) -> QWidget:
        ...
        self.bullet_caliber_filter.addItems(["All", ".224", "6mm", "6.5mm", ".308", ".338"])
        ...
        self.bullets_table.setHorizontalHeaderLabels([
            "Manufacturer", "Name", "Caliber", "Weight (gr)", 
            "BC G1", "BC G7", "Length (in)", "Diameter (in)", "Type"
        ])
    ...
    def create_powders_tab(self) -> QWidget:
        ...
        self.powders_table.setHorizontalHeaderLabels([
            "Manufacturer", "Name", "Burn Rate", "Density (g/cc)", 
            "Best For", "Temp Stable?", "Notes"
        ])
        self.powders_table.horizontalHeader().setStretchLastSection(True)
    ...
    def create_brass_tab(self) -> QWidget:
        ...
        self.brass_table.setHorizontalHeaderLabels([
            "Manufacturer", "Caliber", "Case Capacity (gr H2O)", 
            "Weight (gr)", "Wall Thickness", "Quality Rating", "Notes"
        ])
        self.brass_table.horizontalHeader().setStretchLastSection(True)
    ...
    def add_component(self):
        ...
        if current_tab == 0:  # Bullets
            ...
            if dialog.exec() == QDialog.DialogCode.Accepted:
                ...
                QMessageBox.information(self, "Success", f"Added {bullet_data['name']} to database!")
            ...
            if dialog.exec() == QDialog.DialogCode.Accepted:
                ...
                QMessageBox.information(self, "Success", f"Added {powder_data['name']} to database!")
        
        elif current_tab == 2:  # Primers
            QMessageBox.information(self, "Add Primer", "Primer add dialog coming soon!")
    ...
    def import_from_file(self):
        ...
        if file_path:
            QMessageBox.information(self, "Import", f"Import from {file_path}\n\nComing soon!")
    ...
    def export_database(self):
        ...
        if file_path:
            QMessageBox.information(self, "Export", f"Export to {file_path}\n\nComing soon!")
...
class AddBulletDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.bullet_type.addItems([
            "BTHP", "VLD", "Hybrid", "ELD", "A-Tip", "RDF", 
            "FMJ", "Soft Point", "Ballistic Tip", "Other"
        ])
        ...
        helper.setStyleSheet("background-color: #fff9c4; padding: 10px; border-radius: 5px; margin-top: 10px;")
...
class AddPowderDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.burn_rate.addItems(["Very Fast", "Fast", "Medium-Fast", "Medium", 
