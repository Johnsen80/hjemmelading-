...
class InventoryManager(QWidget):
    ...
    def create_powder_tab(self):
        ...
        self.powder_table.setSelectionBehavior(QTableWidget.SelectionBehavior.SelectRows)
    ...
    def create_bullets_tab(self):
        ...
        self.bullets_table.setSelectionBehavior(QTableWidget.SelectionBehavior.SelectRows)
    ...
    def create_primers_tab(self):
        ...
        self.primers_table.setSelectionBehavior(QTableWidget.SelectionBehavior.SelectRows)
    ...
    def load_powder(self):
        ...
        for i, powder in enumerate(powders):
            ...
            # Status med farge
            status_item = QTableWidgetItem(self.get_powder_status(powder['quantity_grams']))
    ...
    def load_bullets(self):
        ...
        for i, bullet in enumerate(bullets):
            ...
            self.bullets_table.setItem(i, 3, QTableWidgetItem(f"{bullet['weight_grains']}"))
            ...
            self.bullets_table.item(i, 0).setData(Qt.ItemDataRole.UserRole, bullet['id'])
    ...
    def load_primers(self):
        ...
        for i, primer in enumerate(primers):
            ...
            self.primers_table.item(i, 0).setData(Qt.ItemDataRole.UserRole, primer['id'])
...
class PrimerDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.type_combo = QComboBox()
        self.type_combo.addItems(["Small Rifle", "Large Rifle", "Small Pistol", 
                                  "Large Pistol", "Magnum Rifle", "Magnum Pistol"])
        layout.addRow("Type:", self.type_combo)
