...
class AddLotDialog(QDialog):
    ...
    def __init__(self, component_type: str, component_id: int, component_name: str, parent=None):
...
class ComponentLotTracker(QWidget):
    ...
    def init_ui(self):
        ...
        self.tabs.addTab(self.create_component_tab('primers', 'Tennhetter'), "💥 Tennhetter")
    ...
    def create_component_tab(self, table_name: str, display_name: str) -> QWidget:
        ...
        table.setHorizontalHeaderLabels([
            'Lot #', 'Mengde', 'Kjøpsdato', 'Status', 'Performance', 'Notater', 'Handling'
        ])
    ...
    def load_lots(self, table: QTableWidget, table_name: str, component_id: int):
        ...
        for i, lot in enumerate(lots):
            ...
            btn_deactivate.clicked.connect(lambda _, lid=lot['id']: self.deactivate_lot(lid, table_name, component_id))
    ...
    def add_lot(self, table_name: str):
        ...
        if not component_id:
            QMessageBox.warning(self, "Ingen komponent valgt", f"Velg en {table_name} først!")
            return
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            QMessageBox.information(self, "Lot lagt til", f"Lot {data['lot_number']} lagt til!")
    ...
    def update_comparison(self, table_name: str, component_id: int):
        ...
        for lot in lots:
            rating = lot['performance_rating'] if lot['performance_rating'] else 'Ikke testet'
