...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel,
                            ...
                            QDoubleSpinBox, QTextEdit, QMessageBox, QSpinBox,
                            QProgressBar, QTabWidget, QWizard, QWizardPage,
...
class LoadDevelopmentWorkflow(QWidget):
    ...
    def create_active_workflows_tab(self):
        ...
        self.active_table.setHorizontalHeaderLabels([
            "Name", "Rifle", "Caliber", "Stage", "Test Date", "Progress", "Next Action", "Status"
        ])
    ...
    def create_completed_workflows_tab(self):
        ...
        self.completed_table.setHorizontalHeaderLabels([
            "Name", "Rifle", "Final Load", "ES/SD", "Group Size", "Date Completed", "Notes"
        ])
    ...
    def create_workflow(self, workflow_data: Dict):
        ...
        workflow_id = self.db.insert("load_development_workflows", {
    ...
    def load_active_workflows(self):
        ...
        try:
            ...
            QMessageBox.critical(self, "Databasefeil", f"Tabellen 'load_development_workflows' mangler eller kan ikke leses.\n\nFeil: {str(e)}")
        ...
        if not workflows:
            QMessageBox.information(self, "Ingen aktive workflows", "Ingen aktive ladningsprosjekter funnet. Trykk 'Start New Load Development' for å opprette en ny.")
            return
        
        for i, workflow in enumerate(workflows):
            wf_id, name, rifle_id, caliber, stage, test_date, status, next_action, progress = workflow
            ...
            self.active_table.setItem(i, 6, QTableWidgetItem(next_action or "Create Batch"))
    ...
    def finalize_load(self):
        ...
        reply = QMessageBox.question(
            self, 'Finalize Load Development',
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            self.db.update("load_development_workflows", 
...
class LoadDevelopmentWizard(QWizard):
    ...
    def create_intro_page(self):
        ...
        page.setSubTitle("This wizard will guide you through creating a systematic load development workflow.")
    ...
    def create_protocol_page(self):
        ...
        protocols = [
            ("bayesian", "Bayesian Optimization Protocol", "Best for: Minimize test rounds, maximize info (5-7 rounds)"),
            ("ocw", "OCW (Optimal Charge Weight)", "Best for: Finding pressure nodes, 15 rounds"),
            ("ladder", "Ladder Test", "Best for: Wide charge exploration, 10-15 rounds"),
            ("satterlee", "Satterlee Method", "Best for: Quick velocity nodes, 10 rounds"),
            ("seating", "Seating Depth Test", "Best for: Refining accuracy, 12-30 rounds"),
            ("combined", "Combined (OCW + Seating)", "Best for: Complete development, 30+ rounds")
        ]
...
class LoadOptimizationDialog(QDialog):
    ...
    def init_ui(self):
        ...
        subtitle = QLabel("Based on published research from Bryan Litz, Hornady, Sierra, Berger, and military studies")
