...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel,
                            ...
                            QTextEdit, QMessageBox, QTabWidget, QFrame,
                            QScrollArea)
...
class PrimerComparisonDialog(QDialog):
    ...
    def init_ui(self):
        ...
        table.setHorizontalHeaderLabels([
            "Primer", "Size", "Type", "Brisance", "Cup Thickness",
            "SD Impact", "Best For", "Price/100"
        ])
        
        primers_data = [
            ("CCI BR-2", "Large Rifle", "Benchrest", "Medium", "Thick", "Baseline (8-12 fps)", "Match", "80 kr"),
            ("CCI 450", "Small Rifle", "Magnum", "High", "Very Thick", "+5-10% vel", "AR-15, Magnums", "75 kr"),
            ("Federal 210M", "Large Rifle", "Match", "Soft", "Thin", "-5 to -10% SD", "Match, Precision", "90 kr"),
            ("Federal 215M", "Large Rifle", "Match Magnum", "Hot", "Thin", "+10-15 fps", "Magnums, Cold", "95 kr"),
            ("Federal 205M", "Small Rifle", "Match", "Soft", "Thin", "-5% SD", "AR-15 Match", "85 kr"),
            ("Remington 7½", "Small Rifle", "Benchrest", "Medium", "Medium", "Baseline", ".223 Match", "70 kr"),
            ("Remington 9½", "Large Rifle", "Standard", "Medium", "Medium", "Baseline", "General", "65 kr"),
            ("Remington 9½M", "Large Rifle", "Magnum", "Hot", "Thick", "+10 fps", "Magnums", "70 kr"),
            ("Winchester WLR", "Large Rifle", "Standard", "Medium", "Thin", "+10-15% SD", "Practice", "55 kr"),
            ("Winchester WSR", "Small Rifle", "Standard", "Medium", "Thin", "+10% SD", "Practice", "50 kr"),
            ("RWS 5341", "Large Rifle", "Match", "Medium", "Thick", "-5% SD", "Match (€)", "120 kr"),
            ("Murom KVB-7", "Large Rifle", "Standard", "Hot", "Very Thick", "Variable", "Surplus", "40 kr"),
        ]
        ...
        """)
        legend.setStyleSheet("background-color: #ecf0f1; padding: 10px; border-radius: 5px;")
...
class SubstitutionFinderDialog(QDialog):
    ...
    def init_ui(self):
        ...
        info.setStyleSheet("background-color: #fff9c4; padding: 10px; border-radius: 5px;")
        layout.addWidget(info)
    ...
    def find_substitutes(self):
        ...
        substitutions = {
            "CCI BR-2": [
                ("Federal 210M", "95%", "May IMPROVE SD by 5-10%. Softer cup - seat carefully.", "✅ No load adjustment needed"),
                ("Remington 9½", "90%", "Similar performance. Slightly less consistent.", "⚠️ Test in your rifle first"),
                ("Winchester WLR", "80%", "Budget option. Expect +10-15% SD increase.", "⚠️ Not match-grade")
            ],
            "Federal 210M": [
                ("CCI BR-2", "95%", "Thicker cup, may increase SD slightly but more consistent.", "✅ Direct substitute"),
                ("Remington 9½", "85%", "Less precise, but works.", "⚠️ Re-test load"),
                ("RWS 5341", "98%", "European match primer. Excellent if available.", "✅ Premium option")
            ],
            "CCI 450": [
                ("Federal 205M", "90%", "Match-grade, softer cup. May improve SD.", "⚠️ Test for slam-fire in AR-15"),
                ("Remington 7½", "85%", "Benchrest primer, thinner cup.", "⚠️ Careful in semi-auto"),
                ("CCI 400", "80%", "Standard version. More variance.", "⚠️ Not match-grade")
            ]
        }
        ...
        for i, (sub, compatibility, notes, adjustment) in enumerate(substitutions[primer], 1):
...
class PressureSignsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        info.setStyleSheet("background-color: #ffe0b2; padding: 10px; border-radius: 5px;")
        layout.addWidget(info)
