...
class AmmoProfileManager(QWidget):
    ...
    def init_ui(self):
        ...
        self.table.setHorizontalHeaderLabels([
            "Navn", "Rifle", "Kaliber", "Kule (gr)", "Krutt", "Ladning (gr)", 
            "Hastighet (fps)", "BC"
        ])
    ...
    def add_profile(self):
        ...
        dialog = AmmoProfileDialog(self, rifles=rifles, powders=powders, 
    ...
    def edit_profile(self):
        ...
        dialog = AmmoProfileDialog(self, profile, rifles, powders, bullets, primers, cases)
        if dialog.exec() == QDialog.DialogCode.Accepted:
            data = dialog.get_data()
...
class AmmoProfileDialog(QDialog):
    ...
    def __init__(self, parent=None, profile=None, rifles=None, powders=None, 
                 bullets=None, primers=None, cases=None):
    ...
    def get_data(self):
        ...
        return {
            ...
            'velocity_fps': self.velocity.value() if self.velocity.value() > 0 else None,
