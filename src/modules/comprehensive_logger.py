...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel, 
                            ...
                            QTabWidget, QCheckBox, QFormLayout, QScrollArea,
...
class ComprehensiveDataLogger(QWidget):
    ...
    def __init__(self, load_id: str = None, load_name: str = None):
        super().__init__()
    ...
    def init_ui(self):
        ...
        title = QLabel(f"📊 Comprehensive Data Log")
    ...
    def create_shot_data_tab(self) -> QWidget:
        ...
        """)
        info.setStyleSheet("background-color: #ecf0f1; padding: 10px; border-radius: 5px;")
...
if __name__ == "__main__":
    ...
    logger = ComprehensiveDataLogger(
        load_id="LD_20241123_001",
        load_name="6.5 Creedmoor - Berger 140gr Hybrid Test"
    )
