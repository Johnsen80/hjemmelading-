...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel, 
                             QSlider, QGroupBox, QPushButton, QComboBox, QSpinBox,
...
class BallisticsSimulator(QWidget):
    ...
    def create_combined_tab(self):
        ...
        self.comparison_plot.setTitle('Pressure vs Charge Weight', color='k', size='12pt')
        ...
        self.velocity_comparison_plot.setLabel('bottom', 'Charge Weight', units='grains')
        self.velocity_comparison_plot.setTitle('Velocity vs Charge Weight', color='k', size='12pt')
    ...
    def create_harmonics_tab(self):
        ...
        self.harmonics_plot.setTitle('Barrel Harmonics & Bullet Exit Timing', color='k', size='12pt')
        
        info = QLabel("🎵 Barrel harmonics visualization\n\n"
    ...
    def load_powders(self):
        ...
        for powder in powders:
            self.powder_combo.addItem(
                f"{powder['manufacturer']} {powder['name']}", 
                powder
            )
    ...
    def update_simulation(self):
        ...
        result = self.engine.calculate_load(
            rifle['id'], bullet['id'], powder['id'],
            self.current_charge, self.coal_mm, self.cbto_mm
        )
    ...
    def update_pressure_graph(self, result):
        ...
        self.pressure_plot.plot(
            [times[peak_idx]], [pressures[peak_idx]],
    ...
    def update_combined_graphs(self, rifle, bullet, powder):
        ...
        for charge in charges:
            result = self.engine.calculate_load(
                rifle['id'], bullet['id'], powder['id'],
                charge, self.coal_mm, self.cbto_mm
            )
        ...
        self.comparison_plot.plot(
            [charges[current_idx]], [pressures[current_idx]],
        ...
        # Mark current charge
        self.velocity_comparison_plot.plot(
            [charges[current_idx]], [velocities[current_idx]],
            pen=None, symbol='o', symbolSize=15,
            symbolBrush='#f39c12',
            name=f'Current: {self.current_charge:.1f} gr'
        )
