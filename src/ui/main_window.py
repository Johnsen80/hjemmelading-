from PyQt6.QtWidgets import (
    QMainWindow, QLabel, QVBoxLayout, QWidget, QDialog,
    QListWidget, QPushButton, QStatusBar, QHBoxLayout, QStackedWidget,
...
class MainWindow(QMainWindow):
    ...
    def resume_workflow(self):
        # Placeholder for workflow resume
        pass
    ...
    def _open_workflow_debug(self):
        ...
        wf_keys = [
            'load_development_workflow','ocw_test','ladder_test','seating_depth',
            'smart_wizard','temperature_test','saami_compliance','chronograph_import',
            'cold_bore','batch_qc','lot_tracker','drop_chart','wind_drift','zero_shift'
        ]
        for k in wf_keys:
            listw.addItem(k)
    ...
    def apply_global_button_style(self):
        ...
        self.label_current_workflow.setStyleSheet("color: white; font-size: 14px; font-weight: bold;")
    ...
    def apply_user_settings(self):
        ...
        try:
            ...
            try:
                from src.modules.mode_manager import UserModeManager, UserMode
            except Exception:
                try:
                    from HjemmeladingApp.utils.mode_manager import UserModeManager, UserMode
                except Exception:
            ...
            try:
                language = QSettings("ReloadingWorkshop", "ReloadingManager").value("language", "Norsk")
        ...
        try:
            ...
            fl = QVBoxLayout(); fl.addWidget(lbl); fallback.setLayout(fl)
    ...
    def create_dashboard_tab(self):
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Dashboard unavailable")); w.setLayout(l)
            return w
    ...
    def create_test_lab_tab(self):
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Test Lab unavailable")); w.setLayout(l)
            return w
    ...
    def create_ammo_tab(self):
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Ammunisjon unavailable")); w.setLayout(l)
            return w
    ...
    def create_inventory_tab(self):
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Inventory unavailable")); w.setLayout(l)
            return w
    ...
    def create_log_tab(self):
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Log unavailable")); w.setLayout(l)
            return w
    ...
    def create_analysis_tab(self):
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Target Analyzer unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Precision Tracker unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Safety Dashboard unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Terrain Map unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Environmental Logger unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Drop Chart Generator unavailable")); w.setLayout(l)
        ...
        try:
            ...
            logger.exception("RiflePerformanceTracker import failed: %s", e)
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Rifle Performance unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Chronograph Import unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("GRT Import unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("GRT Integration unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Temperature Ladder Test unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Component Lot Tracker unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Batch QC unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("SAAMI/CIP Checker unavailable")); w.setLayout(l)
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Ballistics Simulator unavailable")); w.setLayout(l)
    ...
    def create_settings_tab(self):
        ...
        try:
            ...
            w = QWidget(); l = QVBoxLayout(); l.addWidget(QLabel("Settings unavailable")); w.setLayout(l)
            return w
    
    def show_about(self):
        """Viser 'Om programmet' dialog"""
        QMessageBox.about(self, "Om Reloading Workshop Manager",
    ...
    def show_zero_shift_calculator(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "Unavailable", "Zero Shift Calculator unavailable (see debug_err.log in %LOCALAPPDATA%\\Hjemmelading\\logs)")
    ...
    def launch_workflow(self, workflow_id: str):
        ...
        if workflow_id not in workflow_map:
            self.statusBar.showMessage(f"Workflow '{workflow_id}' not implemented yet")
            return
        ...
        if tab_idx is not None:
            ...
            self.statusBar.showMessage(f"Active workflow: {workflow_name}")
            
            # Mark as active in hub
            self.workflow_hub.mark_workflow_active(workflow_id, workflow_name)
        else:
            self.statusBar.showMessage(f"'{workflow_name}' coming soon!")
    ...
    def resume_workflow(self, workflow_id: str):
        ...
        try:
            ...
            self.statusBar.showMessage(f"Resumed workflow: {state.workflow_name}")
            ...
            QMessageBox.warning(self, "Resume Failed", "Could not resume workflow (see debug_err.log in %LOCALAPPDATA%\\Hjemmelading\\logs)")
    ...
    def show_weapon_profile_editor(self):
        ...
        try:
            ...
            dlg = WeaponProfileEditor(data_path=Path("data/demo_weapons.json"), parent=self)
            dlg.exec()
        except Exception as e:
            logger.exception("WeaponProfileEditor failed to open: %s", e)
            QMessageBox.warning(self, "Unavailable", "Weapon Profile Editor unavailable (see debug_err.log in %LOCALAPPDATA%\\Hjemmelading\\logs)")
        
    
    def on_mode_changed(self, new_mode: str):
        """Handle user mode change"""
        mode_name = "🔰 Beginner" if new_mode == getattr(self, '_UserMode', type('UM',(),{'BEGINNER':0})).BEGINNER else "⚡ Expert"
    ...
    def show_load_wizard(self):
        ...
        def on_batches_created(batch_ids):
            ...
            self.statusBar.showMessage(f"✅ {len(batch_ids)} batches created successfully!")
    ...
    def show_brass_manager(self):
        ...
        if self.workflow_hub:
            try:
                self.workflow_hub.mark_workflow_active("brass_manager", "Brass/Hylse Manager")
            except Exception:
                pass
    ...
    def show_ballistics_simulator(self):
        ...
        dialog.setLayout(layout)
        dialog.show()
        self.statusBar.showMessage("🔬 Ballistics Simulator - Physics-based load prediction")
    ...
    def show_load_development_workflow(self):
        ...
        try:
            ...
            try:
                ...
                dialog.setLayout(layout)
                self.statusBar.showMessage("🎯 Load Development Workflow - Complete lifecycle management")
                result = dialog.exec()
                if result == 0:
                    QMessageBox.information(self, "Workflow ikke åpnet", "Workflow-dialogen ble ikke åpnet eller ble lukket umiddelbart.")
                    self.statusBar.showMessage("❌ Workflow-dialogen ble ikke åpnet.")
            except Exception as inner_e:
                error_msg = f"Failed to initialize LoadDevelopmentWorkflow:\n\n{str(inner_e)}"
                logger.exception("Failed to initialize LoadDevelopmentWorkflow: %s", inner_e)
    ...
    def show_saami_checker(self):
        ...
        try:
            ...
            logger.exception("SAAMIComplianceChecker import failed: %s", e)
            QMessageBox.warning(self, "Unavailable", "SAAMI/CIP Checker unavailable (see debug_err.log in %LOCALAPPDATA%\\Hjemmelading\\logs)")
    ...
    def show_grt_integration(self):
        ...
        try:
            ...
            logger.exception("GRTIntegration import failed: %s", e)
            QMessageBox.warning(self, "Unavailable", "GRT Integration unavailable (see debug_err.log in %LOCALAPPDATA%\\Hjemmelading\\logs)")
    ...
    def show_safety_dashboard(self):
        ...
        try:
            ...
            logger.exception("SafetyDashboard import failed: %s", e)
            QMessageBox.warning(self, "Unavailable", "Safety Dashboard unavailable (see debug_err.log in %LOCALAPPDATA%\\Hjemmelading\\logs)")
    ...
    def show_drop_chart(self):
        ...
        try:
            ...
            logger.exception("DropChartGenerator import failed: %s", e)
            QMessageBox.warning(self, "Unavailable", "Dope Card Generator unavailable (see debug_err.log in %LOCALAPPDATA%\\Hjemmelading\\logs)")
    
    def closeEvent(self, event):
        """Håndterer lukking av vinduet"""
        reply = QMessageBox.question(self, 'Bekreft avslutning',
