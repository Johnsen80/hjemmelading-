...
class PopulateThread(QThread):
    ...
    def run(self):
        try:
            ...
            self.progress.emit(f"Current: {bullets_before} bullets, {powder_before} powders, {primers_before} primers")
            ...
            self.progress.emit("\n🎯 Adding bullets...")
            bullets = [
                ("Lapua Scenar 139gr", "Lapua", "6.5mm", 139, 0.615, 0.290, "Match", "Very consistent"),
                ("Berger 140gr Hybrid", "Berger", "6.5mm", 140, 0.618, 0.287, "Match", "Forgiving seating"),
                ("Sierra MatchKing 142gr", "Sierra", "6.5mm", 142, 0.626, 0.295, "Match", "Classic"),
                ("Hornady ELD-M 147gr", "Hornady", "6.5mm", 147, 0.697, 0.351, "Match", "High BC"),
                ("Sierra MatchKing 168gr", "Sierra", "7.62mm", 168, 0.462, 0.231, "Match", ".308 standard"),
                ("Berger 175gr OTM", "Berger", "7.62mm", 175, 0.505, 0.243, "Match", "Tactical"),
                ("Lapua Scenar 185gr", "Lapua", "7.62mm", 185, 0.525, 0.259, "Match", "High BC .308"),
                ("Sierra MatchKing 77gr", "Sierra", "5.56mm", 77, 0.372, 0.196, "Match", "AR-15 standard"),
                ("Berger 73gr BT", "Berger", "5.56mm", 73, 0.370, 0.193, "Match", "Accurate"),
                ("Hornady ELD-M 80.5gr", "Hornady", "5.56mm", 80.5, 0.395, 0.210, "Match", "High BC"),
            ]
            
            for name, mfg, cal, weight, bc_g1, bc_g7, btype, notes in bullets:
                c.execute("""INSERT INTO bullets (name, manufacturer, caliber, weight_grains, 
            ...
            powders = [
                ...
                ("N540", "Vihtavuori", "Extruded", 0.940, "High energy for 6.5 CM, .308"),
                ("N555", "Vihtavuori", "Extruded", 0.900, "Developed for 6.5 Creedmoor comp"),
                ("Norma 204", "Norma", "Extruded", 0.55, ".308 Win, 6.5x55 Swedish standard"),
            ...
            for name, mfg, ptype, dens, notes in powders:
                c.execute("INSERT INTO powder (name, manufacturer, type, density, notes) VALUES (?, ?, ?, ?, ?)",
            ...
            self.progress.emit("\n💥 Adding primers...")
            primers = [
                ("CCI BR-2", "Large Rifle Benchrest", "CCI", "Benchrest primer, very consistent"),
                ("Federal 210M", "Large Rifle Match", "Federal", "Gold standard match primer"),
                ...
                ("Federal 205M", "Small Rifle Match", "Federal", "Match primer for .223"),
            ...
            for name, ptype, mfg, notes in primers:
                c.execute("INSERT INTO primers (name, type, manufacturer, notes) VALUES (?, ?, ?, ?)",
...
class DatabaseSetupDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.btn_populate.setStyleSheet("font-size: 14px; padding: 10px; background-color: #4CAF50; color: white;")
