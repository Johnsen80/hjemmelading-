...
bullets = [
    ...
    ("Lapua Scenar 139gr", "Lapua", "6.5mm", 139, 0.615, 0.290, "Match", "Finnish precision, very consistent"),
    ("Berger 140gr Hybrid", "Berger", "6.5mm", 140, 0.618, 0.287, "Match", "Forgiving seating depth"),
    ("Sierra MatchKing 142gr", "Sierra", "6.5mm", 142, 0.626, 0.295, "Match", "6.5 CM gold standard"),
    ("Norma Golden Target 140gr", "Norma", "6.5mm", 140, 0.585, 0.295, "Match", "Swedish premium match"),
    ("Hornady ELD-M 147gr", "Hornady", "6.5mm", 147, 0.697, 0.351, "Match", "High BC, heat shield tip"),
    ("Sierra MatchKing 168gr", "Sierra", "7.62mm", 168, 0.462, 0.231, "Match", ".308 Win classic"),
    ("Berger 175gr OTM", "Berger", "7.62mm", 175, 0.505, 0.243, "Match", "Military sniper choice"),
    ("Sierra MatchKing 77gr", "Sierra", "5.56mm", 77, 0.372, 0.196, "Match", "AR-15 service rifle std"),
    # Hunting bullets
    ("Lapua MEGA 140gr", "Lapua", "6.5mm", 140, 0.462, 0.231, "Hunting", "Soft point, Scandinavian favorite"),
    ("Barnes TTSX 168gr", "Barnes", "7.62mm", 168, 0.470, 0.235, "Hunting", "100% copper, deep penetration"),
]

for name, mfg, cal, weight, bc_g1, bc_g7, btype, notes in bullets:
    c.execute("INSERT INTO bullets (name, manufacturer, caliber, weight_grains, bc_g1, bc_g7, bullet_type, notes) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
